...
content_file: hackernews_api-guis-should-be-fully-keyboard-driven-charalampos-k
fetched_at: '2026-08-28T21:20:57.501667'
...
Last week I came across apost onHacker
Newsthat encouraged application
developers to stop making terminal user interfaces1(a.k.a. TUIs) and instead focus on graphical user interfaces (a.k.a. GUIs).
The post reached the HN front page and sparked a lively debate in thecommentssection.
...
On the other hand, as a heavyterminal user, Ialsogreatly appreciate all TUIs that allow me to
...
There is nothing preventing a GUI from being fully keyboard-driven4just like — or even better
than — a TUI.
...
For example, the GNOME Human Interface Guidelines state thatjust as it should be possible to perform every
action with a pointing device, every action should also be possible with the
keyboardand thatit should be possible to move around and interact with every part of your user interface
using the
keyboard.
...
For my first ever GUI application,Klisi, I invested some time
...
1. Or alternativelytext-based user
interfaces.↩
