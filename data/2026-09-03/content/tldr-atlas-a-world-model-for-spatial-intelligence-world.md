---
title: 'Atlas: A World Model for Spatial Intelligence | World Labs'
url: https://www.worldlabs.ai/blog/atlas
site_name: tldr
content_file: tldr-atlas-a-world-model-for-spatial-intelligence-world
fetched_at: '2026-09-03T21:36:46.408306'
original_url: https://www.worldlabs.ai/blog/atlas
date: '2026-09-03'
description: Introducing Atlas, our new omni world model for spatial intelligence.
tags:
- tldr
---

September 1, 2026Introducing Atlas, our new omni world model for spatial intelligence.
...
and enablingReal-to-Simworkflows for robotics.
* Image Generation:
...
Atlas will power future versions ofMarbleand other products from World Labs.
...
Videos are generated fromone to six input imageswith manually designed camera paths
...
Atlas generates a complete scene froma single input image.
...
otherwise unrelated image pairs.
...
and Atlas generates a coherent world.
...
but the rest of the scene is imagined.
...
the entire scene is accurately depicted.
...
Atlas opens up new ways to scaleReal-to-Simfor both navigation and manipulation.
...
supporting controllable variations.
...
Atlas is a capable image generator:
...
outputs conditioned on its context.

Atlas is amultimodal autoregressive diffusion transformer.
...
and taken together they enable a new paradigm of generation based on aspatial context.
...
These results confirm thatAtlas outperforms recent video models at camera-controlled generation,
...
90
100
Share of voters choosing Atlas
...
We are alsohiringacross research and engineering to advance spatial intelligence.
