...
site_name: tldr
content_file: tldr-ransomware-knocks-dutch-healthcare-software-vendor
fetched_at: '2026-04-13T06:00:33.367403'
original_url: https://www.theregister.com/2026/04/08/chipsoft_ransomware/
date: '2026-04-13'
description: Dutch healthcare software vendor goes dark after ransomware attack (2 minute read)
tags:
- tldr
---
...
The ransomware element of the cyberattack was confirmed in an advisory penned by Z-CERT, the Netherlands' computer emergency response team for the healthcare industry, and included in astatement published on Wednesday morning.
...
The Registercontacted ChipSoft for more information.
...
Only 11 hospitals have pulled their software offline, nine of which are among the institutions that use the software more extensively, according to a survey by local news outletNOS.
...
In its annual landscape report, Z-CERT listedransomwareand extortion as the foremost concerns for Dutch healthcare organizations – threats that have not materially diminished in recent years.
...
Z-CERT also pointed to the Januaryransomware attack on Belgian hospital network AZ Monicaas a more recent example of the danger cyberattacks pose to healthcare organizations.
