...
site_name: github
content_file: github-github-anthropicsclaude-cookbooks-a-collection-of
fetched_at: '2026-04-13T12:02:11.303358'
original_url: https://github.com/anthropics/claude-cookbooks
author: anthropics
...
To make the most of the examples in this cookbook, you'll need a Claude API key (sign up for freehere).
...
If you're new to working with the Claude API, we recommend starting with ourClaude API Fundamentals courseto get a solid foundation.
...
If you have ideas for new examples or guides, share them on theissues page.
...
* Tool use: Learn how to integrate Claude with external tools and functions to extend its capabilities.Customer service agentCalculator integrationSQL queries
...
* Retrieval augmented generation: Supplement Claude's knowledge with external data sources.Vector databases (Pinecone)WikipediaWeb pages
...
* Vision with Claude:Getting started with imagesBest practices for visionInterpreting charts and graphsExtracting content from forms
