---
title: AI Can't Replace Real Research in Empathy Mapping - NN/G
url: https://www.nngroup.com/articles/ai-empathy-mapping/
site_name: tldr
content_file: tldr-ai-cant-replace-real-research-in-empathy-mapping-n
fetched_at: '2026-08-31T17:51:32.012182'
original_url: https://www.nngroup.com/articles/ai-empathy-mapping/
date: '2026-08-31'
description: AI can help you organize research you’ve already collected, but it can’t create research evidence about the specific, messy experience of real users.
tags:
- tldr
---
...
Anempathy mapis a visualization that articulates what a team knows about a particular type of user, organized into four quadrants:Says,Thinks,Does, andFeels.

An empathy map consists of four quadrants that capture what a team knows about a particular user.
...
* Field studiesorcontextual inquiry:What the environment reveals that users don’t explicitly mention

Empathy maps are especially useful for aligning acrossfunctional teamaround an experience.

## Plausible AI-Generated User Content Isn’t User Research

When you ask an AI tool to play the role of a frustrated user, it synthesizes patterns across large amounts of text and produces something plausible. Butplausibleisn’t the same asreal. It does not create the documented experience of a real, specific person.

AI doesn’t have access to your users, your product’s specific failure points, or the context someone was in when the product let them down. What it producescoulddescribe a frustrated user of almost any product, which means it describes no one in particular.
...
Organizing and clustering sticky notesfrom research you’ve already collected
...
Summarizing patternsacross a large set of quotes
...
What makes an empathy map valuable is the specific, messy detail ofreal people. AI can help you process what you learned from those people, but it can’t manufacture them for you. AI-generated data is not evidence, no matter how specific or convincing it may be. And an empathy map needs to capture evidence.
...
* User Panels: Maintenance and GovernanceLola Famulegun·4 min
* 3 Steps to Scope Your Broad Research StudyLola Famulegun·4 min
* Convenience Sampling: Avoid Bias When Recruiting Study ParticipantsRachel Banawa·4 min

## Related Articles:

* How to Decide When an AI Tool Is Worth KeepingCaleb Sponheim·8 min
* Context ArchitecturePaz Perez·12 min
* Handmade Designs: The New Trust SignalMegan Chan·5 min
* AI Agents as UsersSarah Gibbons and Kate Moran·7 min
* AI Can Help with Survey Writing, But It Still Requires Human ExpertiseRachel Banawa·8 min
* State of UX 2026: Design Deeper to DifferentiateKate Moran, Raluca Budiu, Sarah Gibbons, and The Experts at NN/g·5 min