...
content_file: hackernews_api-creepy-crawlies-konstantin-ryabitsev
fetched_at: '2026-08-31T02:21:48.720213'
original_url: https://people.kernel.org/monsieuricon/creepy-crawlies
author: Konstantin Ryabitsev
date: '2026-08-30'
published_date: '2026-08-29T05:33:07Z'
description: You've probably heard me complain about the "AI crawlers" before, but now I actually have some hard numbers I can put up to show their im...
tags:
- hackernews
- trending
---
...
They still do that — welcome to the wonderful world of “proxy SDK monetization.” It's big business, andyour TV is probably doing it.
...
In other words, we putAnubisin front of everything.

It was immediately extremely effective — the bots just gave up. For a few months, it was bliss: bots were blocked at the perimeter and gave up, moving on to easier targets; the users weremildly annoyedbut tolerated it, and the Anubis stack was easy enough to deploy everywhere.
...
It's impossible to tell with certainty which of these are bots and which are real humans — but chances are, if it's asking for an old commit in a random old fork, it'sprobablynot a real developer trying to do their work.
