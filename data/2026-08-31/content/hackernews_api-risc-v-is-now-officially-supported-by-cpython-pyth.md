...
content_file: hackernews_api-risc-v-is-now-officially-supported-by-cpython-pyth
fetched_at: '2026-08-31T02:21:47.191550'
original_url: https://blog.python.org/2026/08/riscv-now-officially-supported/
author: lumpa
date: '2026-08-25'
description: I’m happy to announce that RISC-V platforms are now officially supported by CPython. 🎉 🚀
tags:
- hackernews
- trending
---
...
officially supported by CPython as atier 3platform! 🎉 🚀

## What is RISC-V?

RISC-Vis an openinstruction set architecture (ISA). Importantly,
...
Its ecosystem has grown considerably in recent years and isprojected to
quadruple by 2032. With that growth, it’s increasingly important that
...
where it could be added toPEP 11.

A particularly important part of this has been having reliable, ongoing testing
on real RISC-V hardware. I’d like to thank theRISE Projectfor their
...
I’d especially like to thankLudovic Henryfrom the RISE Project,Furkan Onder, andEmma Smith, along with the many others who have
contributed. Additionally, I’m personally grateful for theSovereign Tech Agency,
...
RISC-V directly into CPython’s CI, again kindly supported by RISE with theirRISE RISC-V Runners initiative. This should give contributors faster
feedback than thebuildbots(which usually runaftera patch is merged)
...
and test suites, and pleaselet us know what breaks. Testing across
