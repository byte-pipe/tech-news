...
url: https://engineering.grab.com/crowdsourced-taxonomy-verification
site_name: tldr
content_file: tldr-crowdsourced-taxonomy-verification-a-feedback-driv
fetched_at: '2026-08-04T11:46:10.343173'
original_url: https://engineering.grab.com/crowdsourced-taxonomy-verification
date: '2026-08-04'
description: Knowledge graphs power modern search and recommendation systems, but automated construction methods can introduce semantic inaccuracies. This framework verifies KG relationships in real time by injecting candidate edges into live search results and using user feedback to validate semantic truth.
tags:
- tldr
---
...
We introduce afeedback-driven verification enginethat operationalizes the search interface as a validation environment. Key contributions include:
...
* Contextual anchoring: The system logs the specific search term, also known as theanchor, used by the user. A click on “Pho” is only counted as a vote for the relationship if the user was searching for “Noodle Soup” at the time.
...
To demonstrate the framework, consider a validation scenario in food delivery taxonomy. An LLM-based ingestion pipeline flags a candidate parent-child linkNoodle Soup → Dry Mee Pokand stores it as an unverified candidate edge in the KG, ready for live validation.
