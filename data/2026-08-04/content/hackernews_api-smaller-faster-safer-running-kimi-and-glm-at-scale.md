---
title: 'Smaller, faster, safer: running Kimi and GLM at scale | The Cloudflare Blog'
url: https://blog.cloudflare.com/smaller-faster-safer-models/
site_name: hackernews_api
content_file: hackernews_api-smaller-faster-safer-running-kimi-and-glm-at-scale
fetched_at: '2026-08-04T11:46:01.797908'
original_url: https://blog.cloudflare.com/smaller-faster-safer-models/
author: ascorbic
date: '2026-08-03'
published_date: '2026-08-03T13:00:00.000Z'
description: Serving frontier models like Kimi and GLM means fighting for GPU memory. Here's how we quantize KV caches, compress model weights, and add integrity checks to serve them faster, cheaper, and safely.
tags:
- hackernews
- trending
---
...
We've written before about how weserve large models on Workers AIand about separatingthe prefill and decode phasesof inference to get more out of each GPU. This post looks at three techniques we layer on top of that to fit these models into memory and keep them fast: quantizing the KV cache, compressing the model weights, and, because both of those pack more requests onto shared hardware, protecting the cache those requests share. These optimizations enable us to support more customers at lower costs, with no change in model accuracy.

All our experiments and production traffic are running and benchmarked withSGLang, an open-source inference serving framework. We found that SGLang offers the best performance in the market, and we work closely with the SGLang team to upstream patches and new features to make our work available to the open-source community.
