...
content_file: hackernews_api-running-local-models-is-good-now-vicki-boykis
fetched_at: '2026-06-16T20:04:54.002351'
original_url: https://vickiboykis.com/2026/06/15/running-local-models-is-good-now/
author: jfb
date: '2026-06-16'
published_date: '2026-06-15T08:00:00-05:00'
...
I’ve been workingwith local modelssince they came out, and finally, they’re surprisingly good now.
...
1. Model:The post recommendsGemma 26B A4B, butgemma-4-12b-qatis more recent and smaller and faster, without much sacrifice in accuracy.
...
3. Agent Harness Config:Since I run everything in Docker, I edited Pi’smodels.jsonin order to get Pi to talk to the model.
"lmstudio"
: 
{
...
# note that you'll need to specify a base if you also use OpenAI to access OpenAI's actual completions endpoint
...
/.pi/agent/models.json:/config/models.json
...
#agentic#llms#ml#local llms#open source