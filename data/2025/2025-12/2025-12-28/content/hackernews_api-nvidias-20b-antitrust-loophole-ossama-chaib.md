---
title: Nvidia's $20B Antitrust Loophole | Ossama Chaib
url: https://ossa-ma.github.io/blog/groq
site_name: hackernews_api
fetched_at: '2025-12-28T11:06:56.470971'
original_url: https://ossa-ma.github.io/blog/groq
author: ossa-ma
date: '2025-12-27'
published_date: '2025-12-25T00:00:00.000Z'
description: The Groq deal that dodged regulators, enriched Chamath, sidestepped Saudi entanglements and a whole bunch more
tags:
- hackernews
- trending
---
...
CPUs and GPUsare built around external DRAM/HBM (High Bandwidth Memory). Every compute operation requires shuttling data between the processor and off-chip memory. This works fine for general-purpose computing, but for inference workloads, that constant round-trip creates latency and energy overhead. Since GPUs evolved from graphics rendering they're optimized for parallel training workloads and not SEQUENTIAL inference.
...
Scenario 2: Most of the $20B goes to retention packagesIf the deal is structured so that the bulk of the money goes to retention/hiring packages for Ross, Madra, and the senior team joining Nvidia, with a smaller licensing fee to Groq Inc., employees get less. Maybe the split is $15B retention, $5B licensing fee. Now that same engineer with 0.01% gets $500K instead of $2M.

Scenario 3: The IP licensing is separate from talent acquisitionNvidia pays Groq Inc. for the IP (say $5-7B, roughly the Sept 2024 valuation), and separately pays Ross + team retention packages directly. Regular employees get their share of the IP licensing fee only. That same engineer might get $500-700K.
...
* Nvidia Acquiring Groq for $20B
* Nvidia-Groq Deal Structure
* Groq Series E: $750M at $6.9B Valuation
* Groq LPU Architecture
* Groq Deterministic Inference
* Saudi Arabia $1.5B Groq Investment
* Groq Dammam Data Center
* America's AI Action Plan
* White House AI Action Plan
* Chamath SPAC Performance
* Chamath Virgin Galactic Stock Dump
* Chamath SPAC Warning
* Meta-Groq Partnership
* HUMAIN Groq Partnership
* Sunny Madra All-In Appearance
* David Sacks Anthropic Criticism
