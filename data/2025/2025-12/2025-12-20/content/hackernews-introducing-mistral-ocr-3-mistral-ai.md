...
fetched_at: '2025-12-20T11:06:46.821875'
original_url: https://mistral.ai/news/mistral-ocr-3
author: pember
date: '2025-12-20'
description: Achieving a new frontier for both accuracy and efficiency in document processing.
---
...
* Now powers Document AI Playground inMistral AI Studio, a simple drag-and-drop interface for parsing PDFs/images into clean text or structured JSON
...
NOTE: See appendix B for specific fields that are included in each category.
...
Access the model either through the API or via the new Document AI Playground interface, both inMistral AI Studio. Mistral OCR 3 is fully backward compatible with Mistral OCR 2. For more details, head over tomistral.ai/docs.
