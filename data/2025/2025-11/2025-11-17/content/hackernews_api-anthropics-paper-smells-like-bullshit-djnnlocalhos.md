...
fetched_at: '2025-11-17T11:07:51.090820'
original_url: https://djnn.sh/posts/anthropic-s-paper-smells-like-bullshit/
author: vxvxvx
date: '2025-11-16'
description: offensive security & software engineering
tags:
- hackernews
- trending
---

Areportwas recently published by an AI-research company calledAnthropic.
They are the ones who notably createdClaude, an AI-assistant for coding. Personally, I don’t use it but that is besides the point.
Before we start, it’s important to say I don’t have anything against them, or AI in general. I do havesome documented concernsbut I am not “Anti-AI”, or whatever.
...
* Anthropic seemingly disrupted anAPT’s campaign, though a number of companies and government entities were affected,
...
This is typically done by sharing domain-names linked with the campaign, MD5 or SHA512 hashes you could look for on Virus Exchange websites such asVirusTotal, or other markers that would help you verify that your
networks are safe. As an example,hereis the French CERT sharing (in French, but an English version is available too) about APT28’s TTPs.

We can see:

* MITRE ATT&CKused to determine what are the techniques used (eg: Account Manipulation, Antivirus evasion, etc.),
...
The same goes with research in other fields. Youcannotjust claim things and not back it up in any way, and wecannotas an industry accept that it’s OK for companies to release this.
...
Attribution is averyserious matter, with sometimes diplomatical implications. You can’t just go on and point the finger at anyone and expect people to believe you for no reason.
...
For all we know, the “advanced threat actors” they’re talking about here could just be script kiddies trying to automateffufandsqlmapcommands.
