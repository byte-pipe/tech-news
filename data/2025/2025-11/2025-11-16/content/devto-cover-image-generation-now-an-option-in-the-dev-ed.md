---
title: Cover Image Generation Now an Option in the DEV Editor - DEV Community
url: https://dev.to/devteam/cover-image-generation-now-an-option-in-the-dev-editor-1nld
site_name: devto
fetched_at: '2025-11-16T11:07:01.024857'
original_url: https://dev.to/devteam/cover-image-generation-now-an-option-in-the-dev-editor-1nld
author: Ben Halpern
date: '2025-11-13'
description: 'We''re happy to roll out a new feature today: Prompt-driven image generation, built directly into the... Tagged with community, forem, ai, design.'
tags: '#community, #forem, #ai, #design'
---

We're happy to roll out a new feature today:Prompt-driven image generation, built directly into the post editor. This is now available on DEV and all other subforems we host. (Self-hosted instances ofour open-source Forem projectcan use it if they bring their own key).
...
* The Tech:We're using thegemini-2.5-flash-imagemodel (aka "Nano Banana"). We'll be tracking future upgrades to this model to keep improving the experience.
* Open Source First:We love being open source! You'll find a direct link to the feature's source code right in the generation modal. We're planning to do this more often across the site. (You can alsocheck it out here).
