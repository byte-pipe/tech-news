---
title: Sudden loss of key US satellite data could send hurricane forecasting back ‘decades’ | US weather | The Guardian
url: https://www.theguardian.com/us-news/2025/jun/28/noaa-cuts-hurricane-forecasting-climate
site_name: hackernews_api
fetched_at: '2025-06-30T13:31:50.494826'
original_url: https://www.theguardian.com/us-news/2025/jun/28/noaa-cuts-hurricane-forecasting-climate
author: trauco
date: '2025-06-30'
published_date: '2025-06-28T14:27:10.000Z'
description: Scientists left scrambling amid hurricane season after irreplaceable program is slotted to be shuttered
tags:
- hackernews
- trending
---
...
A critical US atmospheric data collection program will be halted by Monday, giving weather forecasters just days to prepare, according to apublic noticesent this week. Scientists that the Guardian spoke with say the change could set hurricane forecasting back “decades”, just as this year’s season ramps up.
...
The satellites also formed a unique source of data for tracking changes to the Arctic and Antarctic, and had been tracking changes to polar sea ice continuouslyfor more than 40 years.
...
The loss of DMSP comes as Noaa’s weather and climate monitoring services have become critically understaffed this year asDonald Trump’s so-called “department of government efficiency” (Doge) initiative hasinstilleddraconiancutsto federal environmental programs.

A current Noaa scientist who wishes to remain anonymous for fear of retaliation said that the action to halt the DMSP, when taken in context with other recent moves by theTrump administration, amounted to “a systematic destruction of science”.
...
Scientists said the decision to halt the DMSP will result in immediately degraded hurricane forecasts during what isexpected to be an above-average seasonas well as a gap in monitoring sea ice – just asArctic sea ice is hittingnew record lows.
...
In recent years, the DMSPhad struggled to maintainconsistent funding and priority within the Department of Defense as it transitioned away from its cold war mission. The only other nation with similar satellite capability is Japan, andmessages posted earlier in Juneindicate that scientists had already been considering a switch tothe Japanese datain case of a DMSP outage – though that transition will take time.
