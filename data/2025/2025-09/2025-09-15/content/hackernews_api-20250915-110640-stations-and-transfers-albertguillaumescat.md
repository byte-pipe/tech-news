---
title: Stations and transfers - albertguillaumes.cat
url: http://stations.albertguillaumes.cat/
site_name: hackernews_api
fetched_at: '2025-09-15T11:06:40.105593'
original_url: http://stations.albertguillaumes.cat/
author: tcumulus
date: '2025-09-14'
description: Models of European metro stations
tags:
- hackernews
- trending
---
...
Despite Frankfurt has officially a U-Bahn (puremetro), technically is a Stadtbahn (light rail), despite the platform level is high even for stops located at the street. The S-Bahn is also part of the basic rail network of the city.
...
Hannover has aStadtbahn, which is a mixture of a tramway that runs in a metro-like tunnel in the city centre.
...
##### London
 ...
 Take a look at other stations: TfL released
3D drawings of almost all the underground Tube stations
.
...
##### New York
 ...
 Discover more stations at Candy Chan's
Project Subway NYC website
.
...
Some examples are:Gare du Midi (Brussels),Mehringdamm (Berlin),Príncipe Pío (Madrid, lines 6-10)andLängenfeldgasse (Vienna).
...
Several transfer stations in Berlin have this layout:Berliner Str.,Bismarckstr.,Gleisdreieck,Hermannplatz,Hermannstr.,Leopoldplatz,Osloer Str.,Ostktreuz,Südkreuz,SchönebergandWesktreuz.

Other examples outside Berlin are:Gorg (Barcelona),Downtown Crossing (Boston),Arts-Loi (Brussels),Hauptwache (Frankfurt),Colombia (Madrid),Miromesnil (Paris),Beurs (Rotterdam)andStephansplatz (Vienna).
...
Some examples include:Paral·lel (Barcelona),Brandenburger Tor (Berlin),Baixa-ChiadoandCampo Grande (Lisboa),JussieuandVilliers (París).
...
Due to the inconvenience of walking through the never-ending corridors, some transfer stations are part of the general culture of the mentioned cities, such asPasseig de Gràcia (Barcelona, 270 m appr.),Diego de León (Madrid, 250 m appr.),Stadtmitte (Berlin, 150 m appr.)oChâtelet (Paris, 170 m appr.).
...
Examples of stations including platforms at very different levels include:CollblancandZona Universitària (Barcelona),Plaza de España (Madrid),Deák Ferenc Tér (Budapest),Madeleine (Paris),Schottenring (Viena).
...
The rail station comprises two parts: a surface terminus opened in 1961 –not depicted– with 20 platforms, and two underground platforms that are part of thePassante Ferroviarioline, opened in 1997. Next to the underground section of the railway station, there are the two metro stations.
...
* Project Subway NYC. Similar project with drawings of some New York City stations.
* Drawings of the London Underground stations used in internal documents of TfL.
