...
site_name: devto
fetched_at: '2025-08-29T10:02:09.847038'
original_url: https://dev.to/anthonymax/10-open-source-gems-to-become-the-ultimate-developer-dkk
author: Anthony Max
date: '2025-08-24'
description: TL;DR Every day we use different technological tools, already on automatism, although we... Tagged with webdev, javascript, programming, opensource.
...
## 2. 🐈‍⬛Nest.js- A progressive Node.js framework for building efficient, scalable, and enterprise-grade server-side applications
...
## 3. 🧠Agent TARS- The Open-sourced Multimodal AI Agent Stack connecting Cutting-edge AI Models and Agent Infra.
...
💎 Check out Agent TARS

## 4. 🐇Bun- Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
...
## 5. 🕷Supertest- Super-agent driven library for testing node.js HTTP servers using a fluent API
...
## 6. 👀Mockoon- Easiest and quickest way to run mock APIs locally
...
💎 Check out Mockoon repository

## 7. 💼Frappe HR- Open Source HR and Payroll Software

The next project is an open source business solution for HR management from Frappe. This company has been around for a long time and has a reallybig name in the industry, as you may have used (or are using) itsERPNextproduct if you work as a manager.

Frappe HR has everything you need to drive excellence within the company. It's a complete HRMS solution with over 13 different modules right from Employee Management, Onboarding, Leaves, to Payroll, Taxation, and more!

💎 Check out Frappe HR

## 8. 🖋️Appwrite- Build like a team of hundreds_
