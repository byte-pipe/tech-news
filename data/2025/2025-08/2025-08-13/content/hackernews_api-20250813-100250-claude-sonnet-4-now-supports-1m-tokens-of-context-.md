...
fetched_at: '2025-08-13T10:02:50.754624'
original_url: https://www.anthropic.com/news/1m-context
author: adocomplete
date: '2025-08-13'
description: Claude Sonnet 4 now supports up to 1 million tokens of context on the Anthropic API—a 5x increase.
tags:
- hackernews
- trending
---
...
To account for increased computational requirements,pricingadjusts for prompts over 200K tokens:
...
When combined withprompt caching, users can reduce latency and costs for Claude Sonnet 4 with long context. The 1M context window can also be used withbatch processingfor an additional 50% cost savings.
...
To learn more about Sonnet 4 and the 1M context window, see ourdocumentationandpricing page.
