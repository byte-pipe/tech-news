...
fetched_at: '2025-08-12T07:05:24.611605'
original_url: https://www.openssh.com/pq.html
author: throw0101d
date: '2025-08-12'
description: OpenSSH post quantum cryptography
---

OpenSSH: Post-Quantum Cryptography

## OpenSSHPost-Quantum Cryptography
...
by default since release 9.0 (2022), initially via thesntrup761x25519-sha512algorithm. More recently, in OpenSSH 9.9,
we have added a second post-quantum key agreementmlkem768x25519-sha256and it was made the default scheme in OpenSSH 10.0.
...
warnings are displayed by default but may be disabled via theWarnWeakCryptooption inssh_config(5).
...
sntrup761x25519-sha512
 and versions 9.9 and greater support

mlkem768x25519-sha256
. If your server is already running one of these
versions, then check whether the
KexAlgorithms
 option has disabled
their use.
