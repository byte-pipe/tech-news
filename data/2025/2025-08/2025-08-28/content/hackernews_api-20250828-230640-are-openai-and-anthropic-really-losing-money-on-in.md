---
title: Are OpenAI and Anthropic Really Losing Money on Inference? - Martin Alderson
url: https://martinalderson.com/posts/are-openai-and-anthropic-really-losing-money-on-inference/
site_name: hackernews_api
fetched_at: '2025-08-28T23:06:40.093456'
original_url: https://martinalderson.com/posts/are-openai-and-anthropic-really-losing-money-on-inference/
author: martinald
date: '2025-08-28'
published_date: '2025-08-27T00:00:00.000Z'
description: Are OpenAI and Anthropic losing money on inference?
tags:
- hackernews
- trending
---

I keep hearing what acashincineratorAIis, especially around inference. While it seems reasonable on the surface, I've often been wary of these kind of claims, so I decided to do some digging.
...
* $20/month ChatGPT Pro user: Heavy daily usage but token-limited100k toks/dayAssuming 70% input/30% output: actual cost ~$3/month5-6x markup for OpenAI
* 100k toks/day
...
* Claude Code Max 5 user($100/month): 2 hours/day heavy coding~2M input tokens, ~30k output tokens/dayHeavy input token usage (cheap parallel processing) + minimal outputActual cost: ~$4.92/month → 20.3x markup
...
* Claude Code Max 10 user($200/month): 6 hours/day very heavy usage~10M input tokens, ~100k output tokens/dayHuge number of input tokens but relatively few generated tokensActual cost: ~$16.89/month → 11.8x markup
