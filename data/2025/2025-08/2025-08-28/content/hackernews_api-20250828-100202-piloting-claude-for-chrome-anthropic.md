...
fetched_at: '2025-08-28T10:02:02.760653'
original_url: https://www.anthropic.com/news/claude-for-chrome
author: davidbarker
date: '2025-08-27'
description: Announcing a pilot test of a new Claude browser extension
tags:
- hackernews
- trending
---
...
The first line of defense against prompt injection attacks ispermissions. Users maintain control over what Claude for Chrome can access and do:
...
If you’d like to take part, you can join the Claude for Chrome research preview waitlist atclaude.ai/chrome.Once you have access, you can install the extension from the Chrome Web Store and authenticate with your Claude credentials.

We recommend starting with trusted sites—always be mindful of the data that’s visible to Claude—and avoiding use of Claude for Chrome for sites that involve financial, legal, medical, or other types of sensitive information. You can find a detailed safety guidein our Help Center.
