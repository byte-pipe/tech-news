...
site_name: devto
fetched_at: '2025-08-07T07:04:56.745572'
original_url: https://dev.to/corpothug/bossortoss-we-weaponized-astro-react-and-poop-emojis-to-judge-executives-at-scale-33jf
author: CloAv
date: '2025-08-05'
description: 'Warning: This app may cause excessive laughter, existential reflection, or mild HR incidents. The... Tagged with webdev, devchallenge, react, supabase.'
tags: '#webdev, #devchallenge, #react, #supabase'
---

Warning: This app may cause excessive laughter, existential reflection, or mild HR incidents.

The Problem:There are thousands of CEOs, CTOs, and other buzzword-laden acronyms out there. But how do we, the humble minions of the corporate ladder, hold them accountable? Reviews are gated. Glassdoor is boring. Twitter is chaos.
...
💡 The Stack (AKA “Wait, this actually works?”)🧑‍🚀 Astro: Because we love fast static builds… until we realize we want hydration on every component.
...
🔧 But Wait, It’s Actually Engineered Properly™Dynamic routing with slugs: Each exec has their own page — fast, statically rendered, and SEO-optimized with meta tags.
...
🪄 Why We Did ThisWe wanted to prove that modern frameworks can scale even when your idea is utterly unhinged.
...
🧪 Tech Is Serious. But It Doesn’t Have to Be Boring.We built BossOrToss.wtf to be funny, fast, and functional.
...
📣 Check it out:🔗https://BossOrToss.wtf
