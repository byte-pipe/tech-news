---
title: Build an AI Agent And Win 💸 - DEV Community
url: https://dev.to/portia-ai/build-an-ai-agent-and-win-3p3c
site_name: devto
fetched_at: '2025-07-24T01:06:25.791897'
original_url: https://dev.to/portia-ai/build-an-ai-agent-and-win-3p3c
author: Zevi Reinitz
date: '2025-07-18'
description: “Everyone’s talking about AI agents. But what can you actually build?” We (the team at Portia AI)... Tagged with ai, hackathon, mcp, devchallenge.
tags: '#ai, #hackathon, #mcp, #devchallenge'
---

“Everyone’s talking about AI agents. But what can youactuallybuild?”

We (the team atPortia AI) keep hearing this — so we’re turning the question back to the community... and we're offering $$$ to the people who can come up with the best answer!
...
👉🏼 We want to build some cool examples that leverage our differentiators and add them to ourexamples repoon Github.
...
* Submit your project as a comment onthis Github issueProvide a link to a private repo shared withemmaportiaandMomo
* Provide a link to a private repo shared withemmaportiaandMomo
* Include a high-resolution demo video explaining how your project works
* Write up a Readme including:Key package dependenciesSetup stepsRunning instructionsOverview of key components in the code
* Key package dependencies
* Setup steps
* Running instructions
* Overview of key components in the code
* Follow ourcontribution guidelinesin particular around linting
* Starour GitHub repo😇
...
* Sign Up toPortia cloudand access 1000+ cloud and MCP tools with built-in auth out of the box
