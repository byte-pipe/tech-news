---
title: 8 Alternatives to AI for Coding and Creativity - DEV Community
url: https://dev.to/ingosteinke/8-alternatives-to-ai-for-coding-and-creativity-26k3
site_name: devto
fetched_at: '2025-07-10T01:05:42.926665'
original_url: https://dev.to/ingosteinke/8-alternatives-to-ai-for-coding-and-creativity-26k3
author: Ingo Steinke, web developer
date: '2025-07-02'
description: AI isn't the solution to all your problems. AI Alternatives are plenty and specific to your use case.... Tagged with webdev, programming, productivity, ai.
...
Techniques like rubber duck dialog development, feature branches, merge/pull requests, code reviews, explicit acceptance criteria, and test-driven development can also be used when working alone.
...
* Does AI Harm or Benefit Learning?Getting good at Shoveling Dirt
* Getting good at Shoveling Dirt
* What do people use AI for?Text processingDebugging and Development SupportAI as an Advanced ELIZAInspiration, IdeationFAQ, Q&A, ResearchCode Creation, Explanation and RefactoringCan AI help to Understand Legacy Code?Complex Code Generation vs. Reading the ManualAlternatives to AI-Assisted Code GenerationAlternatives to AI-assisted Image GenerationEffort and Laziness as Human Virtues
* Text processing
* Debugging and Development SupportAI as an Advanced ELIZA
* AI as an Advanced ELIZA
* Inspiration, Ideation
* FAQ, Q&A, Research
* Code Creation, Explanation and RefactoringCan AI help to Understand Legacy Code?Complex Code Generation vs. Reading the ManualAlternatives to AI-Assisted Code Generation
...
Apart from its real limitations, AI assistants often fail to understand assumptions or don't understand your requirements. As an example, it took me three attempts to make the JetBrains AI assistant, which is integrated in my IDE, to consider the code snippet already highlighted in the open editor, to answer a specific question. Finding the answer without AI might have been much quicker, and practicing to code still provides more long-term value than practicing to prompt AI questions. QuotingErik Dietrich's Surviving the Great Commoditizer, we shouldn't get "good at shovelling dirt."
...
Combining the advantages of all possible solutions, you could start with your own thoughts and take notes, then use AI or a search engine for more inspiration and aspect that you might have overlooked.Write and let your thoughts flow. Read, edit, repeat.

Later, you can ask an AIanda human expert to review and suggest improvements. Don't rely on AI but choose an experienced human proof reader if quality is important!
...
(Source: Steph Smith, quoted by Matt Novak, quoted on Meme Monday) stephsmithio paleofuture.bsky.socialhttps://dev.to/best_codes/comment/2pe6p

AI folks have now discovered "thinking":Sometimes in the process of writing a good enough prompt for ChatGPT, I end up solving my own problem, without even needing to submit it.
...
### Ingo Steinke, web developer ・ Sep 27 '23
