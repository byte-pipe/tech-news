...
fetched_at: '2025-07-04T07:04:47.827090'
original_url: https://lucumr.pocoo.org/2025/7/3/tools/
author: Bogdanp
date: '2025-07-04'
published_date: '2025-07-03T00:00:00'
description: The solution to agentic flows was code all along.
---
...
GitHub MCP, then repeat it with theghCLI tool. You'll almost certainly
...
reliability. All these problems are what we need to deal withbefore we can
even think of tool usageor MCP. We need to figure out how to ensure that our
...
judge to figure out if theapproachis correct. Don't really have to validate
...
hard to replace Playwright with a code approachfor all casesbecause what
