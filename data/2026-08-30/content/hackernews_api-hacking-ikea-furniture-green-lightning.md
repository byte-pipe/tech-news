---
title: Hacking IKEA Furniture · Green Lightning
url: https://greenlightning.eu/diy/hacking-ikea-furniture/
site_name: hackernews_api
content_file: hackernews_api-hacking-ikea-furniture-green-lightning
fetched_at: '2026-08-30T21:52:42.576355'
original_url: https://greenlightning.eu/diy/hacking-ikea-furniture/
author: greenlightning
date: '2026-08-30'
published_date: '2026-08-30T13:00:00+02:00'
description: When something you want is not available for purchase, well, you can always build it yourself! I recently moved and have a dedicated office room now. I wanted …
tags:
- hackernews
- trending
---
...
When researching products, I found that workbenches or industrial shelving units have too much of a garage look and would never get girlfriend approval. Regular cabinets were only available with a maximum depth of 40 cm, which is a bit too small for my taste. I also looked into custom-made furniture, which landedslightlyoutside my budget at roughly 1 000 €per unit(I want two units). ChatGPT suggested looking at kitchen cabinets, which do have suitable dimensions (typically 60 cm deep) and a better price point (maybe on the order of 300 € per unit), but I could not find something with a decent design, a functional layout, and nice-looking sides (as the cabinets are usually intended to be installed in a kitchen where the side walls are not visible).
