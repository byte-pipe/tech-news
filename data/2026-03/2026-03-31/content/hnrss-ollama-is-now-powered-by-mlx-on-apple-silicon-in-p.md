---
title: Ollama is now powered by MLX on Apple Silicon in preview · Ollama Blog
url: https://ollama.com/blog/mlx
site_name: hnrss
content_file: hnrss-ollama-is-now-powered-by-mlx-on-apple-silicon-in-p
fetched_at: '2026-03-31T11:22:31.292059'
original_url: https://ollama.com/blog/mlx
date: '2026-03-31'
description: Today, we're previewing the fastest way to run Ollama on Apple silicon, powered by MLX, Apple's machine learning framework.
tags:
- hackernews
- hnrss
---
...
This unlocks new performance toaccelerate your most demanding work on macOS:

* Personal assistants like OpenClaw
* Coding agents like Claude Code, OpenCode, or CodexAccelerate coding agents like Pi or Claude CodeOpenClaw now responds much faster
...
Ollama now leverages NVIDIA’sNVFP4format to maintain model accuracy while reducing memory bandwidth and storage requirements for inference workloads.
...
It further opens up Ollama to have the ability to run models optimized by NVIDIA’smodel optimizer. Other precisions will be made available based on the design and usage intent from Ollama’s research and hardware partners.
...
This preview release of Ollama accelerates the newQwen3.5-35B-A3Bmodel, with sampling parameters tuned for coding tasks.
