...
content_file: hackernews_api-dabao-evaluation-board-for-baochip-1x-what-it-is-w
fetched_at: '2026-03-15T06:00:11.184505'
original_url: https://www.crowdsupply.com/baochip/dabao/updates/what-it-is-why-im-doing-it-now-and-how-it-came-about
author: timhh
date: '2026-03-12'
description: 'Baochip-1x: What it is, why I''m doing it now and how it came about'
tags:
- hackernews
- trending
---
...
I’m aware of newer memory protection technologies, such asCHERI, PMPs, MPUs… and as a nerd, I love thinking about these sorts of things. In fact,in my dissertation, I even advocated for the use of CHERI-style hardware capabilities and tagged pointers in new CPU architectures.
...
However, as an open source strategy advisor, I argued that users who viewed open source as a positive feature would likely also expect, at aminimum, that the CPU would be open source. Thus I offered to add the battle-tested CPU core from the Precursor SoC – the Vexriscv – to the tapout, and I promised I would implement the core in such a way that even if it didn’t work, we could just switch it off and there would be minimal impact on the chip’s power and area budget.
