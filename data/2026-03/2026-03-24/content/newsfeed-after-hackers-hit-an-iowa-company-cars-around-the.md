---
title: After hackers hit an Iowa company, cars around the country failed to start - Ars Technica
url: https://arstechnica.com/security/2026/03/after-hack-some-ignition-interlock-users-couldnt-start-their-own-cars/
site_name: newsfeed
content_file: newsfeed-after-hackers-hit-an-iowa-company-cars-around-the
fetched_at: '2026-03-24T11:22:02.157011'
original_url: https://arstechnica.com/security/2026/03/after-hack-some-ignition-interlock-users-couldnt-start-their-own-cars/
date: '2026-03-23'
published_date: '2026-03-23T21:10:14+00:00'
description: If you don't calibrate your interlock in time, your vehicle is dead.
tags:
- ars-technica
- security
- hacking
...
The attack made calibrations impossible, which meant that some users in each state weren’t able to calibrate on time and were in danger of having their vehicles locked. (The companytold a Connecticut media outletthat 7–10 percent of users in that state had been affected.)

On March 18, Intoxalock published astatus page on its websitesaying that it had authorized local service centers to grant 10-day calibration extensions. (These do not apparently work on every version of the company’s interlocks, and they do not apply to several states.) In addition, Intoxalock said that it would pay all user costs, including tow fees, “that are a direct result of the temporary system pause.”
...
4. 4.Nvidia CEO tries to explain why DLSS 5 isn’t just “AI slop”
5. 5.Republicans in Congress add $250 annual federal EV tax to transport bill
