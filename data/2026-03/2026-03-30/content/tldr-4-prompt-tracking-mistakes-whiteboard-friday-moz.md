---
title: 4 Prompt Tracking Mistakes — Whiteboard Friday - Moz
url: https://moz.com/blog/prompt-tracking-mistakes-whiteboard-friday
site_name: tldr
content_file: tldr-4-prompt-tracking-mistakes-whiteboard-friday-moz
fetched_at: '2026-03-30T19:26:31.050390'
original_url: https://moz.com/blog/prompt-tracking-mistakes-whiteboard-friday
date: '2026-03-30'
description: Are you measuring AI visibility wrong? Tom Capper reveals the 4 biggest mistakes in AI prompt tracking and 4 creative ways to expand your list of prompts.
tags:
- tldr
---
...
Happy Friday, Moz fans. Today I want to talk about prompt tracking. Now this has been a big discussion topic in the industry, particularly the last few months, I feel actually, but actually the last year in general, and it's something that we have built out in both Moz Pro and STAT, and we're including for all our customers.

But I think a lot of people have their reservations about prompt tracking. So I'm not going to focus on talking about our products today. This isn't an advert. But instead, I want to talk about four mistakes that I see people making in any tool, really, that I think are leading to some of these reservations and misunderstandings.

## 1. Focusing on citations rather than mentions

So the first one, and probably the biggest one, actually is citations.

So I've got this example, a beautiful prompt here. This is the kind of thing that you might see as like a screenshot in your prompt tracking tool. There's a question at the top, which in this case is probably something about a phone recommendation or what phone is best for certain needs or something like this.

Then you get a response below, which mentions various phone brands and sub-brands, and then has a citation. In this case, I've taken the example of pcmag.com.

Now say you're Apple. You're Apple in this example, and you're trying to gauge your own performance. What you could do is look for apple.com being mentioned. You say, "Oh, no, the citation is actually from an external site. It's from PCMag. Therefore, this is a failure.

I think that would be ill-conceived. You don't really care where this information comes from. In fact, if anything, it's more authoritative if this information is coming from someone else's site, right? You are not necessarily looking to be cited.

Obviously, you might be one of the cited sources here. But the most important thing is that you are mentioned.
...
We know now that these kinds of AI responses, in most cases, are not very likely to generate a click or referral traffic through to a website.

This is a different place in your marketing funnel from traditional search, where you might have been focused on getting that click. This is much more about awareness. This is about being in the conversation. So I don't think you should be overfocused on who is here, except insofar as this is the opportunity.

You might see this, say you're not happy with how you're mentioned in this snippet. You might see this and think, "Okay, fine, I need to do some outreach to PCMag and make sure I'm featured in their roundups or whatever it might be." So this is your opportunity, not your ranking or something like that.
...
But this is the same kind of thing you're used to with keyword tracking, basically, where maybe 10 years ago you might have had a similar conversation about keyword tracking, where you say, "There's so much localization now. There's so much personalization now. We need to have a wider variety of keywords in order to get representative data in our tracking." And this is the same kind of thing.
...
We have some tools to help with this. My colleague,Dr. Pete,has written agreat guide, which will be referenced below, I hope. People Also Ask could also be a good starting point because those are sort of reallong-tail keywordsthat Google seems to think exist and might be useful. There are lots of different things you can do here to try and get some kind of representative, more specific, longer-tail terms. Those are the four sorts of mistakes I wanted to talk about.
