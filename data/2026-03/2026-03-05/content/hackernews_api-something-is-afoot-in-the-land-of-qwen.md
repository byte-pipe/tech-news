...
content_file: hackernews_api-something-is-afoot-in-the-land-of-qwen
fetched_at: '2026-03-05T06:00:13.900279'
original_url: https://simonwillison.net/2026/Mar/4/qwen/
author: Simon Willison
date: '2026-03-05'
description: Something is afoot in the land of Qwen
tags:
- hackernews
- trending
---
...
It all started withthis tweetfrom Junyang Lin (@JustinLin610):
...
More information is available inthis article from 36kr.com. Here’sWikipedia on 36Krconfirming that it’s a credible media source established in 2010 with a good track record reporting on the Chinese technology industry.
...
This story hits particularly hard right now because the Qwen 3.5 models appear to beexceptionallygood.

I’ve not spent enough time with them yet but the scale of the new model family is impressive. They started withQwen3.5-397B-A17B on February 17th—an 807GB model—and then followed witha flurry of smaller siblingsin 122B, 35B, 27B, 9B, 4B, 2B, 0.8B sizes.
