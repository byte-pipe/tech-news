---
title: A Japanese Glossary of Chopsticks Faux Pas | Nippon.com
url: https://www.nippon.com/en/japan-data/h01362/
site_name: hackernews_api
content_file: hackernews_api-a-japanese-glossary-of-chopsticks-faux-pas-nipponc
fetched_at: '2026-03-21T19:10:26.639047'
original_url: https://www.nippon.com/en/japan-data/h01362/
author: cainxinth
date: '2026-03-20'
published_date: 2022-06-28T00:00:07+0900
description: An overview of chopsticks gaffes that are best avoided when eating in Japan.
tags:
- hackernews
- trending
---
...
From bad manners to taboo, there are certain ways of using chopsticks that are considered as going against dining etiquette. These various acts, known askiraibashi, are listed below.
...
## 🥢 合わせ箸Awasebashi(also known as 拾い箸hiroibashior 箸渡しhashiwatashi)
...
## 🥢 移り箸Utsuribashi(also known as 渡り箸wataribashi)
...
## 🥢 うら箸Urabashi(also known asそら箸sorabashi)

To pick up food with the chopsticks and then put it back without taking it.

## 🥢 拝み箸Ogamibashi

To hold the chopsticks between both hands when expressing thanks for the food. It is considered rude to hold objects in your hands when in prayer and it is taboo to hold the chopsticks while sayingItadakimasu, a phrase said before eating, giving thanks for the life of the food.

Ogamibashi.(© Pixta)

## 🥢 押し込み箸Oshikomibashi(also known as 込み箸komibashi)
...
## 🥢 返し箸Kaeshibashi(also known as 逆さ箸sakasabashi)
...
## 🥢 かき箸Kakibashi(also known as かき込み箸kakikomibashi)
...
## 🥢 こじ箸Kojibashi(also known as ほじり箸hojiribashi)

To use the chopsticks to pick something out from near the bottom of the dish.

## 🥢 こすり箸Kosuribashi

To rubwaribashi(disposable chopsticks) together to remove splinters.

## 🥢 探り箸Saguribashi

To use the chopsticks to stir the food around to find something.

## 🥢 刺し箸Sashibashi(also known as 突き箸tsukibashi)
...
## 🥢 立て箸Tatebashi(also known as 突き立て箸tsukitatebashi, 仏箸hotokebashi)
...
To allow sauce or soup to drip from the tips of the chopsticks when eating.Namidameans “tears.”
...
## 🥢 橋箸Hashibashi(also known as渡し箸watashibashi)

To place the chopsticks like a bridge across the top of a dish to show one is finished. Chopsticks should be placed on thehashioki(chopstick rest).
...
## 🥢 惑い箸Madoibashi(also known as 迷い箸mayoibashi)
