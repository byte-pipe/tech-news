...
site_name: hnrss
content_file: hnrss-boxart
fetched_at: '2026-03-06T06:01:06.917085'
original_url: https://boxart.lt/blog/poor_mans_polaroid
date: '2026-03-05'
description: Custom lightboxes and blog about DIY
tags:
- hackernews
- hnrss
---
...
## Kamera
 ...
 vis tiek kompiuteris - gali prijungti ekraną, klaviatūrą, pelę, taip
...
, ką aš ir padariau. Kažkodėl tai kainavo mažiau nei atskiros dalys.
 ...
 ant torto, kurios neįmanoma užpūst, tik žymiai blogiau. Daugumą
...
## Spausdintuvas
 ...
 Šis spausdintuvas nėra ypatingas - jis tiesiog mažas, reikalauja
...
## Susirinkimas
 ...
 mygtuką, kuris pasakytų kompiuteriui, kad laikas pailsėti (patartina).
...
## Padaryk Nuotrauką
 ...
 Per daug nesigilinant į detales, programavimui naudojau Python kalbą
...
"
shots/image_{timestamp}_converted.jpg
"

 image.save(converted_filename)

 last_image = io.BytesIO()
 image.save(last_image, format=
'
JPEG
'
)
...
GPIO.add_event_detect(CAMERA_BUTTON_PIN, GPIO.FALLING, callback=camera_button_callback, bouncetime=
200
)
GPIO.add_event_detect(POWER_BUTTON_PIN, GPIO.FALLING, callback=power_button_callback, bouncetime=
200
)
GPIO.add_event_detect(REPRINT_BUTTON_PIN, GPIO.FALLING, callback=reprint_button_callback, bouncetime=
200
)
...
thread = threading.Thread(target=worker, daemon=
True
)
thread.start()
...
stop_event.wait()
 ...
 Raspberry Pi kamera nėra bloga, bet ir ne ypatingai gera - kartais
...
Čia gali užsisakyti mano rašliavos RSS naujienlaiškį
