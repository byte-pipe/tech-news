...
summarized_at: 2026-03-27T01:01:54.686269
---
...
## Announcement
- Starting April 24, interaction data from Copilot Free, Pro, and Pro+ users will be used to train and improve GitHub’s AI models unless users opt out.
- Copilot Business and Copilot Enterprise users are excluded from this change.
- Opt‑out option is available in the “Privacy” settings; previous opt‑out choices remain honored.

## Why the change
- Using real‑world interaction data aligns with industry practice and helps create more accurate, context‑aware, and secure coding suggestions.
