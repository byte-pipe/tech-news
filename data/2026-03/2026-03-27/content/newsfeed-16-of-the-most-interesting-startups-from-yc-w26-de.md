---
title: 16 of the most interesting startups from YC W26 Demo Day | TechCrunch
url: https://techcrunch.com/2026/03/26/16-of-the-most-interesting-startups-from-yc-w26-demo-day/
site_name: newsfeed
content_file: newsfeed-16-of-the-most-interesting-startups-from-yc-w26-de
fetched_at: '2026-03-27T11:20:18.692360'
original_url: https://techcrunch.com/2026/03/26/16-of-the-most-interesting-startups-from-yc-w26-demo-day/
author: Dominic-Madori Davis
date: '2026-03-26'
published_date: '2026-03-26T19:30:00+00:00'
description: From redirecting doomscrolling to training humanoid robots, these 16 startups stood out as the most interesting ones from an overflowing YC cohort.
tags:
- techcrunch
- startups
- venture
...
ARC Prize FoundationWhat it does:Creates benchmarks to help measure progress toward AGI.
...
AvoiceWhat it does:Helps automate the tedious non-design work for architecture firms
...
Button ComputerWhat it does:A wearable AI
...
CodeWispWhat it does:Lets anyone build games using AI
...
Crosslayer LabsWhat it does:Helps detect website spoofs
...
DoomersionWhat it does:Teaches you languages as you doomscroll
...
LexiusWhat it does:Embeds advanced AI into security systems
...
Librar LabsWhat it does:An AI-powered library management system tool
...
MillirayWhat it does:Radar system to help track small drones
...
MouseCatWhat it does:Uses AI to investigate fraud
...
Opalite HealthWhat it does:Uses AI to help healthcare providers talk to non-English speakers
...
Sequence MarketsWhat it does:Let’s people trade across various markets, like crypto and prediction, on one system.
...
ShoFoWhat it does:A video library of basically everything
...
SonarlyWhat it does:Helps software fix its own production issues
...
Terranox AIWhat it does:Uses AI to find uranium deposits in North America
