---
title: I built a file transfer tool that can’t spy on you even if it wanted to - DEV Community
url: https://dev.to/aliirz/i-built-a-file-transfer-tool-that-cant-spy-on-you-even-if-it-wanted-to-2p39
site_name: devto
content_file: devto-i-built-a-file-transfer-tool-that-cant-spy-on-you
fetched_at: '2026-03-27T11:20:08.742046'
original_url: https://dev.to/aliirz/i-built-a-file-transfer-tool-that-cant-spy-on-you-even-if-it-wanted-to-2p39
author: Ali Raza
date: '2026-03-26'
description: I got tired of explaining privacy policies to people. Every time I needed to send a file to someone,... Tagged with opensource, go, webdev.
...
I couldn’t verify any of that. Neither could you.So I built phntm.sh. And I want to be honest about what it is, what it isn’t, and where it’s still rough.
...
Where it liveshttps://phntm.shhttps://github.com/aliirz/phntm.shhttps://github.com/aliirz/phntm-cli
