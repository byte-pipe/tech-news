...
site_name: hnrss
content_file: hnrss-openrocket-simulator
fetched_at: '2026-03-18T19:25:08.565054'
original_url: https://openrocket.info/
date: '2026-03-15'
description: OpenRocket is a free, fully featured model rocket simulator that allows you to design and simulate your rockets before actually building and flying them.
tags:
- hackernews
- hnrss
---
...
With a huge database of motor data fromThrustCurveyou can find the most appropriate motors for your model specifications. Easily filter and search the database for motors that are suitable for your design.
...
Connect with fellow rocket enthusiasts, ask questions about rocket designs, share your experiences, and get in touch with our developers.

Our Discord server is the perfect place todiscuss, learn, andhave fun with like-minded individuals. Click the button below to join:

Join our Discord Server

## Open source

OpenRocket is an open source program, which means you can help improve it!Check out how you can contributehere.

Did you find an issue or have a feature request?File an issueon GitHub orcontact us.