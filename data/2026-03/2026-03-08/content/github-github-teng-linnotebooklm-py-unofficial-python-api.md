---
title: 'GitHub - teng-lin/notebooklm-py: Unofficial Python API for Google NotebookLM · GitHub'
url: https://github.com/teng-lin/notebooklm-py
site_name: github
content_file: github-github-teng-linnotebooklm-py-unofficial-python-api
fetched_at: '2026-03-08T11:07:35.509619'
original_url: https://github.com/teng-lin/notebooklm-py
author: teng-lin
description: Unofficial Python API for Google NotebookLM. Contribute to teng-lin/notebooklm-py development by creating an account on GitHub.
---
...
⚠️Unofficial Library - Use at Your Own Risk

This library usesundocumented Google APIsthat can change without notice.
...
Best for prototypes, research, and personal projects. SeeTroubleshootingfor debugging tips.

## What You Can Build

🤖AI Agent Tools- Integrate NotebookLM into Claude Code or other LLM agents. Ships withClaude Code skillsfor natural language automation (notebooklm skill install), or build your own integrations with the async Python API.
...
🎙️Content Generation- Generate Audio Overviews (podcasts), videos, slide decks, quizzes, flashcards, infographics, data tables, mind maps, and study guides. Full control over formats, styles, and output.
...
Claude Code, LLM agents, natural language automation
...
URLs, YouTube, files (PDF, text, Markdown, Word, audio, video, images), Google Drive, pasted text; refresh, get guide/fulltext
...
2 formats, 9 visual styles (classic, whiteboard, kawaii, anime, etc.)
...
⚠️The main branch may contain unstable changes. Use PyPI releases for production.
