---
title: 🐾 FurEver Log — The App I Built After Losing Abu - DEV Community
url: https://dev.to/siti_aisyahmatzainal_73/furever-log-the-app-i-built-after-losing-abu-4agn
site_name: devto
content_file: devto-furever-log-the-app-i-built-after-losing-abu-dev-c
fetched_at: '2026-03-02T11:18:17.351003'
original_url: https://dev.to/siti_aisyahmatzainal_73/furever-log-the-app-i-built-after-losing-abu-4agn
author: Siti Aisyah Mat Zainal
date: '2026-02-28'
description: The Community This app is built for pet owners who suddenly become full-time caregivers. The ones... Tagged with devchallenge, weekendchallenge, showdev, catloss.
tags: '#showdev, #devchallenge, #weekendchallenge, #catloss'
---
...
What I BuiltFurEver Log – A Companion Health & Memory Tracker

A calm, structured space for tracking health and preserving moments.

Not loud.Not overly clinical.Just clear.
...
In Abu’s case, this would include:FeLV, FIP, splenic tumour, anemia.
...
When Abu’s appetite dropped.When his gums looked pale.When he felt weaker.
...
Appetite = “None” for 2 consecutive daysOR
...
It’s not fear-driven.It’s not dramatic.It’s supportive.
...
Medical data is important.But memories are everything.
...
🔗 Live Demo:https://furever-log.netlify.app/
...
💻 GitHub Repository:https://github.com/aisyahz/FurEver-Log---A-Companion-Health---Memory-Tracker.git
...
LocalStorage for persistenceChosen intentionally to ship a working prototype within a weekend.
...
At the vet.At home.At work.

I replayed conversations.I second-guessed decisions.I tried to remember every detail.
