...
content_file: hackernews_api-fontcrafter-create-your-handwriting-font-for-free
fetched_at: '2026-03-10T06:00:17.140044'
original_url: https://arcade.pirillo.com/fontcrafter.html
author: Chris Pirillo
date: '2026-03-09'
published_date: '2026-03-07T17:12:35.975Z'
description: Convert your scanned handwriting into custom OTF, TTF, and WOFF2 fonts with local browser processing and vectorization. No account or uploads needed.
tags:
- hackernews
- trending
---
...
FontCrafter exports four formats:OTF(OpenType, best for desktop apps like Word and Photoshop),TTF(TrueType, universal compatibility),WOFF2(compressed web font for websites), andBase64(for embedding directly in CSS). All formats are generated locally.
...
Characters withgreen borderswere detected cleanly. Click any character todeselectit — a replacement from another row will be used. Small imperfections are fine — they give your font personality.
...
Name your font and choose how your three rows should be used. Enableligaturesfor natural-looking connected letter pairs.
...
Characters to treat as descenders
...
Ligatures are letter pairs that connect naturally in handwriting — likeff,fi,fl,th, andst. Auto-generate is recommended — it's instant and produces natural-looking connections from your existing characters.
