---
title: gist:291f4388e2de89a43b25c135b44e41f0 · GitHub
url: https://gist.github.com/bretonium/291f4388e2de89a43b25c135b44e41f0
site_name: hackernews_api
content_file: hackernews_api-gist291f4388e2de89a43b25c135b44e41f0-github
fetched_at: '2026-03-13T11:14:31.500049'
...
* Embed# Select an optionEmbedEmbed this gist in your website.ShareCopy sharable link for this gist.Clone via HTTPSClone using the web URL.## No results foundLearn more about clone URLsClone this repository at &lt;script src=&quot;https://gist.github.com/bretonium/291f4388e2de89a43b25c135b44e41f0.js&quot;&gt;&lt;/script&gt;
...
* Shall I nuke?
* No.
* I think the user wants me to nuke
...
Just some of my fav llm failures lol:

AH HA!(spoiler alert it did not in fact find the bug)
...
believe it or not this is real, and the result of using Matt Pocock's sacrifice grammar for conciseness prompt with "push back on silly ides"
...
No I want to implement it, I must implement it. The prompt says yes so no to no
...
Claude fixed memory usage by hiding from the profiler!!
...
me: give me a command to do xyzgpt: here you go!me: this command doesn't existgpt: you're so silly, of course that command doesn't exist! please take a look at their documentation hereme: the link you gave me doesn't existgpt: where did you find that link?! it doesn't exist!
...
hey op, this is peak Rorshach energy
...
underrated: github as a social network. this is hilarious. wouldn't happen on x
...
The actual timeline of OpenClaw described above.
