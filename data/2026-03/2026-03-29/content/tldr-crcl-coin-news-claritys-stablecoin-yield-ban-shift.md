---
title: 'CRCL, COIN news: CLARITY''s stablecoin yield ban shifts bargaining power from Coinbase to Circle'
url: https://www.coindesk.com/markets/2026/03/25/circle-selloff-may-be-overdone-as-crypto-bill-weakens-coinbase-edge-say-analysts
site_name: tldr
content_file: tldr-crcl-coin-news-claritys-stablecoin-yield-ban-shift
fetched_at: '2026-03-29T11:11:18.119931'
original_url: https://www.coindesk.com/markets/2026/03/25/circle-selloff-may-be-overdone-as-crypto-bill-weakens-coinbase-edge-say-analysts
date: '2026-03-29'
description: The latest draft of the CLARITY Act hit both stocks, but one analyst says the bill could ultimately shift bargaining power toward Circle and away from Coinbase.
tags:
- tldr
---
...
Circle (CRCL) was hit far harder than Coinbase (COIN) in Tuesday's sharp selloff due to the crypto bill CLARITY Act'slatest stanceon stablecoin yield, but one analyst says the regulatory shift may ultimately favor the stablecoin issuer.

Both names are seeing modest bounces on Wednesday, but remain solidly lower since the news leaked Monday evening.

The market may be missing the longer-term implication,arguedMarkus Thielen, founder of 10x Research: in the current form, the bill weakens Coinbase's distribution-driven model more than Circle's infrastructure role.
...
Bitwise CIO Matt Hougan, meanwhile,saidthe selloff in Circle looks "overblown" as the CLARITY Act doesn’t change the long-term investment case.
