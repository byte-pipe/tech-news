---
title: Market structure bill compromise draws wide-ranging reaction from fractured crypto crowd
url: https://www.coindesk.com/policy/2026/03/25/market-structure-bill-compromise-draws-wide-ranging-reaction-from-fractured-crypto-crowd
site_name: tldr
content_file: tldr-market-structure-bill-compromise-draws-wide-rangin
fetched_at: '2026-03-29T11:11:18.429114'
original_url: https://www.coindesk.com/policy/2026/03/25/market-structure-bill-compromise-draws-wide-ranging-reaction-from-fractured-crypto-crowd
date: '2026-03-29'
description: The yield agreement, seen as a step toward finally advancing the stalled market structure bill, hasn't yet won industry support.
tags:
- tldr
---
...
* Coinbase and some others in the crypto industry aren't comfortable with the language pitched by lawmakers this week on the stablecoin yield section of the Clarity Act, sources said, but nobody has declared a definitive opposition.
* An industry call was said to highlight some sharp differences of opinion over how to proceed with the crypto market structure bill talks.
* The bankers, which represent the other side on the stablecoin yield debate, haven't revealed their view of the latest compromise language.
...
The crypto industry's potential concerns with the approach pitched this week,first reported by CoinDesk, alreadycaused chaos in the marketfor leading U.S. stablecoin issuer Circle and Coinbase's stock. Circle stock dropped 20% on Tuesday, though it ticked up slightly on Wednesday. However, Tuesday's news from its chief rival, Tether, aboutsubmitting to an auditmay have been another factor in the hit to Circle's shares, observers noted.

Despite negative responses to the Clarity Act revisions, Patrick Witt, the White House's crypto adviser, criticized the "uninformed" people making predictions about the Clarity Act's status.

"It’s all going to work out," heposted Wednesday on social media site X(formerly Twitter). "Bullish."

One of the people advocated taking a step back:
