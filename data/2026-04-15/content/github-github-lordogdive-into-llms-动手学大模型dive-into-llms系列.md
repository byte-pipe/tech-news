---
title: 'GitHub - Lordog/dive-into-llms: 《动手学大模型Dive into LLMs》系列编程实践教程 · GitHub'
url: https://github.com/Lordog/dive-into-llms
site_name: github
content_file: github-github-lordogdive-into-llms-动手学大模型dive-into-llms系列
fetched_at: '2026-04-15T11:55:48.335044'
original_url: https://github.com/Lordog/dive-into-llms
author: Lordog
description: 《动手学大模型Dive into LLMs》系列编程实践教程. Contribute to Lordog/dive-into-llms development by creating an account on GitHub.
---
...
作为能够更充分模拟真实世界的多模态大语言模型，其如何实现更强大的多模态理解和生成能力？多模态大语言模型是否能够帮助实现AGI？
...
想要饭来张口、解放双手？那么让我们一起来让AI Agent替你点外卖、回消息、购物比价吧！
