---
title: I'm switching my phone from Android to Linux. – runarcn.no
url: https://runarcn.no/android-to-linux/
site_name: hackernews_api
content_file: hackernews_api-im-switching-my-phone-from-android-to-linux-runarc
fetched_at: '2026-08-06T12:55:08.492024'
original_url: https://runarcn.no/android-to-linux/
author: speckx
date: '2026-08-05'
description: Since Android is becoming increasingly more locked down and slopped, I'm jumping ship.
tags:
- hackernews
- trending
---
...
For the past months or even years, I've become more and more dissatisfied with the path Google has taken with the Android Open Source Project (AOSP). Be it the dependency and insanetrackingof Google Play Services,locking downof device trees to hinder custom ROM development, all the AI stuff being put into the system, or most recently (and perhaps worst),removingthe ability of installing apps per your own wishing - it's become sort of like a "death by a thousand papercuts" situation. While the AOSP isn't exactly dead (yet), it kind of feels like it's just a question of time. Therefore, I've decided to jump ship. I'm installing linux on my phone.
