...
content_file: hackernews_api-oracle-just-halved-its-always-free-arm-limits-here
fetched_at: '2026-08-06T07:11:16.531011'
original_url: https://www.cnelecar.com/blog/oracle-always-free-arm-limits-cut-2026/
author: Louis
date: '2026-08-06'
published_date: '2026-08-05T14:50:00+08:00'
description: Oracle cut its Always Free ARM limits to 2 OCPU / 12GB, enforced Aug 18, 2026. Resize or consolidate your free instances before they're terminated.
tags:
- hackernews
- trending
---
...
If you’re running any Ampere A1 ARM instance larger than2 OCPUs or 12 GB of RAM— or more than one of them — you need to act beforeAugust 18, 2026, or Oracle will terminate the excess automatically. Your two free x86 instances are untouched.
...
Resource
Old limit
New limit (enforced Aug 18, 2026)
ARM (Ampere A1) OCPU
Up to 4 OCPUs
Up to 2 OCPUs
ARM memory
...
x86 micro instances
2 × 1 OCPU / 1 GB
2 × 1 OCPU / 1 GB (unchanged)
Other Always Free services
Available
Remain available

One thing that trips people up: the ARM limit is atenancy-wide pool, not per instance. You get 2 OCPUs and 12 GB total to divide however you like — one 2/12 instance, or two 1/6 instances — but the sum can’t go over. And it’s separate from the two always-free x86 instances, which keep their own allowance.
...
Two 2/12 instances add up to4 OCPUs and 24 GB— exactly double the new pool. You can’t keep both.Pick one, back up its data, and terminate it.Keep the other at 2/12, and you’re sitting right at the limit.
...
* Assuming stopping an instance frees the allocation.It often doesn’t. To drop under the limit, you generally need toterminate, not just stop. Check your tenancy’sLimits, Quotas and Usageto see what’s actually counting.
...
The free ARM tier is nowhalfof what it was. If you’re over the new 2 OCPU / 12 GB pool, you have untilAugust 18, 2026to fix it.
