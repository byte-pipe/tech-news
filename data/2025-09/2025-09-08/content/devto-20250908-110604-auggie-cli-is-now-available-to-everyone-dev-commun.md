---
title: Auggie CLI is Now Available to Everyone! 🚀 - DEV Community
url: https://dev.to/augmentcode/auggie-cli-is-now-available-to-everyone-hkg
site_name: devto
fetched_at: '2025-09-08T11:06:04.120727'
original_url: https://dev.to/augmentcode/auggie-cli-is-now-available-to-everyone-hkg
author: Emma Webb
date: '2025-09-02'
description: Hey DEV community! We've got some exciting news to share. After a month of private beta testing with... Tagged with ai, webdev, cli, programming.
tags: '#ai, #webdev, #cli, #programming'
---

Hey DEV community! We've got some exciting news to share.

After a month of private beta testing with thousands of developers who made Auggie their go-to coding agent, we're thrilled to announce thatAuggie CLI is now available to everyone.
...
Create specialized workflows and repeatable actions tailored to your needs. Whether it's code review, updating documentation, or any other routine task, you can trigger these withauggie command <name>or use slash commands directly in the terminal UI.
...
Start using Auggie CLI today with one command:npm install -g @augmentcode/auggie. And because we genuinely want to hear how you're using Auggie, we built in a feedback command (/feedback) to make sharing your thoughts effortless.
