...
site_name: hnrss
content_file: hnrss-comparison-of-ai-models-across-intelligence-perfor
fetched_at: '2026-07-25T11:28:32.145503'
original_url: https://artificialanalysis.ai/models
date: '2026-07-24'
description: Comparison and analysis of AI models across key performance metrics including quality, price, output speed, latency, context window & others.
tags:
- hackernews
- hnrss
---
...
Comparison and analysis of AI models across key performance metrics including quality, price, output speed, latency, context window & others. Click on any model to see detailed metrics. For more details including relating to our methodology, see our 
FAQs.
...
SeePrompt Cachingfor the full breakdown.
...
Mercury 2 is the fastest at 820.7 tokens per second, followed by Gemini 3.5 Flash-Lite (421.1 t/s) and HyperNova 60B 2605 (420.8 t/s).
...
Gemini 2.5 Flash-Lite (Non-reasoning) has the lowest time to first token at 0.34s, followed by Command A+ (0.42s) and North Mini Code (0.50s).
