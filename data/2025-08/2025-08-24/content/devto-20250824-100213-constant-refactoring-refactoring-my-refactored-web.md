---
title: 'Constant Refactoring: Refactoring my refactored Website - DEV Community'
url: https://dev.to/ingosteinke/constant-refactoring-refactoring-my-refactored-website-4pf
site_name: devto
fetched_at: '2025-08-24T10:02:13.435130'
original_url: https://dev.to/ingosteinke/constant-refactoring-refactoring-my-refactored-website-4pf
author: Ingo Steinke, web developer
date: '2025-08-20'
description: Constant deprecation and breaking changes in npm packages cause "software rot" even for... Tagged with webdev, programming, productivity.
...
* add case studies
* revise landing pages for specific audiencesend-customers (startups, small businesses, preferably with an ethcial focus)recruiters and "agencies" (B2B web development companies)fellow developers to collaborate withdesigners to collaborate with.
...
* use popular mainstream toolsreplace Codecept by Cypress or Playwrightevaluate if Eleventy is still a good choice
...
* ensure that my content is consistent acrossmy portfolio website (Ingo-Steinke.de)my blog posts (DEV,Open Mind Culture,Substack)social mediaCV (PDF documents)public profiles (LinkedIn, Freelancermap,GitHub Pages, etc.)internal profiles (recruiters, business partners)business cards
