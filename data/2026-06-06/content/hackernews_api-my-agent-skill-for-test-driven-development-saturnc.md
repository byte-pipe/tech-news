---
title: My Agent Skill for Test-Driven Development - SaturnCI - Continuous Integration for Ruby on Rails
url: https://www.saturnci.com/my-agent-skill-for-test-driven-development.html
site_name: hackernews_api
content_file: hackernews_api-my-agent-skill-for-test-driven-development-saturnc
fetched_at: '2026-06-06T19:33:13.579783'
original_url: https://www.saturnci.com/my-agent-skill-for-test-driven-development.html
author: laxmena
date: '2026-06-04'
description: 'SaturnCI: Continuous Integration for Ruby on Rails'
tags:
- hackernews
- trending
---
...
Unfortunately, I don't expect uncoached agents to get much better at
 ...
 quality, but, sadly, the testing practices preached byteachersare often pretty bad as well. It's truly rough out there.
...
The good news is that I've found that, with a bit of guidance, agents are
 ...
 can serve as a close enough approximation to the truth, is Kent Beck'sCanon TDD.
...
Since it's a living document, I don't want to bake my TDD skill into this
 ...
 Instead,you can see my TDD skill here on GitHub.
 Having said that, I can certainly share the essence of the skill here
 since I'm sure that that isn't going to change.

First I clue the agent in to what I call thespecify-encode-fulfillloop, which is my personal alternative to
...
My TDD skill contains a bit more detail but this is the essence of the
 ...
 tests themselves, though, so I have a different skill for that,Test Design Review.
...
Many test design violations are just violations of general software
 ...
 I like to feed them through mySoftware Design Reviewskill as well.
