...
site_name: newsfeed
content_file: newsfeed-ais-most-important-protocol-is-getting-a-little-bi
fetched_at: '2026-07-21T11:37:34.005821'
original_url: https://techcrunch.com/2026/07/20/ais-most-important-protocol-is-getting-a-little-bit-easier-to-use/
author: Russell Brandom
date: '2026-07-20'
published_date: '2026-07-20T20:50:40+00:00'
description: Under the new system, the protocol will take a looser, "stateless" approach to session IDs on the server side, similar to how most ordinary websites already work.
tags:
- techcrunch
- ai
- mcp
...
Theofficial specfor the new version has been public since May, but we got anunusually clear explanationof the changes Monday morning from the folks at Arcade — a two-year-old startup that’s built its entire business around the work of getting AI agents to actually function inside real companies, letting them securely connect to and act on tools like Gmail, Slack, and Salesforce.
