---
title: 'GitHub - dottxt-ai/outlines: Structured Outputs · GitHub'
url: https://github.com/dottxt-ai/outlines
site_name: github
content_file: github-github-dottxt-aioutlines-structured-outputs-github
fetched_at: '2026-07-21T11:37:20.988939'
original_url: https://github.com/dottxt-ai/outlines
author: dottxt-ai
...
Made with ❤👷️ by the team at.txtTrusted by NVIDIA, Cohere, HuggingFace, vLLM, etc.
...
Audit your schema: share one schema, we show you what breaks under generation, the constraints that fix it, and compliance rates before and after. Sign uphere.

## Table of Contents

* Why Outlines?
* Quickstart
* Real-World Examples🙋‍♂️ Customer Support Triage📦 E-commerce Product Categorization📊 Parse Event Details with Incomplete Data🗂️ Categorize Documents into Predefined Types📅 Schedule a Meeting with Function Calling📝 Dynamically Generate Prompts with Re-usable Templates
...
# "Summary: Good laptop with great display but thermal issues"
...
print
(
f"Successfully extracted data for 
{
structured_count
}
 of 
...
"This restaurant exceeded all my expectations. Fantastic service!"
...
Constrain outputs to predefined options

Multiple Choices Guide →

Function Calls

Infer structure from function signatures

Function Guide →

JSON/Pydantic

Generate outputs matching JSON schemas
...
Enforce complex output structures
...
Separate complex prompts from code

Template Guide →

Custome types

Intuitive interface to build complex types

Python Types Guide →

Applications

Encapsulate templates and types into functions
...
Follow us onTwitteror check out ourblogto stay updated on our latest work in making LLMs more reliable.
