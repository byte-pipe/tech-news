---
title: 'GitHub - paperswithbacktest/awesome-systematic-trading: A curated list of awesome libraries, packages, strategies, books, blogs, tutorials for systematic trading. · GitHub'
url: https://github.com/paperswithbacktest/awesome-systematic-trading
site_name: github
content_file: github-github-paperswithbacktestawesome-systematic-tradin
fetched_at: '2026-07-28T11:43:09.189954'
original_url: https://github.com/paperswithbacktest/awesome-systematic-trading
author: paperswithbacktest
description: A curated list of awesome libraries, packages, strategies, books, blogs, tutorials for systematic trading. - paperswithbacktest/awesome-systematic-trading
---
...
* 97 libraries and packagesfor research and live trading
* 40+ strategiesdescribed by institutionals and academics
* 55 booksfor beginners and professionals
* 23 videosand interviews
* And also someblogsandcourses

## 📈 Interested in trading strategies implemented in Python?

Visit our comprehensive collection atpaperswithbacktest.comfor exclusive content!

Click here to see the full table of content

* Libraries and packagesBacktesting and Live TradingGeneral - Event Driven FrameworksGeneral - Vector Based FrameworksCryptocurrenciesTrading botsAnalyticsIndicatorsMetrics computationOptimizationPricingRiskBroker APIsData SourcesGeneralCryptocurrenciesData ScienceDatabasesGraph ComputationMachine LearningTimeSeries AnalysisVisualization
* Backtesting and Live TradingGeneral - Event Driven FrameworksGeneral - Vector Based FrameworksCryptocurrencies
* General - Event Driven Frameworks
* General - Vector Based Frameworks
* Cryptocurrencies
* Trading bots
* AnalyticsIndicatorsMetrics computationOptimizationPricingRisk
* Indicators
* Metrics computation
* Optimization
* Pricing
* Risk
* Broker APIs
* Data SourcesGeneralCryptocurrencies
* General
* Cryptocurrencies
* Data Science
* Databases
...
* TimeSeries Analysis
* Visualization
* StrategiesBonds, commodities, currencies, equitiesBonds, commodities, equities, REITsBonds, equitiesBonds, equities, REITsCommoditiesCryptosCurrenciesEquities
...
* Currencies
* Equities
* BooksBeginnerBiographyCodingCryptoGeneralHigh Frequency TradingMachine Learning
* Beginner
* Biography
* Coding
* Crypto
...
List of97 libraries and packagesimplementing trading bots, backtesters, indicators, pricers, etc. Each library is categorized by its programming language and ordered by descending populatrity (number of stars).
...
A Go implementation of the [ta-lib]((
https://github.com/mrjbq7/ta-lib
) with streaming update support
...
List of40+ academic papersdescribing original systematic trading strategies. Each strategy is categorized by its asset class and ordered by descending Sharpe ratio.

👉 Strategies are now hostedhere.
...
A comprehensive list of55 booksfor quantitative traders.
