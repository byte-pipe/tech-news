...
content_file: hackernews_api-postgres-backed-durable-workflow-execution-dbos
fetched_at: '2026-05-29T12:06:56.320430'
...
Most commonly, durable workflows are implemented viaexternal orchestration. This is the pattern used by systems like Temporal, Airflow, and AWS Step Functions. In this model, durable programs are written as workflows of steps whose execution is coordinated by a central orchestrator.
