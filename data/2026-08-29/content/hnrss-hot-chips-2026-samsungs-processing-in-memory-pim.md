...
site_name: hnrss
content_file: hnrss-hot-chips-2026-samsungs-processing-in-memory-pim
fetched_at: '2026-08-29T15:29:05.932260'
original_url: https://chipsandcheese.com/p/hot-chips-2026-samsungs-processing
author: Chester Lam
date: '2026-08-29'
description: In-memory compute with LPDDR5X
tags:
- hackernews
- hnrss
---
...
This isn’t a very high figure, but an implementation with many LPDDR5X chips will have higher aggregate throughput. For example, eight LPDDR5X chips together would have 9.6 INT8 TOPS, which just about matches theNPU in Intel’s Meteor Lake. That would also be an expensive setup, because eight 16 GB LPDDR5X chips would correspond to 128 GB of system memory.
