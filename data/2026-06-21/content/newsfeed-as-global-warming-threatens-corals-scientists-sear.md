...
site_name: newsfeed
content_file: newsfeed-as-global-warming-threatens-corals-scientists-sear
fetched_at: '2026-06-21T11:06:44.001681'
original_url: https://arstechnica.com/science/2026/06/as-global-warming-threatens-corals-scientists-search-for-reefs-that-can-take-the-heat/
date: '2026-06-19'
published_date: '2026-06-19T11:15:11+00:00'
description: Researchers say these coral strongholds may help repopulate more degraded reefs.
tags:
- ars-technica
- features
- science
...
Since 2023, record-breaking marine heat waves have swept through the tropics, fuelingthe most severe global coral bleaching event ever recorded. More than 80 percent of the world’s reefs have been impacted in at least 83 countries and territories. Corals have been so stressed by the extreme temperatures, they’ve expelled the tiny algae living inside their tissues that provide them with food and their brilliant hues, leaving them pale, ghostly and struggling to survive. Many have not recovered.
...
Coastal development projects such as ports or harborsthat require dredgingcan bury corals beneath sediment. Agricultural runoff,sewageand plastic pollution introduce harmful pathogens and excess nutrients that spark coral disease or toxic algal blooms that suffocate the tiny animals. Bottom trawling—a fishing method that drags weighted nets across the seafloor—can crush entire reefs, while dynamite fishing can shatter centuries-old coral colonies in seconds.

“That would be like taking a sledgehammer to crush a hermit crab,” Cohen said.

Already, the world has lost more than half of its coral reefs to the combined pressures of climate change and other human activity. Some scientists warn that without significant intervention,more than 90 percent of tropical reefs coulddisappear in the next 25 years.
...
A 2021 World Bank analysisshows 40 percent of existing buildings in Majuro are endangered by rising sea levels driven by global warming. Several of them are local schools.
...
Credit:Paul Horn/Inside Climate NewsCredit:Paul Horn/Inside Climate News
...
Recently, her team at theCohen Labat Woods Hole has begun training AI models to analyze these images automatically.
...
More recently, conservationists have started to advocate for the protection of“blue corridors”—migratory pathwaysused by marine megafauna, such as whales and sharks, to travel between different habitats used to feed, mate, or give birth to their young.
...
Corallarvae can drift hundreds of milesfrom their parents before settling on a reef for the rest of their lives.
...
Forecasters recently warnedthat El Niño conditions have formed once again in the tropical Pacific and are expected to strengthen by this fall.
...
This article originally appeared onInside Climate News, a nonprofit, non-partisan news organization that covers climate, energy, and the environment. Sign up for their newsletterhere.
...
1. 1.Android verification is coming: Google confirms timeline and supported app stores
2. 2.NASA asks Northrop Grumman to stop working on lunar HALO module
3. 3.Rocket Report: Rebuild begins at Blue Origin launch pad; Relativity targets Mars
4. 4.A bold satellite rescue mission came together in record time, but will it work?
5. 5.Tesco moving 40,000 server workloads off VMware amid Broadcom's “abusive conduct”
