---
title: Opus 4.5 is going to change everything · Burke Holland
url: https://burkeholland.github.io/posts/opus-4-5-change-everything/
site_name: hackernews_api
fetched_at: '2026-01-07T19:11:12.244220'
original_url: https://burkeholland.github.io/posts/opus-4-5-change-everything/
author: tbassetto
date: '2026-01-06'
...
I don’t have a fancy landing page for this one yet, but you can view all of the source codehere.
...
When I say that Opus 4.5 built this almost entirely, I mean it. It used thefirebaseCLI to stand up any resources it needed and would tag me in for certain things like upgrading a project to the Blaze plan for features like storage, etc. The best part was that when the Firebase cloud functions would throw errors, it would automatically grep those logs, find the error and resolve it. And all it needed was a CLI. No MCP Server. No fancy prompt file telling it how to use Firebase.
...
What youdon’tneed: variable names, formatting, comments meant for humans, or patterns designed to spare your brain.

What youdoneed: simple entry points, explicit code with fewer abstractions, minimal coupling, and linear control flow.
...
Each time you complete a task or learn important information about the project, you should update the
`.github/copilot-instructions.md`
 or any
`agent.md`
 file that might be in the project to reflect any new information that you've learned or changes that require updates to these instructions files.
