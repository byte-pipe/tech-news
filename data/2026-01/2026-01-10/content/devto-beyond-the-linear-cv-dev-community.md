...
site_name: devto
fetched_at: '2026-01-10T11:07:10.763741'
...
## Real-World Challenge: The €25 Debugging Journey

The Mystery:My CV Knowledge Graph app spiked from €5.60 to a projected €28/month.

The Obvious Culprit:a bot (185.136.92.x) hitting my app 180 times/day.

The Plot Twist:Deep log analysis revealed:
...
The Real Problem:Users closing browser tabs without disconnecting, leaving WebSockets open for 60+ seconds.

The Solution:

# Simple timeout reduction
...
Result:€28/month →€2.96/month(-89%)

Lessons Learned:

1. Always profile before optimizing
2. The "obvious" culprit isn't always guilty
3. Sometimes the simplest fix is the best one
