---
title: CSS Optical Illusions - DEV Community
url: https://dev.to/alvaromontoro/css-optical-illusions-58j
site_name: devto
fetched_at: '2026-01-18T11:06:35.714268'
original_url: https://dev.to/alvaromontoro/css-optical-illusions-58j
author: Alvaro Montoro
date: '2026-01-15'
description: A collection of optical illusions created with CSS. Tagged with css, html, webdev, showdev.
tags: '#showdev, #css, #html, #webdev'
---

Over the past week, I have coded a series of optical illusions using CSS only (and some HTML for one of them, but most of them are CSS only). I createda collection on CodePen with 40 of them, although the number may grow in the next few weeks.
...
For this one (and the next one), I used asuper ingenious wave shape generatorby@afif.
