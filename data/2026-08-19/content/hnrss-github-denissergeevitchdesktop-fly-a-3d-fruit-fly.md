---
title: 'GitHub - DenisSergeevitch/desktop-fly: A 3D fruit fly living on your macOS desktop, driven by a live spiking simulation of the real FlyWire connectome · GitHub'
url: https://github.com/DenisSergeevitch/desktop-fly
site_name: hnrss
content_file: hnrss-github-denissergeevitchdesktop-fly-a-3d-fruit-fly
fetched_at: '2026-08-19T11:23:15.682178'
original_url: https://github.com/DenisSergeevitch/desktop-fly
date: '2026-08-18'
description: A 3D fruit fly living on your macOS desktop, driven by a live spiking simulation of the real FlyWire connectome - DenisSergeevitch/desktop-fly
tags:
- hackernews
- hnrss
---
...
simulation of the realFlyWireconnectome. It walks across your windows, grooms, sleeps, and decides to flee
...
leaky-integrate-and-fire (LIF) simulation:LC4 (104) + LPLC2 (210)looming-detector visual neuronsDNp01 / Giant Fiber (GF) (2)— the escape command neuronDNa01 + DNa02 (4)steering neurons ·DNp09 (2)forward walkingDNg11 (6)grooming ·MDN (4)backward walking ("moonwalker")DNp02/DNp04/DNp11 (6)escape-maneuver (wing) neuronstheir 330 strongest partners, including ascending (proprioceptive) and
...
the wind→GF pathway.Typing is vibration(idle-time API — knowswhenkeys were pressed, never which).
...
cd
 - 
&&
 python3 etl.py /tmp/flywire

## Diagnostics

./DesktopFly --simtest 
#
 circuit invariants: GF silent at rest, 4 ms loom latency, ...

./DesktopFly --behaviortest 
#
 17 end-to-end checks: stimulate neurons -> body reacts

./DesktopFly --snapshot f.png 
#
 offscreen fly render

./DesktopFly --brainshot b.png 
#
 offscreen brain render
...
Code is MIT. The files indata/are derived from FlyWire (FAFB v783) and
areCC BY-NC 4.0— seedata/DATA_LICENSE.md.
