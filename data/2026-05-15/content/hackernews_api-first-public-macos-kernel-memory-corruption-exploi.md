...
content_file: hackernews_api-first-public-macos-kernel-memory-corruption-exploi
fetched_at: '2026-05-15T11:42:15.764101'
original_url: https://blog.calif.io/p/first-public-kernel-memory-corruption
author: Calif
date: '2026-05-14'
description: Apple spent five years building hardware and software to make memory corruption exploits dramatically harder. Our engineers, working together with Mythos Preview, built a working exploit in five days.
tags:
- hackernews
- trending
---
...
Early this week, we had a meeting at Apple Park in Cupertino. While there, we also shared with Apple our latest vulnerability research report: the first public macOS kernel memory corruption exploit on M5 silicon, survivingMIE. It waslaserprinted, in honor of our hacker friends.
...
Memory corruption remains the most common vulnerability class everywhere, including iOS and macOS. In security, if you can’t fully prevent something, youaccept the riskmitigate it by making exploitation more expensive.
...
Apple spent five years building it. Probably billions of dollars too. According to their research, MIEdisruptsevery public exploit chain against modern iOS, including the recently leaked Coruna and Darksword exploit kits.
...
Our hosts shared that Apple spent $5 billion building this “office”, then asked about our office. We said, well, ours definitely costlessthan $1 billion.
