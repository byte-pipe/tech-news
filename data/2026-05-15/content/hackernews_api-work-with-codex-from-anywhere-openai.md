---
title: Work with Codex from anywhere | OpenAI
url: https://openai.com/index/work-with-codex-from-anywhere/
site_name: hackernews_api
content_file: hackernews_api-work-with-codex-from-anywhere-openai
fetched_at: '2026-05-15T11:42:16.015733'
original_url: https://openai.com/index/work-with-codex-from-anywhere/
author: mikeevans
date: '2026-05-14'
...
* Programmatic access tokensprovide scoped credentials that can be issued directly from ChatGPT workspace settings for CI pipelines, release workflows, and internal automations.
