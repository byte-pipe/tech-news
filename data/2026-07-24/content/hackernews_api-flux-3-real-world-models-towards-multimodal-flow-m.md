---
title: 'FLUX 3 - Real World Models: Towards Multimodal Flow Models as the Backbone of Visual Intelligence. | Black Forest Labs'
url: https://bfl.ai/blog/flux-3
site_name: hackernews_api
content_file: hackernews_api-flux-3-real-world-models-towards-multimodal-flow-m
fetched_at: '2026-07-24T11:34:55.999316'
original_url: https://bfl.ai/blog/flux-3
author: Black Forest Labs
date: '2026-07-24'
published_date: '2026-07-23T15:00:00.000Z'
description: FLUX 3, our new multimodal frontier model, jointly learns from images, video, and audio to build one representation of the world. Now available in Early Access.
tags:
- hackernews
- trending
---
...
FLUX 3 builds onSelf-Flow,our approach for efficiently aligning multimodal generation and understanding within the same underlying architecture. Based on this approach, we significantly scaled up compute and data resources to train FLUX 3 across video, images, and audio at the same time.
...
FLUX 3 Video is now available inEarly Access here
...
If you are interested in exploring and building with FLUX 3, get in touch here. If you are interested in contributing to our mission, join us! We arehiringin Germany and the US.