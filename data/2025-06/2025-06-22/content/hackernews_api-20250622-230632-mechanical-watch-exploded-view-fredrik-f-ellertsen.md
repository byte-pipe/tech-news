---
title: 'Mechanical Watch: Exploded View - Fredrik F. Ellertsen'
url: https://fellerts.no/projects/epoch.html
site_name: hackernews_api
fetched_at: '2025-06-22T23:06:32.268644'
original_url: https://fellerts.no/projects/epoch.html
author: fellerts
date: '2025-06-22'
description: 'Mechanical Watch: Exploded View'
tags:
- hackernews
- trending
---
...
In May 2022, someone posted to Hacker NewsBartosz
 Ciechanowski's
 blog postexplaining how mechanical watch movements work. Since then, his blog has
 ...
 illustrations are magnificent.The first illustration in his blog post about mechanical watch movements
 ...
 cool would it be to hold an exploded view of arealmechanical
 watch in your hand?

Screenshot of the exploded view render fromBartosz
 Ciechanowski's
 blog post.
...
Building an exploded view of a mechanical watch movement is undoubtedly
 ...
 watch is assembled. People with that skillset are called watchmakers.Maker, not "destroyer for the sake of art". I guess it falls to
...
Here comes my favorite part: jumping head-first into a project requiring
 ...
 about building a real-life exploded view of a mechanical watch movement?The first thing to consider is what type of mechanical watch movement to
 "explode". Although he doesn't explicitly say, I think Bartosz
 Ciechanowski's blog post is based on theETA caliber
 2824-2mechanical watch movement (or one of its many clones, such as
 ...
 industry. I highly encourage the curious reader to check outthis YouTube videoof a very skilled and equally witty watchmaker servicing a Hamilton
 ...
 would be much better.Luckily, in the late 1800's to early 1900's, many people carried a
 ...
 gorgeous, hand-engraved movements from the turn of the 20th century oneBayfor next to nothing.Pocketwatches are the simplest mechanical watch movements out there:
 ...
 out practicing on pocketwatch movements.Now for the hard part: How do you suspend 50-100 tiny components to form
...
The first two problems can probably be solved by throwing money at the
 ...
 epoxy instead.To achieve the effect I want, I need around 20 layers for a regular
 ...
 the ideal mold for casting the silicone.My resin disks solved problems 1 and 2 above, but problem 3 is still
...
It took a while to accept that the only hope I had was to cast the
 ...
 pour resin all over it and then pull out any air bubbles.Scarred and burnt by resin's index of refraction, I went looking for
 ...
 than what I started with.The assembly process actually resembles "proper" watchmaking a lot. Of
 ...
 do it with glue instead of oil---CA glue being thecomplete
 oppositeof a lubricant.Armed with a pair of helping hands and a set of self-closing tweezers, I
...
At this point I've tried a number of different epoxy resins claiming to
 ...
 the vacuum chamber does a good job of pulling out the trapped air.My casting method goes like this: Mix enough of part A and B of your
 ...
 pop most of the bubbles.Now pour the resin into the mold and go through the vacuum process
...
My first somewhat promising cast was in a borosilicate class cylinder. I
 ...
 and answer a few burning questions with this prototype:Q:How visible is the fishing line in the final result?A:Not very! It's visible in the right light, but I don't
 think I'm able to do any better.Q:Does CA glue interfere with the resin in any way?A:Most resin datasheets say that CA glue can interfere with
 the resin's curing process, but I can't tell from this test.Q:Does casting in a cylinder make sense?A:Definitely not. Light refracts on the curved cylinder
 surface making it difficult to understand the geometry inside,
 defeating the purpose of the model. Cast in a cube.A week or so later, the cylinder shattered. Resin shrinks as it cures. On
...
At this point I have settled on a somewhat structured process.### Disassemble and cleanStart with a clean, disassembled movement. For instructions on how to
 properly disassemble and clean a watch movement, I highly recommentMark
 ...
 use of an activator.I made a small jig for cutting pieces of fishing line accurately and
 squarely out of a janky hand press tool.### Assemble trainwheel sideWork starts on the train wheel side of the movement (often called the
 ...
 More glue binds the bridges to the fishing line.Subassemblies such as of the keyless works, motion works, balance
 ...
 working on: the fishing line's flat ends allows it to stand upright.### Flip and assemble the dial sideBefore starting work on the dial side of the movement, it must be flipped
 ...
 casting resin.### Make the mold, prepare and pour resinSpeaking of the mold: I bought some 2 mm thick 20x30 cm acrylic sheets.
 ...
 adhesive to form a cube.Prototype #2 shows a lot of promise! It's far from perfect, though. Here
 are some of the things I'll improve for prototype #3 in no particular
 order:I struggled with attaching subassemblies to the mainplate because
 ...
 (tiny scissor lift) might solve this, so one is on the way.The resin shrunk a lot while curing, most likely because it
 overheated. I'll focus on proper airflow for my next cast.People noted that it's difficult to see between the components, so
 I'll "explode" the next model even more.The hands are set to an invalid time. 10:10 is the way to go.
...
The third iteration incorporated the scissor lift lab jack into the
 ...
 case.I also started using a CA accelerator to speed up the assembly, because
 ...
 when spraying accelerant after the joint has glue in it.You may see that the balance wheel is hanging from the hairspring in
...
At this point I figured I was ready to tackle the final boss of this
 project: the ETA 2824 wristwatch movement that we've all seen inBartosz Ciechanowski's
...
This movement arrived from China in good working order---I was actually
 ...
 issue here though.I was worried that the much smaller components would be challenging to
 ...
 breeze.Some components needed special care, in particular the balance shock
 ...
 hands of a watch---another watchmaker's trick.The assembly process was luckily uneventful, and I finished the build
 ...
 milky streaks throughout the casting.All in all, I spent roughly 18 hours stripping, cleaning and assembling
 the exploded view of the PT5000. With improved technique I might get
 this down below 15 hours, but it'sverytedious work, and rushing
...
Prototype #4 has a couple flaws which I'd like to fix before calling
 ...
 painted surfaces. Here's what didn't work:CA glue dissolves paint just as readily as epoxy resin. It might
 ...
 preserve.UV curable CA glue didn't cure on top of the paint. No idea why.Same with UV curable epoxy resin.Clear spray lacquer from the hardware store worked well and didn't
 ...
 well.There's not much more to say. I'll stop blabbering and make way for an
 image series.
...
I don't have the tools or knowledge required to sand this down to a
 ...
 in case I decide to continue working on this... I mean, moreinterestingwristwatch movements do exist!

Bartosz, if you are reading this,contactme and I'll send you the final casting. This
