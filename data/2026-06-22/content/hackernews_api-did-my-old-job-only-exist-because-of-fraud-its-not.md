---
title: Did my old job only exist because of fraud? – It's not about code
url: https://david.newgas.net/did-my-old-job-only-exist-because-of-fraud/
site_name: hackernews_api
content_file: hackernews_api-did-my-old-job-only-exist-because-of-fraud-its-not
fetched_at: '2026-06-22T13:05:23.771989'
original_url: https://david.newgas.net/did-my-old-job-only-exist-because-of-fraud/
author: advisedwang
date: '2026-06-21'
description: Did my old job only exist because of fraud?
tags:
- hackernews
- trending
---
...
A decade later I heard from a former colleague that Frost was beingsued by the SEC for fraud. Still not sure what to make of my time at GenieDB, I was curious enough to skim the complaint, where I saw this line:
...
The case went to binding arbitration2and the investors won, after which the SEC sued to bar Frost from managing funds in the future. There’s some great elements like claiming a personal chef and cleaner as expenses, telling investors no salary would be paid by the fees (it was) and starting a marketing company just to sponsor someone’s visa.
...
To me, this email shows that the investments were motivated by the fees3and GenieDBwasbeing used to siphon investor money away. I felt like an ant. My career, my family, my citizenship all would be completely different except for this fraud. This story plays out between investors, multi-millionaire VCs, judges, and my entire life isn’t even a footnote.
