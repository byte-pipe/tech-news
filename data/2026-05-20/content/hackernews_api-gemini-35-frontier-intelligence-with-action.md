...
content_file: hackernews_api-gemini-35-frontier-intelligence-with-action
fetched_at: '2026-05-20T06:00:17.341316'
...
* For everyone via the Gemini app and AI Mode inGoogle Search
...
Gemini 3.5 was developed in accordance with our Frontier Safety Framework. We have strengthened our cyber and CBRN safeguards, which means it's less likely to generate harmful content, and to mistakenly refuse to answer safe queries. We achieve this with new, more advanced safety training and mitigations, includinginterpretability toolsthat help check and understand the AI's inner reasoning before it provides a response.
