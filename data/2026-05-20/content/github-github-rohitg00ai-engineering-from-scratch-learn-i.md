---
title: 'GitHub - rohitg00/ai-engineering-from-scratch: Learn it. Build it. Ship it for others. · GitHub'
url: https://github.com/rohitg00/ai-engineering-from-scratch
site_name: github
content_file: github-github-rohitg00ai-engineering-from-scratch-learn-i
fetched_at: '2026-05-20T12:02:48.283995'
original_url: https://github.com/rohitg00/ai-engineering-from-scratch
author: rohitg00
description: Learn it. Build it. Ship it for others. Contribute to rohitg00/ai-engineering-from-scratch development by creating an account on GitHub.
---
...
Every lesson follows six beats. TheBuild It / Use Itsplit is the spine — you implement the
...
Option A — read.Open any completed lesson onaiengineeringfromscratch.comor expand a phase underContents. No setup, no cloning.
...
* You want to understand how AIactually works, not just call APIs.
...
Other curricula end with"congratulations, you learned X."Each lesson here ends with areusable toolyou can install or paste into your daily workflow.
...
Drop into Claude, Cursor, Codex, OpenClaw, Hermes, or any agent that reads 
SKILL.md
.
...
Install the lot withSkillKit. Real tools, not
...
outputs/skill-agent-loop.mdship it
...
### Phase 0: Setup & Tooling12 lessons
...
Install them withSkillKit. Plug them into Claude, Cursor,
...
"Models will keep getting better. The skill that compounds isknowing what to build."— Industry consensus, 2026
...
Maintained byRohit Ghumareand the community.
...
* https://github.com/rohitg00/ai-engineering-from-scratch/blob/main/SPONSORS.md
