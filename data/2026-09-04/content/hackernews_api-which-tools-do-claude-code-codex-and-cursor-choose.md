---
title: Which tools do Claude Code, Codex and Cursor choose? We measured 16,893 sessions to find out. · Armature
url: https://armature.tech/blog/which-tools-coding-agents-install
site_name: hackernews_api
content_file: hackernews_api-which-tools-do-claude-code-codex-and-cursor-choose
fetched_at: '2026-09-04T21:14:40.470322'
original_url: https://armature.tech/blog/which-tools-coding-agents-install
author: The Armature team
date: '2026-09-03'
published_date: '2026-09-03'
description: We watched almost 17k sessions across different types of personas, with 1,163 prompt variations, 75 repositories and 3 coding agents (Claude Code, Codex, Cursor) actually implementing the solutions instead of just recommending one.
tags:
- hackernews
- trending
---
...
* Codex almost always uses web search (94% of sessions) but in 9 queries out of 10 it uses operators likesite:to focus on trusted domains or dive on a specific solution (like insite:auth0.com password reset MFA social connectionsfor example)
...
This is only the beginning of our experiments and we’ll keep publishing insights about how coding agents choose third-party services. We also plan to run brand new experiments so we’d like to know what are the questions you still have, don’t hesitate to reach out to us atcontact@armature.tech.
