...
site_name: hnrss
content_file: hnrss-analysis-package-golangorgxtoolsgoanalysis-go-pack
fetched_at: '2026-07-27T06:50:45.072518'
original_url: https://pkg.go.dev/golang.org/x/tools/go/analysis
date: '2026-07-26'
description: 'Go Analysis Framework: modular static analysis by go team'
tags:
- hackernews
- hnrss
---
...
The primary type in the API isAnalyzer. An Analyzer statically
...
TheAnalyzertype has more fields besides those shown above:
...
APassdescribes a single unit of work: the application of a particular
...
TheDiagnosticstruct does not have a field to indicate its severity
...
* type PackageFact
* type Pass
* func (pass *Pass) ReportRangef(rng Range, format string, args ...any)func (pass *Pass) Reportf(pos token.Pos, format string, args ...any)func (pass *Pass) String() string
...
// module version ("" if unknown, such as for workspace modules)
...
// go version used in module (e.g. "go1.22.0")
...
#### typeModuleError¶added inv0.43.0
...
// the identity of the current analyzer
...
// the abstract syntax tree of each file

	OtherFiles []
string
 
// names of non-Go files of this package

	IgnoredFiles []
string
 
// names of ignored source files in this package
...
// type information about the package
...
// type information about the syntax trees
...
// type errors (only if Analyzer.RunDespiteErrors)

	Module *
Module
 
// the package's enclosing module (possibly nil in some drivers)
