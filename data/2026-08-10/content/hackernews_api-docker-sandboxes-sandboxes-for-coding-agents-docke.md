---
title: Docker Sandboxes | Sandboxes for Coding Agents | Docker
url: https://www.docker.com/products/docker-sandboxes/
site_name: hackernews_api
content_file: hackernews_api-docker-sandboxes-sandboxes-for-coding-agents-docke
fetched_at: '2026-08-10T11:45:54.815721'
original_url: https://www.docker.com/products/docker-sandboxes/
author: etoxin
date: '2026-08-10'
description: Secure sandboxes for Claude Code, Gemini, Codex, and Kiro. Run coding agents with microVM-based isolation.
tags:
- hackernews
- trending
---
...
# Run AI agents safely in local sandboxes.
 ...
 Disposable, isolated sandboxes for AI agents like 
Claude Code, Gemini CLI, Copilot CLI, Codex, OpenCode,
 and 
Kiro
 that need safe, unattended execution.
...
Docker AI Governance
 adds network access policies, filesystem controls, and org-wide MCP governance: defined once, enforced everywhere.
Talk to us about:
