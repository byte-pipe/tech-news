...
content_file: hackernews_api-auto-mode-is-now-the-default-in-claude-code-for-pr
fetched_at: '2026-08-10T11:45:55.533436'
original_url: https://claude.com/blog/auto-mode-default-in-claude-code
author: sbehere
date: '2026-08-10'
...
Learn how these customers arerunning auto mode in production.
...
To switch modes, press Shift+Tab in the CLI or use the mode dropdown on the desktop app. Admins can pin an org-wide default with `defaultMode` inmanaged settings, or turn auto mode off entirely with `disableAutoMode`.
