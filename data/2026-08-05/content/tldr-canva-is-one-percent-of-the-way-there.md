...
url: https://mili.dev/writing/canva-is-one-percent-of-the-way-there/
site_name: tldr
content_file: tldr-canva-is-one-percent-of-the-way-there
fetched_at: '2026-08-05T12:53:18.477811'
original_url: https://mili.dev/writing/canva-is-one-percent-of-the-way-there/
date: '2026-08-05'
description: I spent three years inside the most ambitious company I've ever seen, and the way it works is a preview of how every company will soon have to work.
tags:
- tldr
---
...
In 2011, before there was a company, Mel made a deck for something calledCanvas Chef. The pitch was that you could describe an idea and have it appear, designed, without knowing anything about design. Fifteen years later she stood on stage at Canva Create andquoted her own deck back to the roomwhile launching an AI that does exactly that.

From the original 2011 Canvas Chef deck, viaNBT’s archive of the pitch.
...
None of it holds without a second voice, and Cliff is that voice. He and Mel are married, they built a$42 billion companytogether, and he is one of the best operators I’ve ever seen. He’ll say the thing he actually thinks in front of anyone, and on the occasions he and Mel read a decision differently, it gets worked through in the open rather than sanded down before the room. That’s how a team learns how decisions really get made.

Canva’s plan has two steps: become one of the most valuable companies in the world, then do the most good it can. Mel and Cliff have committedmore than 80% of their wealth, including 30% of the company, much of it tohanding unconditional cash to people in extreme poverty, about the least self-flattering way to give money away that exists. It’s the ambition pointed outward.
