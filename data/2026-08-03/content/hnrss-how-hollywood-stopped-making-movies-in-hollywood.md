...
site_name: hnrss
content_file: hnrss-how-hollywood-stopped-making-movies-in-hollywood
fetched_at: '2026-08-03T19:33:31.826092'
original_url: https://www.statsignificant.com/p/how-hollywood-stopped-making-movies
author: Daniel Parris
date: '2026-07-28'
description: The economics behind where movies are filmed, why Hollywood left Los Angeles, and whether audiences can tell the difference.
tags:
- hackernews
- hnrss
---
...
In the days after the wildfires, filmmaker Sarah Smith and writer Alexandra Pechman organized a WhatsApp group of showrunners and industry workers, drafted a petition, and launched the grassroots#StayInLAcampaign. What began as an emergency effort to help Los Angeles rebuild grew into a broader political movement, drawing more than 20,000 petition signatures, endorsements from prominent actors and filmmakers, and even the fleeting attention of Donald Trump—an actor himself, best known for his performance inHome Alone 2: Lost in New York.
...
1. The rise of the blockbuster:In the 1970s, box-office smashes likeThe GodfatherandJawsdemonstrated the commercial potential of event cinema. By the 1980s, corporatized studios like Paramount-Gulf-Western were actively manufacturing blockbusters, pouring ever-growing budgets into spectacle-driven stories. Films likePredator,First Blood, andRaiders of the Lost Arkwere shot on location in jungles, deserts, and other far-flung settings, as exotic locales amplified their sense of scale.
...
In some cases, this globe-trotting appears directly on screen, like whenMission: Impossiblestages an elaborate car chase through Rome. In other cases, location choice is driven entirely by financial considerations.
...
Subscribe to Stat Significant and receive new data essays every week.
...
3. The Warner Bros. backlot was eerily empty:I had grown up on movies likeThe PlayerandSingin’ in the Rain,where Hollywood appeared as a bustling factory of overlapping productions squeezed onto compact studio lots. Instead, I found emptiness.

This combination of things led to a bizarre summer where me and a posse of underutilized unpaid interns wandered a near-vacant Warner Bros. studio as if it were the Backrooms. This meant hanging out in the Central Perk set fromFriendsor cart-racing other interns fromThe Ellen DeGeneres Showon the street where they filmedGilmore Girls.
...
Thanks for reading Stat Significant! To receive new posts, consider becoming a free or paid subscriber.

Subscribe

## Enjoyed the analysis? Support Stat Significant and unlock the data behind the insights.
...
* Bonus Data Stories:Full access to theMonday Roundup, a bonus edition with extra culture data stories, curated datasets, and recommended reads.
* The Public Dataset Directory(Updated Weekly):A curated directory of public datasets from around the web.
* Interactive Data Hubs:Interactive dashboards acrossStreaming TV,Movies,Music,Search Trends,Wikipedia, and more.

Upgrade to Paid

###### *Note: For best results, open this link in a web browser while logged in to your Substack account.

Stat Significant is a reader-supported publication. To receive new posts and support my work, consider becoming a free or paid subscriber.
...
Want topromote your data tool or media publicationto Stat Significant’s 26,200 readers?Emaildaniel@statsignificant.com

Need help with a data problem?Book a free data consultation

Connect with me onLinkedInif you want to chat about a data project.
