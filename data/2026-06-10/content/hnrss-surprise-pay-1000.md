...
site_name: hnrss
content_file: hnrss-surprise-pay-1000
fetched_at: '2026-06-10T12:07:48.182978'
original_url: https://forestwalk.ai/blog/surprise-blacksmith-costs/
date: '2026-06-09'
description: What's the right behaviour when "try for free" ends?
tags:
- hackernews
- hnrss
---

← Forestwalk Blog: The Understory

Like many developer teams, we’ve been getting fed up with GitHub Actions. As our PR throughputhas gone up, it’s increasingly obvious that our CI actions are too slow and expensive.

While there are a lot of ways to mitigate this, we’d been encouraged to tryBlacksmith.
...
We asked for clarification, and Blacksmith support informed us that the previous warning of “disruption” was not that service wouldstop, but that it might be flagged for suspicious activity.
...
While amusingly as of June 8 Blacksmith’stermsimplied that their right to bill you is contingent on you providing payment information, a SaaS app certainlycouldhave terms that obligate users to pay for unexpected overage when on a free trial.

And let’s be clear: our agents run a lot of CI jobs, so we did expect to hit the limits of the free plan. We used the service and got value for it. So it’s not inherently dishonest, just surprising. My read is that theycando this.
...
No weekly digest. No "thought leadership." Just us, when we have something worth saying.
