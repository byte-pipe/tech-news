...
content_file: hackernews_api-gpt-2-too-dangerous-to-release-2019-naoki-shibuya
fetched_at: '2026-06-10T07:43:24.548148'
original_url: https://naokishibuya.github.io/blog/2022-12-30-gpt-2-2019/
author: AbuAssar
date: '2026-06-10'
description: 'GPT-2: Too Dangerous To Release (2019)'
tags:
- hackernews
- trending
---

GPT-2 is a direct scale-up ofGPT-1, with more parameters and trained on more data. However, it was deemed too dangerous to release by OpenAI:
...
Nine months after the initial announcement of GPT-2, OpenAI decided to release the big GPT-2 with 1.5B parameters along withcode and model weights:
...
Today (December 2022), we’ve already seen how wellChatGPTperforms. So, GPT-2 does not seem so harmful. I can see that they applied what they learned into ChatGPT to prevent misuses, for example, by not impersonating people.
...
* GPT-2: Better Language Models and Their Implicationspaper,codeOpenAI
* ChatGPT: Optimizing Language Models for DialogueOpenAI