---
title: I created my first game and decided to leave GameDev - DEV Community
url: https://dev.to/embernoglow/i-created-my-first-game-and-decided-to-leave-gamedev-o9n
site_name: devto
content_file: devto-i-created-my-first-game-and-decided-to-leave-gamed
fetched_at: '2026-04-24T06:00:35.450175'
original_url: https://dev.to/embernoglow/i-created-my-first-game-and-decided-to-leave-gamedev-o9n
author: EmberNoGlow
date: '2026-04-22'
description: Hi all. I recently decided to create my first (which I showed publicly) game on Godot as part of... Tagged with gamedev, godot, discuss, productivity.
tags: '#discuss, #gamedev, #godot, #productivity'
---
...
I recently decided to create my first (which I showed publicly) game on Godot as part ofGame Name Jam. I had 14 days and was very interested in it.
...
Do you think this is normal? (yes probably)What would you do if you learned about such a defeat?What would you choose - not to give up, or to leave anyway, so that you can possibly return (or not) with new strength?
