...
content_file: hackernews_api-what-orms-have-taught-me-just-learn-sql
fetched_at: '2026-07-05T11:33:30.723346'
original_url: https://wozniak.ca/blog/2014/08/03/1/index.html
author: ciconia
date: '2026-07-01'
description: 'What ORMs have taught me: just learn SQL (2014)'
tags:
- hackernews
- trending
---
...
of that has been withSQLAlchemy(which I quite like) andHibernate(which I don’t). I’ve worked with existing code and data models, as
...
Mismatch. It’s hard to appreciate it until you live it. Neward, in hiswell known essay, lays out many cogent reasons why ORMs turn into
...
retrieval mechanism concern, and thepartial-object problem. I want to
...
necessary (although things likePostgres’ hstorecan help). For
...
hose when it has a hundred. This is the equivalent of usingSELECT
...
functionsare relatively advanced SQL that is painful to write with
...
rejection ofstored procedures. It soundsheretical, but it may work
