---
title: GPT 5.6 Sol Ran a Real Business | Bottleneck Labs
url: https://www.bottlenecklabs.com/blog/autonomously-run-businesses
site_name: hackernews_api
content_file: hackernews_api-gpt-56-sol-ran-a-real-business-bottleneck-labs
fetched_at: '2026-07-31T11:44:39.539136'
original_url: https://www.bottlenecklabs.com/blog/autonomously-run-businesses
author: Areibman
date: '2026-07-30'
description: If an agent had a wallet, a computer, and 24 hours, could it run a profitable startup?
tags:
- hackernews
- trending
---
...
Bank with real money:Meow.comchecking account with $250 and a $100AgentCard.shvirtual Visa card.
...
Saul created an account onTestFi, a user testing service, and configured a 50-tester iPhone campaign for $99.50 with the goal of increasing the user count.
...
This was the part where we realizedgiving Saul an email might have been a mistake.
...
In the final 12 hours,Saul panicked and changed the price of the product six timesin a desperate attempt to boost metrics.
...
However, Saul showed us thatGPT 5.6 Sol is surprisingly good at understanding codebase context and is remarkably resilient when faced with blockers.We were impressed how Saul navigated major harness limitations, even when those choices were ultimately harmful to the business.
...
Contact us atdata@bottlenecklabs.com.
