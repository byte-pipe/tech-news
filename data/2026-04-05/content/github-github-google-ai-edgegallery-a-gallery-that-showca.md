---
title: 'GitHub - google-ai-edge/gallery: A gallery that showcases on-device ML/GenAI use cases and allows people to try and use models locally. · GitHub'
url: https://github.com/google-ai-edge/gallery
site_name: github
content_file: github-github-google-ai-edgegallery-a-gallery-that-showca
fetched_at: '2026-04-05T11:12:29.092804'
original_url: https://github.com/google-ai-edge/gallery
author: google-ai-edge
description: A gallery that showcases on-device ML/GenAI use cases and allows people to try and use models locally. - google-ai-edge/gallery
---
...
2. Download the App:* Install the app fromGoogle PlayorApp Store.
* For users without Google Play access: install the apk from thelatest release
3. Install & Explore:For detailed installation instructions (including for corporate devices) and a full user guide, head over to ourProject Wiki!
...
Check out thedevelopment notesfor instructions about how to build the app locally.

## 🤝 Feedback

This is anexperimental Beta release, and your input is crucial!
...
Licensed under the Apache License, Version 2.0. See theLICENSEfile for details.
