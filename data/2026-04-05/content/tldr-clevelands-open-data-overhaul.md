---
title: Cleveland's open data overhaul
url: https://www.informationweek.com/data-management/cleveland-s-open-data-overhaul-from-sticky-notes-to-public-dashboards
site_name: tldr
content_file: tldr-clevelands-open-data-overhaul
fetched_at: '2026-04-05T01:01:24.155496'
original_url: https://www.informationweek.com/data-management/cleveland-s-open-data-overhaul-from-sticky-notes-to-public-dashboards
date: '2026-04-05'
description: Cleveland deployed its Open Data Policy to provide residents and businesses with data dashboards that bring transparency to the city's infrastructure.
tags:
- tldr
---
...
# Cleveland's open data overhaul: From sticky notes to public dashboards

In just a few years, the city of Cleveland established and deployed its Open Data Policy to provide residents and businesses with data dashboards that bring transparency to the city's infrastructure.
...
REDLANDS, CALIF. -- For the city of Cleveland's chief innovation and technology officer (CITO), Elizabeth Crowe, developing an opendata managementplatform in a digitally challenged environment was like being in an episode of the TV show "Hoarders." The city's departments had data residing everywhere, from local machines to clusters of sticky notes. As the lead on Cleveland's open data initiative, Crowe dug into the existing IT infrastructure for the city and uncovered a staggering 130 enterprise systems.

Tasked by Major Justin Bibb, Crowe has taken on the monumental tasks of bringing the city's public offices into the 21st century,building data dashboardsand deploying anopen data policyfor the city. Prior to her appointment as interim CITO in February, Crowe was named director and founder of the Office of Urban Analytics and Innovation (Urban AI) in August 2022.
...
To  modernize the local government offices, Crowe said her team members assessed the business problems and identified their No. 1 directive -- getting toopen data. Bibb's second executive order established an open data policy and open data governance board, a move that provided Crowe with the official backing to tell governmental departments they would need to get on board with the data management initiative.
...
Kelsey Ziser is a senior editor at InformationWeek, where she covers C-suite dynamics, data strategies and the evolving cybersecurity threat landscape. She also oversees the publication'sIT Leaders Fast-5 column, which brings peer insights to IT professionals.
...
More Insights
Webinars
* The CIO-CFO Partnership: Technology Tools for Financial Alignment
* Scaling the Edge: Architecting Cost-Effective, AI-Ready Infrastructure
* Ditch ITSM Complexity with AI & No-Code
* Your Enterprise Cyber Risk Assessment
* IT Automation in 2026: It Isn't ALL About AI (Just Mostly)
More Webinars
Industry Reports
* Beyond Legacy Virtualization: Wind River's Modern Alternative for Enterprise Infrastructure
...
* InformationWeek 2025 US Tech and IT Salary Report
* ITSM Rankings & Quadrant--See Top Platforms Compared
Access More Research
2026 IT Trends & Outlooks
* IT LeadershipThe stakes rise for the CIO role in 2026Jan 28, 2026|9 MinRead
* Digital TransformationWhat will IT transformation look like in 2026, and how do you know if you're on the right track?Jan 7, 2026|8 MinRead
* CybersecurityWhat CISOs need from AI in a new year of cyberthreatsJan 7, 2026|8 MinRead
* Machine Learning & AI13 unexpected, under-the-radar predictions for 2026Jan 5, 2026|13Slides
Download the Collection
Get a snapshot of the issues affecting CIOs, three times a week in your inbox.
Subscribe to our newsletters today.
SIGN UP
Webinars
* The CIO-CFO Partnership: Technology Tools for Financial AlignmentTuesday, May 19 at 1 pm ET
* Scaling the Edge: Architecting Cost-Effective, AI-Ready InfrastructureThurs, April 2, 2026 at 12 PM EDT
* Ditch ITSM Complexity with AI & No-CodeThurs, March 26, 2026 at 2 PM EDT
* Your Enterprise Cyber Risk AssessmentThurs, Nov. 6, 2025 at 1pm EST
* IT Automation in 2026: It Isn't ALL About AI (Just Mostly)Oct 23rd, 2025 from 11am - 5pm ET | A Sponsored Virtual Event | Doors Open at 10:30am ET
More Webinars
White Papers
* Ditch Bloated & Complex ITSM
* Beyond Chatbots: How AI Is Changing the IT Service Desk
* ITSM Rankings & Quadrant--See Top Platforms Compared
