...
site_name: tldr
content_file: tldr-build-from-anywhere-with-cursor-for-ios-cursor
fetched_at: '2026-07-01T19:58:25.549482'
original_url: https://cursor.com/blog/ios-mobile-app
author: Kevin Niparko
date: '2026-07-01'
description: Cursor is available as a native iOS app on your phone, now in public beta.
tags:
- tldr
---
...
Beyond code,cloud agentsproduce demos, screenshots, and logs that make it easy to validate their work. When an agent is done, you can review these generated artifacts, inspect diffs, leave follow-up instructions, or merge the PR directly from the app.
...
Cursor for iOS is available now in public beta on all paid plans. Get 75% off onComposer 2.5runs in the mobile app now through July 5, 2026.

Download for iOSto start building from your phone, or read thedocsto learn more.
