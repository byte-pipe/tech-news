---
title: Apple's Hide My Email could be exposing your real email address | EasyOptOuts
url: https://easyoptouts.com/guides/apple-hide-my-email-is-leaking-email-addresses
site_name: hnrss
content_file: hnrss-apples-hide-my-email-could-be-exposing-your-real-e
fetched_at: '2026-07-01T19:36:04.194231'
original_url: https://easyoptouts.com/guides/apple-hide-my-email-is-leaking-email-addresses
date: '2026-07-01'
description: The popular iCloud+ service has problems. It's possible for an attacker to discover the email address you're trying to hide.
tags:
- hackernews
- hnrss
---

# Apple's Hide My Email could be exposing your real email address

By Ben and Tyler, Co-founders

2 min read

The popular iCloud+ service has problems. It's possible for an attacker to discover the email address you're trying to hide.
...
We've discovered vulnerabilities in Hide My Email that allow attackers to discover the meant-to-be-hidden address behind a Hide My Email address.We reported the issue to Apple over a year ago, and as of June 30, 2026, it still hasn't been fixed. About a month ago, we realized that the vulnerabilities' severity and scope are greater than we initially thought. We're publicly disclosing the existence of the vulnerability now because we think Hide My Email users deserve to know that their email addresses may not actually be hidden. We want people to be able to account for this risk when deciding when and how to use Hide My Email. Many thanks toJoseph Cox at 404 Mediafor acting as a trusted third party to verify and publicize the issue responsibly.
