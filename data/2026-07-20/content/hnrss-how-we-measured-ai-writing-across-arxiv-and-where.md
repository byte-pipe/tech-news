---
title: How we measured AI writing across arXiv, and where the measurement breaks · unslop
url: https://unslop.run/blog/measuring-ai-writing-on-arxiv
site_name: hnrss
content_file: hnrss-how-we-measured-ai-writing-across-arxiv-and-where
fetched_at: '2026-07-20T19:34:47.045561'
original_url: https://unslop.run/blog/measuring-ai-writing-on-arxiv
date: '2026-07-20'
description: We scored the full text of 12,750 arXiv papers and found that about a third of new ones read as machine-written. Here is the method, the results, and an honest account of the limitations.
tags:
- hackernews
- hnrss
---
...
The detector is cheap to run and we make no money from it. You can try it for free on any arXiv paperhere, and on your own texthere.