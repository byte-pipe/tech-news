---
title: [SECURITY]: Malicious npm releases detected across `@redhat-cloud-services/` scope · Issue #492 · RedHatInsights/javascript-clients · GitHub
url: https://github.com/RedHatInsights/javascript-clients/issues/492
date: 2026-06-01
site: hackernews_api
model: gpt-oss:120b-cloud
summarized_at: 2026-06-02T06:02:31.492017
---
...
## Description
- Issue opened by **sailikhith-stepsecurity** on Jun 1 2026.
- Reports multiple compromised npm packages published under the `@redhat-cloud-services/` scope.
- References:
  - Step Security blog post detailing the compromise.  
    <https://www.stepsecurity.io/blog/multiple-redhat-cloud-services-npm-packages-compromised>
  - Step Security OSS security feed query for the affected scope.  
...
## Recommendations
- Avoid using the listed compromised versions in production environments.
- Upgrade to newer, non‑affected releases as soon as they become available.
- Monitor the Step Security feed and official Red Hat advisories for further updates.