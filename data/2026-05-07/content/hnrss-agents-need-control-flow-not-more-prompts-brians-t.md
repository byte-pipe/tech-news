---
title: agents need control flow, not more prompts | brian’s thoughts
url: https://bsuh.bearblog.dev/agents-need-control-flow/
site_name: hnrss
content_file: hnrss-agents-need-control-flow-not-more-prompts-brians-t
fetched_at: '2026-05-07T20:12:57.861532'
original_url: https://bsuh.bearblog.dev/agents-need-control-flow/
date: '2026-05-07'
description: 'Thesis: reliable agents tackling complex tasks need deterministic control flow encoded in software, not increasingly elaborate prompt chains If you’ve eve...'
tags:
- hackernews
- hnrss
---
...
If you’ve ever resorted toMANDATORYorDO NOT SKIP, you’ve hit the ceiling of prompting.

Imagine a programming language where statements aresuggestionsand functions return “Success” whilehallucinating. Reasoning becomes impossible; reliability collapses as complexity grows.
