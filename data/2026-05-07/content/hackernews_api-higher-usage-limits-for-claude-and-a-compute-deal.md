...
content_file: hackernews_api-higher-usage-limits-for-claude-and-a-compute-deal
fetched_at: '2026-05-07T12:28:56.566107'
original_url: https://www.anthropic.com/news/higher-limits-spacex
author: meetpateltech
date: '2026-05-06'
description: We’ve raised Claude's usage limits and agreed a new compute partnership with SpaceX that will substantially increase our capacity in the near term.
tags:
- hackernews
- trending
---
...
First, we’redoubling Claude Code’s five-hour rate limitsfor Pro, Max, Team, and seat-based Enterprise plans.

Second, we’reremoving the peak hours limit reduction on Claude Codefor Pro and Max accounts.

Third, we’reraising ourAPI rate limitsconsiderably for Claude Opus models, as shown in the table below:
...
* A 5 GW agreement with Googleand Broadcom, which will begin coming online in 2027;
* Astrategic partnershipwith Microsoft and NVIDIA that includes $30 billion of Azure capacity;
* Our$50 billion investmentin American AI infrastructure with Fluidstack.
...
Finally, we recently made acommitmentto cover any consumer electricity price increases caused by our data centers in the US. As part of our international expansion, we’re exploring ways to extend that commitment to new jurisdictions, as well as partnering with local leaders to invest back into the communities that host our facilities.
