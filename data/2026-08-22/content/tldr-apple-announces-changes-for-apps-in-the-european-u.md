---
title: Apple announces changes for apps in the European Union - Apple
url: https://www.apple.com/newsroom/2026/08/apple-announces-changes-for-apps-in-the-european-union/
site_name: tldr
content_file: tldr-apple-announces-changes-for-apps-in-the-european-u
fetched_at: '2026-08-22T11:19:29.484860'
original_url: https://www.apple.com/newsroom/2026/08/apple-announces-changes-for-apps-in-the-european-union/
date: '2026-08-22'
description: Apple announces changes for apps in the European Union (5 minute read)
tags:
- tldr
---
...
* Apps in the Kids categoryon the App Store will not include links to websites to complete transactions, to reduce the risk of fraud or scams targeting children.

* Forusers under 18 years old, all apps from the App Store that use alternative payment processing or link out to a website for transactions must include a parental gate that requires younger users to involve their parent or guardian before making a purchase.

* Forusers under 13 years old, apps from the App Store cannot link out to websites for transactions to protect against the risk of scams that target younger kids.
...
Apple is providing detailed resources to help developers understand the options now available for their apps in the EU, which they can access from the 
