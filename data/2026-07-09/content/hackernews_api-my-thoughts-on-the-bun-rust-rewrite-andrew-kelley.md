---
title: My Thoughts on the Bun Rust Rewrite - Andrew Kelley
url: https://andrewkelley.me/post/my-thoughts-bun-rust-rewrite.html
site_name: hackernews_api
content_file: hackernews_api-my-thoughts-on-the-bun-rust-rewrite-andrew-kelley
fetched_at: '2026-07-09T19:36:32.995513'
original_url: https://andrewkelley.me/post/my-thoughts-bun-rust-rewrite.html
author: kristoff_it
date: '2026-07-09'
description: My thoughts on the Bun Rust rewrite
tags:
- hackernews
- trending
---
...
Andrew Kelley
 - My Thoughts on the Bun Rust Rewrite (2026 Jul 09)
...
set up a monthly donation toZig Software Foundationthat amounted to
$60,000 per year. He didn't have to do either of those things, but he did,
and it was pretty cool of him. Even inhis blog post that I'm referencing,
...
to hit differently for me. It's one thing tochoose a poor work-life balance for oneself; a different thing entirely todemand it of others:

"Oven is going to be a grind, especially the first nine months or so. If
work-life balance means a lot of time spent not working, it's probably not a
good fit."
...
Bun's codebase. Hacks on top of hacks.Abuse of assertions.Most of all, recklessly speeding past feature after feature
...
By this time, we all felt at ZSF that Bun was a net liability, and this wasbeforeRoboBun became the #1 contributor. Along with the discomfort of
...
caused not only a surge ofdrive by slop contributions,
...
The blog post is expertly written. It'salmostlike the marketing department of a
...
warn you about yourcomptimeabuse for years. We even madethis time report thingspecifically for projects that need to audit their use ofcomptime/inlineusage and compile times.
...
One, I'm genuinely grateful for the donations ZSF received from Bun.We spent that money paying contributors to work on Zig.
