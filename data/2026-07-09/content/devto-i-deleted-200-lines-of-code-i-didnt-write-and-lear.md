---
title: I Deleted 200 Lines of Code I Didn't Write and Learned More Than When I Wrote It... - DEV Community
url: https://dev.to/gamya_m/i-deleted-200-lines-of-code-i-didnt-write-and-learned-more-than-when-i-wrote-it-18dd
site_name: devto
content_file: devto-i-deleted-200-lines-of-code-i-didnt-write-and-lear
fetched_at: '2026-07-09T19:36:35.394974'
original_url: https://dev.to/gamya_m/i-deleted-200-lines-of-code-i-didnt-write-and-learned-more-than-when-i-wrote-it-18dd
author: Gamya
date: '2026-07-09'
description: Quick note before we dive in — I know I've been off track from the iOS/Swift series lately. I just... Tagged with devops, programming, ai, career.
...
With generated code, the code arrived and the context didn't come with it. The AI made decisions — some of them genuinely good decisions — and I accepted them without understandingwhythey were the decisions. So now I'm standing here six weeks later, looking at my own project like a stranger, trying to figure out which parts are load-bearing and which are just decoration.

This is exactly as uncomfortable as it sounds.

## So I Started Making Predictions

Before I deleted anything, I started asking myself: okay, if I remove this, what do I think breaks? Not what could break in theory. What do Ithinkwill happen, specifically.
...
Some of it I rewrote from scratch. Not because the original was wrong. Because rewriting it meant I finallyownedit. There's a difference between code you're managing and code you understand, and I needed to close that gap before I could trust myself to work on it properly.
