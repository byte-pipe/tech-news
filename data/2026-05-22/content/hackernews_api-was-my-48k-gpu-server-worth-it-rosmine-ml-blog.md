---
title: Was my $48K GPU server worth it? – Rosmine ML Blog
url: https://rosmine.ai/2026/05/13/was-my-48k-gpu-worth-it/
site_name: hackernews_api
content_file: hackernews_api-was-my-48k-gpu-server-worth-it-rosmine-ml-blog
fetched_at: '2026-05-22T11:58:07.664500'
original_url: https://rosmine.ai/2026/05/13/was-my-48k-gpu-worth-it/
author: apwheele
date: '2026-05-18'
published_date: '2026-05-13T14:43:44+00:00'
description: In 2024 I quit my FAANG job to become an independent researcher. To do this I needed GPUs, so I built "grumbl", a 6x 6000 Ada GPU server. This blog describes the build, some of the issues I faced, and answers the question "was it worth it to build the server myself, or should I…
tags:
- hackernews
- trending
---
...
I found Tim Dettmers’guide to choosing a GPUhelpful. From that I narrowed it down to A100’s, H100’s or RTX 6000 Ada. A100’s don’t support FP8 and have slower inference performance than the newer GPUs, and I’m going to be doing a lot of inference (RL), so narrowed it down to 6000 Ada vs H100. Looking at theprice/throughputratios of 6000 Ada vs H100 vs A100, I went with the 6000 Ada GPUs.
...
* Several of the failures were due to riser issues, and Nathan Odle’sriser investigationwas very helpful for debugging
...
Questions? Comments?DM me on Xor E-mail me at hello@rosmine.ai
