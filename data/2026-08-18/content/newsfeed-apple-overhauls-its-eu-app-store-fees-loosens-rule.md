---
title: Apple overhauls its EU App Store fees, loosens rules for alternative app stores | TechCrunch
url: https://techcrunch.com/2026/08/18/apple-overhauls-its-eu-app-store-fees-loosens-rules-for-alternative-app-stores/
site_name: newsfeed
content_file: newsfeed-apple-overhauls-its-eu-app-store-fees-loosens-rule
fetched_at: '2026-08-18T19:26:18.644459'
original_url: https://techcrunch.com/2026/08/18/apple-overhauls-its-eu-app-store-fees-loosens-rules-for-alternative-app-stores/
author: Sarah Perez
date: '2026-08-18'
published_date: '2026-08-18T17:12:13+00:00'
description: Apple is simplifying its EU App Store fees, replacing its per-install fee with a 5% commission for apps distributed outside the App Store and making it easier for developers to operate alternative app marketplaces.
tags:
- techcrunch
- apps
- commerce
...
The tech giant hadadjustedits App Store fees in the EU last year after regulatorsfined Apple €500 millionfor noncompliance with the EU’s Digital Markets Act (DMA) and threatened further fines. In doing so, Apple presented a more complex fee structure, which criticscalledan example of “malicious compliance.” The old structure included an initial acquisition fee, store services fees, and different tiers of service based on developers’ needs.
