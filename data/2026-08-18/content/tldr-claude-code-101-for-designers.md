...
site_name: tldr
content_file: tldr-claude-code-101-for-designers
fetched_at: '2026-08-18T19:26:12.415128'
original_url: https://yaronschoen.com/blog/claude-code-101-for-designers/
author: Yaron Schoen
date: '2026-08-18'
description: What Claude Code actually is, plus a plain-language decoder for the jargon around it. Models, tokens, agents, MCP, and friends.
tags:
- tldr
---
...
Claude Code runs inside the terminal (a full tour of which is thenext post), and it always works from inside a folder: whatever folder you start it in becomes its workspace.

### But the terminal can live inside an app

If the raw terminal isn't your thing, it doesn't have to be a standalone window. Code editors like VS Code come with a terminal built in, and apps likeRigadigdigor evenDenotedress the whole experience up in friendlier clothing (full disclosure: those two tools are mine). Same engine, different outfit.
...
This post is part ofClaude for Designers, a series of posts helping product designers get comfortable designing and building with Claude Code.
