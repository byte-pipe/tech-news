---
title: 'Dario Amodei on X: "1/2 Thanks Gavin for an especially thoughtful exchange. I don''t usually spend much time on social media but I wanted to engage here because it really brings out the heart of an important conversation. First, on regulation, I think that “either concentrate it in the hands of a" / X'
url: https://twitter.com/DarioAmodei/status/2088758816376807762
site_name: hackernews_api
content_file: hackernews_api-dario-amodei-on-x-12-thanks-gavin-for-an-especiall
fetched_at: '2026-08-18T11:23:02.037807'
original_url: https://twitter.com/DarioAmodei/status/2088758816376807762
author: jacquesm
date: '2026-08-17'
published_date: '2026-08-15T22:44:43.000Z'
description: 1/2 Thanks Gavin for an especially thoughtful exchange. I don't usually spend much time on social media but I wanted to engage here because it really brings out the heart of an important conversation. First, on regulation, I think that “either concentrate it in the hands of a
tags:
- hackernews
- trending
---
...
# Dario Amodei on X: "1/2 Thanks Gavin for an especially thoughtful exchange. I don't usually spend much time on social media but I wanted to engage here because it really brings out the heart of an important conversation.

First, on regulation, I think that “either concentrate it in the hands of a"

* Dario Amodei@DarioAmodei1/2 Thanks Gavin for an especially thoughtful exchange. I don't usually spend much time on social media but I wanted to engage here because it really brings out the heart of an important conversation.
...
BTW I do not think that the events of the last few months have “failed to result in [my] preferred regulatory path”.  The approach that the Trump administration is reported to be taking — pre-deployment testing for frontier models, and also testing of open-weights models when they get closer to the frontier — is one that I am very supportive of, though of course I have to see the details to be sure.  I am also supportive of Demis Hassabis’ ideas around a FINRA-like entity.  This contrasts with six months ago when most of the industry was still pushing for preemption of all state regulation and no apparent federal approach either.Gavin Baker@GavinSBakerAug 15Replying to@_sholtodouglasSholto, thank you for setting the record straight. Larger issue is that multiple very serious people in Silicon Valley have heard some variation of this and believe it to be true. And the reason it is believable to so many is that it is consistent with Dario’s public messagingShow more10:44 PM · Aug 15, 20266.6MViews1.1K8598.8K9.3K
* Dario Amodei@DarioAmodeiAug 152/2 Second, on the messaging around AI.  I do not agree that my messaging has been disproportionately negative.  In fact it has been about equally balanced between risks and benefits: I’ve written one major essay about each, and even in interviews where I discuss the risks, IShow more1.1K6058.8K11M
* signüll@signulllAug 15i understand your dislike of social media but it would be immensely valuable for everyone if you participated in at least a subset of discourse on this platform. would greatly appreciate it.2871.5K65K