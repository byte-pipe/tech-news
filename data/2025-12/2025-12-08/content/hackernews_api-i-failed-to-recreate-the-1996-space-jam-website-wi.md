---
title: I failed to recreate the 1996 Space Jam Website with Claude | j0nah.com
url: https://j0nah.com/i-failed-to-recreate-the-1996-space-jam-website-with-claude/
site_name: hackernews_api
fetched_at: '2025-12-08T19:07:10.103784'
original_url: https://j0nah.com/i-failed-to-recreate-the-1996-space-jam-website-with-claude/
author: thecr0w
date: '2025-12-07'
...
07.12.2025—claude,ai,space jam,web development,computer vision—14min read

Link to the Hacker News post. Thanks everybody for all the engagement!

Hey somebody did it! Check it outhere.
...
Final note: I use "he" to refer to Claude, whichJoshfinds ridiculous.

## Space Jam, 1996

For those who don't know, Warner Bros keeps thisanachronistic websiteonline that was released in 1996 to accompany the Space Jam movie.
...
Correction: The original site is built using tables. Thanks towilsmexandsqirclesfor calling that out!
...
Your
 job is to recreate the landing page
as
 faithfully
as
 possible
...
* Tool to take screenshots of hisindex.htmlfile to compare iteratively with the original
...
When I dug into the logs, it appeared that Claude actuallydiduse the grids. He pulled out these numbers:
...
In one iteration, Claude built himself a helper:compare.htmla little side by side viewer so he could look at his screenshot and the reference together. It didn't help him at all, but my God was he convinced it did.
...
* Iteration 2 (25px grid):he decides he needs "more precise positioning" and shifts theentireorbit inward by ~20 pixels. Planets go from roughly a 250px radius to ~230px. He is now confidently converging on the wrong answer.
...
CRITICAL
:
 remember that the zoomed image is zoomed
in
 to
200
%
...
When
 you're creating your version
,
 maintain proper proportions
,
 meaning that your version should keep the same relative spacing
as
