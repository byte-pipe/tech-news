---
title: I Fed 24 Years of My Blog Posts to a Markov Model - Susam Pal
url: https://susam.net/fed-24-years-of-posts-to-markov-model.html
site_name: hackernews
fetched_at: '2025-12-14T19:06:47.686164'
original_url: https://susam.net/fed-24-years-of-posts-to-markov-model.html
author: zdw
date: '2025-12-14'
---
...
Yesterday I shared a little program calledMark V. Shaney
 Junioratgithub.com/susam/mvs. It
 ...
 Wikipedia articleMark
 V. Shaneyfor more details about it. In this post, I will
...
The program I shared yesterday has only about30 lines of
 Pythonand favours simplicity over efficiency. Even if you have
 ...
 and make complete sense of it. I also offer an explanationfurther belowin this post.
...
Once in a while, I get the itch to take one of those exploratory
 ...
 repo along with aREADME.md,CHANGES.mdand the whole shebang and share it ongithub.com/susamandcodeberg.org/susam. The
 Mark V. Shaney Junior program that I shared yesterday happened to be
 one such exercise.

## Gibberish

If you scroll down theREADMEof this
 ...
 training the model onA Christmas Carolby Charles Dickens,
 ...
 just head over to theGibberishsection of the README.

Soon after sharing the project, I wondered what kind of gibberish it
 would produce if I fed all 24 years of my blogposts and pagesinto the program.
...
This is the text that comes out after the program consumes over 200
 ...
 acomments sectionwith over 500
...
No, I have never said anywhere that opening a Lisp source file could
 ...
 'Lisp source file' phrase from myLisp in Vimpost and the
 'self-esteem' bit from theFrom Perl
 to Pipost.
