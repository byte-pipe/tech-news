...
site_name: devto
fetched_at: '2025-12-02T11:08:01.751232'
...
First, the basics. GitHub has this neat feature where if you create a public repository with the same name as your username, e.g.nickytonline/nickytonline, it becomes a special profile repository where the README.md in the repo displays directly on your profile page.
...
* Videos from:my YouTube channelwork video contentvideos where I'm a guest
* my YouTube channel
* work video content
...
Each section between the HTML comments gets automatically replaced by the content generated by the GitHub Actions. Theblog-post-workflowaction looks for the default<!-- BLOG-POST-LIST:START -->and<!-- BLOG-POST-LIST:END -->comments, but you can customize this with thecomment_tag_nameparameter like I do for my newsletter section (NEWSLETTER-POST-LIST).
