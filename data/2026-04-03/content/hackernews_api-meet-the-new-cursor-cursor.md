...
content_file: hackernews_api-meet-the-new-cursor-cursor
fetched_at: '2026-04-03T11:18:59.935511'
original_url: https://cursor.com/blog/cursor-3
author: Sualeh Asif
date: '2026-04-02'
description: Cursor 3 is a unified workspace for building software with agents.
tags:
- hackernews
- trending
---
...
In the last year, we moved from manually editing files to working with agents that write most of our code. How we create software will continue to evolve as we enter thethird era of software development, where fleets of agents work autonomously to ship improvements.
...
Cloud agents produce demos and screenshots of their work for you to verify. This is the same experience you get atcursor.com/agents, now integrated into the desktop app.
...
Cursor can use the built-inbrowserto open, navigate, and prompt against local websites.

### #Plugins on the Cursor Marketplace

Browse hundreds ofpluginsthat extend agents with MCPs, skills, subagents, and more. Install with one click, or set up your ownteam marketplaceof private plugins.
...
Upgrade Cursor, and typeCmd+Shift+P -> Agents Windowto try the new interface. Or learn more in ourdocs.
