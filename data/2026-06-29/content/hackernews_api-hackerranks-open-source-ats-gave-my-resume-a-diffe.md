...
content_file: hackernews_api-hackerranks-open-source-ats-gave-my-resume-a-diffe
fetched_at: '2026-06-29T19:22:49.148601'
original_url: https://danunparsed.com/p/hackerrank-open-source-ats
author: Dan Kinsky
date: '2026-06-29'
description: I ran HackerRank's open-source ATS on my resume 100 times. Same resume, different score every time. Here's why.
tags:
- hackernews
- trending
---
...
It’s popped up on LinkedIn and Reddit with hundreds, sometimes thousands, of likes.1A coworker mentioned it to me in passing a few days ago.
...
I disabledDEVELOPMENT_MODEand put it in a loop to run a hundred times.
...
Thanks for reading. If you found that interesting let me know, otherwise I won’t know to keep making these.

Subscribe

Correction (June 28): A reader flagged that theresume_evaluation_criteria.jinjatemplate says “Software Intern” on line 1 — nowhere documented, nowhere else referenced in the repo. The same template that later gives bonus points for “founder roles, co-founder positions, or early-stage engineer roles.” I re-ran with an explicit Senior SWE prompt and got identical results — the scoring dimensions are position-agnostic.

1

ViralLinkedIn(read at your own risk) andRedditposts. They both claim the repo was open-sourced recently, but based on commit history it’s more likely that it just blew up recently and has been open sourced since October 2025.

2

Non-determinism at temperature 0 was flagged inthis GitHub issue, opened October 2025.
