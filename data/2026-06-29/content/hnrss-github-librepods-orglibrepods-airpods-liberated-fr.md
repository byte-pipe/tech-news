...
site_name: hnrss
content_file: hnrss-github-librepods-orglibrepods-airpods-liberated-fr
fetched_at: '2026-06-29T19:23:05.281664'
original_url: https://github.com/librepods-org/librepods
date: '2026-06-28'
description: AirPods liberated from Apple's ecosystem. Contribute to librepods-org/librepods development by creating an account on GitHub.
tags:
- hackernews
- hnrss
---
...
Please report any other such websites tome@kavish.xyz
...
* Personalized volume
* Loud Sound Reduction (needsVendorID spoofing)
* Microphone side
* Pause media when falling asleep (needs a recent firmware)
* EnableOff listening modeto switch toOff
...
You can do this on Linux by editing the DeviceID in/etc/bluetooth/main.conf. Add this line to the config fileDeviceID = bluetooth:004C:0000:0000. For android you can enable theact as Apple devicesetting in the app's settings (shown only when Xposed is available and LibrePods module is enabled).
...
Some parts of the UI components were borrowed fromKyant0's demo app, which is licensed underApache License 2.0.

## Linux (rewrite)

Theaacp.rsand theatt.rsfiles were translated from Kotlin to Rust with AI. Some parts of themedia_controller.rsfile, mainly the pulse integration, was also AI-generated.
...
* @hackclub for hostingHigh SeasandLow Skies!
...
* MagicPods - if you're looking for "LibrePods for Windows" (ms storeinstaller|website)
...
If you see any misuse of the LibrePods name or logo, please report it tome@kavish.xyz.
