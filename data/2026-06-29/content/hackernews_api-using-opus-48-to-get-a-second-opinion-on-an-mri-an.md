...
content_file: hackernews_api-using-opus-48-to-get-a-second-opinion-on-an-mri-an
fetched_at: '2026-06-29T19:22:46.956852'
original_url: https://antoine.fi/mri-analysis-using-claude-code-opus
author: engmarketer
date: '2026-06-29'
description: My experiencing trying to get a second opinion on my shoulder injury using Claude Code. It's a fascinating glimpse into the future but it's hard to have full confidence in the results just yet.
tags:
- hackernews
- trending
---
