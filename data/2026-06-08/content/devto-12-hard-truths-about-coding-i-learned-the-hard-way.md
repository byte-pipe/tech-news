...
site_name: devto
content_file: devto-12-hard-truths-about-coding-i-learned-the-hard-way
fetched_at: '2026-06-08T12:33:19.552572'
original_url: https://dev.to/canro91/12-hard-truths-about-coding-i-learned-the-hard-way-after-10-years-124j
author: Cesar Aguirre
date: '2026-06-08'
description: I got fired from my first job, took down a database server with a badly written query, and was... Tagged with career, careerdevelopment, beginners, coding.
tags: '#career, #careerdevelopment, #beginners, #coding'
---
...
This is what I callMassive Unrequested Refactorings.
...
— "Entity Framework is the best."— "No, it's painfully slow."— "Nooo, stored procedures are the best"

Arrggg!

Tools are just tools.That's why we, coders, have the reputation of being opinionated and grumpy.And please, let's not talk about clean code and best practices. That'sa subject I changed my mind about.
...
If any of that resonates, check outStreet‑Smart Coding, the roadmap with 30 practical lessons I wish I had starting out my coding journey.
