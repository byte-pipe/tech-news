---
title: 'GitHub - Egonex-AI/Understand-Anything: Graphs that teach > graphs that impress. Turn any code into an interactive knowledge graph you can explore, search, and ask questions about. Works with Claude Code, Codex, Cursor, Copilot, Gemini CLI, and more. · GitHub'
url: https://github.com/Egonex-AI/Understand-Anything
site_name: github
content_file: github-github-egonex-aiunderstand-anything-graphs-that-te
fetched_at: '2026-06-08T19:46:03.281918'
original_url: https://github.com/Egonex-AI/Understand-Anything
author: Egonex-AI
...
On thefirst runin a project — when you don't pass--languageand no language is stored yet —/understanddetects the language you're conversing in. If it isn't English, it asks you to confirm (or override) before generating; English conversations are unaffected. Your choice is saved to.understand-anything/config.jsonand reused on every later run.
...
If auto-discovery doesn't pick it up, install it manually: openCursor Settings → Plugins, pastehttps://github.com/Lum1104/Understand-Anythinginto the search field, and add it from there.
...
This split is why the graph is reproducible on the structural side (the same code always yields the same edges) while still capturing intent on the semantic side (what a file isfor, not just what it imports).
