...
site_name: hnrss
content_file: hnrss-i-built-a-vulnerable-app-and-spent-1500-seeing-if
fetched_at: '2026-06-04T12:02:39.131331'
original_url: https://kasra.blog/blog/i-spent-1500-seeing-if-llms-could-hack-my-app/
date: '2026-06-04'
description: As a part of my work I do security research for various apps and websites. I wanted to see if LLMs could reproduce a common class of exploits I've found in multiple apps. So I built a deliberately vulnerable book review app and spent $1,500 finding out…
tags:
- hackernews
- hnrss
---
...
If you would like to try solving it yourself before I spoil it,here’s a ZIP of the APK and challenge descriptioneach LLM was fed.
...
* Agoogle-services.jsoninside the app includes Firebase information.
...
* Reach out tohi@kasra.codesif you’re interested in an audit of your app!
...
* For all but Claude I usedpias the base harness alongside thepi-goal-xextension to force models to keep trying.
* Claude used Claude Code’s-pmode which doesn’t support plan mode but it never stopped midway.
...
* Gotsoclose to the right answer multiple times but security guardrails ended the session early.
...
If you want to test your own models unzip thetest appand give the markdown file to your agent. I’d love to hear your results!
...
Thanks for reading! If you’re interested in these types of topics I would love you to also read my post onmaking a chatbot for peptide info.
