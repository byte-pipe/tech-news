---
title: 'How I Use AI to Build Frontend Apps: My Candid, Messy Process - DEV Community'
url: https://dev.to/blackgirlbytes/how-i-use-ai-to-build-frontend-apps-my-candid-messy-process-3ehk
site_name: devto
fetched_at: '2025-11-06T11:09:20.239195'
original_url: https://dev.to/blackgirlbytes/how-i-use-ai-to-build-frontend-apps-my-candid-messy-process-3ehk
author: Rizèl Scarlett
date: '2025-11-04'
description: I've noticed that some of the pushback against using AI to code stems from people not knowing how to... Tagged with ai, agents, goose, mcp.
tags: '#ai, #agents, #goose, #mcp'
---

I've noticed that some of the pushback against using AI to code stems from people not knowinghowto use it. I know, I know you've heard the “skill issue” joke before, and it sounds annoying, but it's kind of true.

I also see a spectrum of people who are trying to accept using AI, but they don't seem to ever take the time to "chisel," as Patrick Erichson phrased it, orrefine what the AI agent outputs. They definitely submit AI slop, and it makes me cringe.
...
Here's my final output:https://nokeyboardsallowed.dev/
...
The first thing I did was chat withClaude. I usedClaude Sonnet 4to help me brainstorm what I would do and come up with a quality prompt to give an AI agent so that I'd be less frustrated with the output.

This is an abridged version because the conversation was pretty long.

First, I gave Claude some context:

Me:need to make a hackathon landing page. help me brainstorm. the hackathon challenge will be this so im thinking we can have a hackathon landing page that reflects the theme in some type of way but lets brainstorm ideas first before we build. This is the challenge.The Challenge:Build an app using unconventional inputs. Voice commands, gestures, facial expressions, anything other than the traditional keyboard and mouse.
...
Then, I copied and pasted the prompt into Loveable, ChatGPT, andgoose. I compared the output for all three. Loveable had the best design.

Here's what Loveable gave me:
...
## Part 3: Working with goose (My Codebase Agent) ⚙️

When I'm working with goose, I have agoosehintsfile that saysmake a commit for every change. I also set up the Git repo for the working directory and connected it locally and remotely. This way, if there’s something I don't like, I can easily roll back.

I moved to goose because I know it can see the whole landscape of my codebase and it has information about itself since it’sgoose. I used Claude Sonnet 4 as the LLM for goose.

### Getting Familiar

I told goose to get familiar with the app by prompting it to look through the codebase and look at what was running onlocalhost:8000.

goose:Pushed back and said it cant look atlocalhost:8000.
...
Me:Because we're challenging them to use new technology, I want to link them to our documentation. How do you think I should do that?Here's our main docs:https://block.github.io/goose/docs/category/guidesHere's our installation:https://block.github.io/goose/docs/getting-started/installationHere's our subagents docs:https://block.github.io/goose/docs/guides/subagentsWhere do you think I should add this? Should I just have one link to main docs, or should I include all three? How should it look design wise?
