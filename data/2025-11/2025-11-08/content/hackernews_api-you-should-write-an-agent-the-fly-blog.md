...
fetched_at: '2025-11-08T11:06:40.835472'
original_url: https://fly.io/blog/everyone-write-an-agent/
author: tabletcorry
date: '2025-11-06'
description: 'They''re like riding a bike: easy, and you don''t get it until you try.'
tags:
- hackernews
- trending
---
...
People havewildly varying opinionsabout LLMs and agents. But whether or not they’re snake oil, they’re a big idea. You don’t have to like them, but you should want to be right about them. To be the best hater (or stan) you can be.
...
This is a trivial engine for an LLM app using theOpenAI Responses API. It implements ChatGPT. You’d drive it with thethe obvious loop. It’ll do what you’d expect: the same thing ChatGPT would, but in your terminal.
...
"you're Alph and you only tell the truth"
...
"you're Ralph and you only tell lies"
...
I know itwants my ironno matter what it tells me.
