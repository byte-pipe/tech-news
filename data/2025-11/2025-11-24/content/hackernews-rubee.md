...
fetched_at: '2025-11-24T19:06:22.799867'
original_url: https://computer.rip/2025-11-22-RuBee.html
author: Sniffnoy
date: '2025-11-24'
---
...
RuBee is a product of Visible Assets Inc., or VAI, founded in 20041by John K.
...
VAI, though, coined the termvisibility networkto describe RuBee. That's
...
to these as "IP, subnet, and MAC,"2but these names are more like analogies.
...
is that it is alsodifficultto receive. Here is RuBee's most interesting trick:
...
1. I have found some conflicting information on the date, it could have been
as early as 2002. 2004 is the year I have the most confidence in.↩
2. The documentation is confusing enough about these details that I am actually
unclear on whether the RuBee "MAC address" is 4 bytes or 6. Examples show 6 byte
addresses, but the actual 1902.1 specification only seems to allow 4 byte addresses
in headers. Honestly all of the RuBee documentation is a mess like this. I suspect
that part of the problem is that VAI has actually changed parts of the protocol and
not all of their products are IEEE 1902.1 compliant.↩
