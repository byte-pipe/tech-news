...
content_file: hackernews_api-we-will-not-be-divided
fetched_at: '2026-02-28T11:07:41.725911'
original_url: https://notdivided.org
author: BloondAndDoom
date: '2026-02-28'
description: Employees of Google and OpenAI stand together to refuse the Department of War's demands to use AI models for domestic mass surveillance and autonomous killing without human oversight.
tags:
- hackernews
- trending
---
...
This site is hosted onFly.io, a US-based infrastructure provider. The database is SQLite, stored on an encrypted persistent volume. Verification emails are sent viaResend. Google Forms is used as one verification option because it allows email confirmation without sending anything to your inbox. The site itself is a simple open-source Flask application. No analytics or tracking scripts are used. DNS and SSL are managed through Cloudflare.
