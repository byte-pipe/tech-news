...
fetched_at: '2026-02-07T11:08:16.975513'
original_url: https://mitchellh.com/writing/my-ai-adoption-journey
author: anurag
date: '2026-02-05'
published_date: '2026-02-05T00:00:00.000Z'
description: My AI Adoption Journey
tags:
- hackernews
- trending
---
...
Adopting a tool feels like work, and Ido notwant to
...
did itvery well. The command palette that ships for macOS in Ghostty
...
To find value, youmustuse anagent. An agent is the industry-adopted
term for an LLM that can chat and invoke external behavior in a loop1At a bare minimum, the agent must have the ability to: read files,
execute programs, and make HTTP requests.

## Step 2: Reproduce Your Own Work

The next phase on my journey I triedClaude Code. I'll cut to the
...
Instead of giving up, Iforced myself to reproduce all my manual commits
...
This wasexcruciating, because it got in the way of simply getting things
...
here were understanding whennotto reach for an agent. Using an agent
...
To try to find some efficiency, I next started up a new pattern:block out the last 30 minutes of every day to kick off one or more agents.My hypothesis was thatperhapsI could gain some efficiency if the agent
can make somepositive progressin the times I can't work anyways.
...
* Deep research sessionswhere I'd ask agents to survey some
...
* Issue and PR triage/review.Agents are good at usinggh(GitHub CLI),
...
Very important at this stage: turn off agent desktop notifications.Context switching is very expensive. In order to remain efficient, I
...
the highly publicizedAnthropic skill formation paper.
...
APIs, update theAGENTS.md(or equivalent). Here isan example from Ghostty.
...
Simultaneous to step 5, I'm also operating under the goal ofhaving an agent running at all times.If an agent isn't running,
...
models like Amp'sdeep mode(which
...
I'm not [yet?] running multiple agents, and currently don't really want to.I find having the one agent running is a good balance for me right now
...
these new tools and give a glimpse about how I approach new toolsin general, regardless of AI.
