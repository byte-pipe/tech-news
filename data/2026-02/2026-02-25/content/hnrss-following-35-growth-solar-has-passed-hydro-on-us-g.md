---
title: Following 35% growth, solar has passed hydro on US grid - Ars Technica
url: https://arstechnica.com/science/2026/02/final-2025-data-is-in-us-energy-use-is-up-as-solar-passes-hydro/
site_name: hnrss
content_file: hnrss-following-35-growth-solar-has-passed-hydro-on-us-g
fetched_at: '2026-02-25T19:26:51.545889'
original_url: https://arstechnica.com/science/2026/02/final-2025-data-is-in-us-energy-use-is-up-as-solar-passes-hydro/
date: '2026-02-25'
published_date: '2026-02-24T22:40:08+00:00'
description: Coal makes a bit of a comeback, if only by accident.
tags:
- hackernews
- hnrss
---
...
And the fossil fuel market has gotten increasingly complicated. In the recent past, every increase in demand would have been met by additional natural gas generation, given the abundance of local production. But high demand and increased tariffs have led torising costs and long delaysfor the hardware that generates electricity by burning natural gas. President Trump also reversed Biden’s block on new facilities that export natural gas in liquid form, meaning the local market isincreasingly competing with international sales, raising prices.

Coal has thus been more economically viable than in years past, and electricity generated from burning it rose by 13 percent. Chris Wright, the secretary of energy, has also ordered a number of coal plants slated for closureto remain available.It’s unclear whether many of them are generating power, since they wouldn’t be slated for closure if demand could be met more economically without them operating. The administration has probably had a stronger impact on coal use by its promotion of natural gas exports.
...
While the Trump administration has been hostile to renewable energy, there’s only so much it can do to fight the economics. Arecent analysisof planned projects indicates that the US will see another 43 GW of solar capacity added in 2026—far more than the 27 GW added in 2025. That will be joined by 12 GW of wind power, with over 10 percent of that coming from two of the offshore wind projects that the administration has repeatedlyfailed to block. The largest wind farm yet built in the US, a 3.6 GW monster in New Mexico, is also expected to begin operations in 2026.

 In absolute terms, natural gas still rules the US grid.
...
In absolute terms, natural gas still rules the US grid.
 ...
 Most energy sources had a quiet year.
...
1. 1.Inside the quixotic team trying to build an entire world in a 20-year-old game
2. 2.In a replay of 2019, Apple says a single desktop Mac will be manufactured in the US
3. 3.DJI sues the FCC for “carelessly” restricting its drones
4. 4.Following 35% growth, solar has passed hydro on US grid
5. 5.Boozy chimps fail urine test, confirm hotly debated theory
