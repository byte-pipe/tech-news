...
site_name: tldr
content_file: tldr-how-we-set-up-our-cloud-agent-environment-cursor
fetched_at: '2026-08-01T11:30:03.594090'
original_url: https://cursor.com/blog/cloud-agent-environment
author: Arvind Saripalli
date: '2026-08-01'
description: Getting our monorepo working for cloud agents taught us that the development environment is a product in its own right, only one whose users are agents.
tags:
- tldr
---
...
When we decided togive cloud agents computersso they could test their changes, the first step was to make sure they were good at testing them in our own codebase.
