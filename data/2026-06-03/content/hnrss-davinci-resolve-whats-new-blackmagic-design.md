---
title: DaVinci Resolve – What’s New | Blackmagic Design
url: https://www.blackmagicdesign.com/products/davinciresolve/whatsnew
site_name: hnrss
content_file: hnrss-davinci-resolve-whats-new-blackmagic-design
fetched_at: '2026-06-03T20:09:14.860979'
...
### Search Contentwith AI IntelliSearch
...
### Extreme QualityAI UltraSharpen
...
### Hollywood GradingTools for Still Photography
...
### Support forDaVinci Color Tools
...
### Keyframes andCurves Editor Updates
...
### HTML Graphicsand Lottie Support
...
### Manage AudioTracks with Folders
...
### MainConcept H.265and MV-HEVC Encoding
...
### Instant Picturein Picture Layout
...
### Vertical Resolutionfor Social Media
...
### Upload Directlyto Social Media
...
Includes large search dial in a design thatincludes only the specific keys needed for editing. Includes Bluetooth with battery for wireless useso it's more portable than a full sized keyboard!

$435

Find Reseller

## DaVinci ResolveReplay Editor
...
## DaVinci ResolveEditor Keyboard
...
## DaVinci ResolveMicro Color Panel
...
Designed in collaboration with professionalHollywood colorists, the DaVinci Resolve Advanced Panel features a massive number of controls fordirect access to every DaVinci color correction feature.
...
Portable audio control surface includes 12premium touch sensitive flying faders, channel LCDs for advanced processing, automation and transport controls plus HDMI for an external graphics display.
...
Get incredibly fast audio editing for soundengineers working on tight deadlines! IncludesLCD screen, touch sensitive control knobs, built in search dial and full keyboard with multi function keys.
...
## Fairlight ConsoleChassis Leg Kit 0 Deg
...
## Fairlight ConsoleChassis Leg Kit 8 Deg
...
### Fairlight Studio ConsoleIndividual Modules
...
### Fairlight Studio ConsoleUnpopulated Chassis

## Fairlight ConsoleChassis 2 Bay
...
## Fairlight ConsoleChassis 3 Bay
...
## Fairlight ConsoleChassis 4 Bay
...
## Fairlight ConsoleChassis 5 Bay
...
### AccessoriesFor Custom Furniture
...
## Fairlight ConsoleChannel Rack Kit
...
## Fairlight ConsoleChannel Control Blank
...
## Fairlight ConsoleLCD Monitor Blank
...
## Fairlight ConsoleChannel Fader Blank
