---
title: AI Agents to Make Sense of Data at OpenAI - InfoQ
url: https://www.infoq.com/presentations/data-aware-ai-agents/
site_name: tldr
content_file: tldr-ai-agents-to-make-sense-of-data-at-openai-infoq
fetched_at: '2026-06-25T11:56:09.025917'
original_url: https://www.infoq.com/presentations/data-aware-ai-agents/
date: '2026-06-25'
description: OpenAI’s Bonnie Xu explains Kepler, their internal AI data analyst agent built on MCP. She shares how they scale data discovery across 600+ PB using automated context, RAG, and AST-based evals.
tags:
- tldr
---

InfoQ HomepagePresentationsAI Agents to Make Sense of Data at OpenAI
...
QCon AI is a practitioner-led event focused entirely on the engineering
...
peer organizations use in production.

### INFOQ EVENTS

* June 25th, 2026, 1 PM EDT#### Architecting for Autonomous Reliability: Embedding AI into Your Observability StackPresented by: Justin Griffin - Head of Product at NeuBird AI

* July 9th, 2026, 12 PM EDT#### From Log Noise to Incident Intelligence: A Maturity Model for AI-Assisted ObservabilityPresented by: Nicolas Jung - Product Manager, Logs at Datadog

* July 16th, 2026, 1 PM EDT#### Engineering for the Agentic Era: How to Spec, Build, Test, and Operate AI-Powered SystemsPresented by: Juveria Kanodia - Senior Director of Engineering at Harness
...
* #### Related Editorial
* #### Popular across InfoQ##### AWS Launches Blocks, an Open-Source TypeScript Framework Designed for AI Agents to Build Backends##### Anthropic Reports Claude Now Handles 95% of Internal Analytics Queries##### TSRX: a Framework-Agnostic Alternative to JSX##### .NET 11 Preview 5: Brings File-Based App Improvements, New C# Features, and a Blazor Validation Wave##### Java News Roundup: Spring Tools, Helidon, Open Liberty, TomEE, JobRunr, Hibernate, Commonhaus##### How eBPF Empowers Developers to Observe Inside the Linux Kernel in a Safe and Unintrusive Way
