...
content_file: hackernews_api-bend-2-and-the-vibe-coding-trap-liam-powells-blog
fetched_at: '2026-09-19T06:00:26.878990'
original_url: https://blog.liampwll.com/posts/bend_vibe_coding/
author: LiamPowell
date: '2026-09-18'
description: Bend 2 and the Vibe-Coding Trap
tags:
- hackernews
- trending
---
...
I won’t reproduce it here because the code isn’t too important. What is important for this article is that it’s quite a bit of code. It’s 58 lines of code just to state that the player can never touch the flag or win the game. There’s also other problems in that the LLM can redefine theGamesubprograms to do anything; however, that’s once again not the point of the article.
...
(
"Winning is impossible. WASD + Enter to move; q + Enter to quit."
);
...
"WON (this should be unreachable)"
