...
content_file: hackernews_api-apples-new-speech-api-vs-whisper-the-first-real-be
fetched_at: '2026-07-13T19:32:51.949039'
original_url: https://get-inscribe.com/blog/apple-speech-api-benchmark.html
author: get-inscribe
date: '2026-07-13'
description: We measured Apple's new SpeechAnalyzer against SFSpeechRecognizer and Whisper on 5,559 LibriSpeech utterances. Apple never published accuracy numbers. Here they are, with raw transcripts you can rescore.
tags:
- hackernews
- trending
---
...
We ship both Apple engines and three Whisper models side by side inInscribe, a private on-device AI workspace, which puts us in an unusual position: we can run all five through identical production code paths on the same machine and the same audio. So we did.
...
Whisper Tiny, test-clean
7.88%
7.6%
+0.28

Whisper Base, test-clean
5.42%
5.0%
+0.42

Whisper Small, test-clean
3.74%
3.4%
+0.34

Whisper Tiny, test-other
17.04%
16.9%
+0.14

Whisper Base, test-other
12.51%
12.4%
+0.11

Whisper Small, test-other
7.95%
7.6%
+0.35
...
The benchmark found a shipping bug in Inscribe. Our Apple-engine file import fed audio to SpeechAnalyzer and closed the input stream, but never calledfinalizeAndFinishThroughEndOfInput(). Without that call the analyzer never delivers its final results, and the import hangs forever. It had gone unnoticed because our Auto setting preferred Whisper. The fix shipped the same day, and it is part of why we publish the harness details: measuring your own product carefully has a way of finding the things you were not looking for.
