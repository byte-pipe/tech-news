...
site_name: hnrss
content_file: hnrss-larp-revenue-infrastructure-for-serious-founders
fetched_at: '2026-07-13T12:27:10.911960'
original_url: https://www.larp.website/
date: '2026-07-12'
description: LARP pairs you with another founder. You send them $10,000. They send you $10,000. You've both booked $10,000 in revenue. Cash never moves. (Satire.)
tags:
- hackernews
- hnrss
---
...
The number in the pitch is real. Whether itmeansanything is a philosophy question, not an accounting one.
...
Same shape as your ledger — capital, chips, and cloud credits circling a handful of companies, each leg counted as revenue somewhere. Tap a company to see the actual reported deals. Every figure is real and sourced.
 ...
 chips / compute flowing back

tap a node

To be clear:
 every deal here is legal, publicly announced, and defended by the people in it — Anthropic CEO Dario Amodei called the structure "nothing inappropriate in principle." Critics compare the pattern to 1990s dot-com vendor financing and warn it can inflate the 
appearance
 of demand. As Bloomberg puts it, a circular deal is legally different from a fraudulent "round-trip" — regulators' term for sham trades with no economic substance designed to inflate results. LARP is a joke about the round-trip. This is the legal cousin it rhymes with.
...
curl -X POST https://api.larp.co/v1/settlements \
 -H 
"Authorization: Bearer $LARP_API_KEY"
 \
 -d counterparty_id=
cp_8f2a91
 \
...
Tip the joke →
 ...
 Or just email me — 
[email protected]
. Say thanks, argue with the disclaimer, or tell me about the actual company you're building. That's the address.
...
No real money ever moved — that would be securities fraud, and this is a jokeaboutsecurities fraud. Your ARR is real. Your bank balance is exactly what it was.
