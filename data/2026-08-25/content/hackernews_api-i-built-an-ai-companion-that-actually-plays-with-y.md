...
content_file: hackernews_api-i-built-an-ai-companion-that-actually-plays-with-y
fetched_at: '2026-08-25T06:00:20.397576'
original_url: https://pantel.is/projects/ai-gaming-companion/
author: Pantelis Kalogiros
date: '2026-08-24'
published_date: '2026-08-23'
description: 'How Varkos was built: a low-latency AI companion that plays Skyrim with you, follows complex instructions and evolves through shared experiences.'
tags:
- hackernews
- trending
---
...
Optimized version of PocketTTS called PocketTTS-Raven (open sourced this a while ago. You can see it in action here -https://pantel.is/projects/pocket-tts-raven/?b=1or grab its codehttps://github.com/pkalogiros/pocket-tts-raven) is used as the main fast engine.
...
Until then follow me on@pkalogirosif you're curious and wanna see (slow) updates. Cheers.