---
title: AI is hitting entry-level jobs hardest, Stanford study finds - Ars Technica
url: https://arstechnica.com/ai/2026/08/ai-is-hitting-entry-level-jobs-hardest-stanford-study-finds/
site_name: newsfeed
content_file: newsfeed-ai-is-hitting-entry-level-jobs-hardest-stanford-st
fetched_at: '2026-08-25T11:25:21.747095'
original_url: https://arstechnica.com/ai/2026/08/ai-is-hitting-entry-level-jobs-hardest-stanford-study-finds/
date: '2026-08-24'
published_date: '2026-08-24T21:45:53+00:00'
description: Young employment in AI-impacted fields down 19% compared to more AI-resistant occupations.
tags:
- ars-technica
- ai
- economy
...
The August 2026 editionof “Canaries in the Coal Mine? Six Facts about the Recent Employment Effects of Artificial Intelligence” updates and revisesa paper of the same name published last yearwith fresh data and refined statistics. In that update, the Stanford researchers find the employment trends they identified for entry-level workers last year are persisting and expanding. Specifically, employment levels for workers aged 22 to 25 in the most “AI-exposed” occupations are now 19 percent below those of their peers in fields less exposed to AI disruption.

Last year, that gap measured just 13 percent.

## Not all jobs are AI jobs

To determine those numbers, the researchers used a large subsample of the anonymized, high-frequency payroll dataregularly aggregated by HR management company ADP. The team then rated each occupation’s “exposure” to AI disruption using botha potential labor market impact gaugeestablished by previous researchers (wetook a somewhat critical look at that previous researchearlier this year) andthe Anthropic Economic Index, which looks at how various occupations actually use the Claude model in their everyday work (Google releaseda similar report based on occupational Gemini usagelast month).
...
3. 3.Nvidia senior manager linked to Supermicro scheme smuggling AI servers to China
4. 4.Trump tried to curb clean energy. It’s booming anyway.
5. 5.Review: Chuwi's $449 Unibook laptop is a funhouse-mirror MacBook Neo
