---
title: 'Daniel Gultsch | Jabber/XMPP: 25 Years of Digital Independence'
url: https://gultsch.de/posts/25-years-of-digital-independence/
site_name: hackernews_api
content_file: hackernews_api-daniel-gultsch-jabberxmpp-25-years-of-digital-inde
fetched_at: '2026-08-25T11:24:48.223876'
original_url: https://gultsch.de/posts/25-years-of-digital-independence/
author: inputmice
date: '2026-08-24'
published_date: '2026-08-24T00:00:00+00:00'
description: 'Jabber/XMPP: 25 Years of Digital Independence'
tags:
- hackernews
- trending
---
...
The Internet used to be—and to some degree still is—built around standards. A data center operator can buy servers from one company, switches from another, routers from a third, and connect them to a backbone internet provider that runs hardware from yet another company. If a company goes out of business or shifts to anti-consumer practices, the next generation of hardware can easily be ordered from a different vendor.
The need for and the benefits of this supply chain independence are easily understood even by people who don’t operate data centers for a living. However, when it comes to communication tools, even the tech-literate fail to apply the same critical scrutiny.
...
The Extensible Messaging and Presence Protocol (XMPP)45is a standard for communicating online. It wasn’t created to fit a particular zeitgeist or address the current political climate. In fact, its roots go back more than 25 years.
