...
site_name: tldr
content_file: tldr-a-greyscale-iphone-setup-that-works-in-everyday-li
fetched_at: '2026-06-12T19:42:03.217155'
original_url: https://www.fabianhemmert.com/opinions/a-greyscale-iphone-setup-that-works-in-everyday-life
date: '2026-06-12'
description: I'm driven by the belief that we must not sacrifice our humanness for technology.
tags:
- tldr
---
...
your phone to greyscale can work wonders if you want to reduce your screen time(that means: increase the time spent in the real world). But when I tried to do this myself, I found that I switched back to »colour« mode quickly (because some apps need colour for usability), and then to forget to go back to greyscale.

 

## The Problem

Greyscale-mode works great for me. It makes the phone less attractive, I spend less time on it and get to do more of what I actually want to do. It's part of my low-dopamine phone setup, and it makes my life richer – ironically, you could say, it makes my (off-screen) lifemore colorful.
...
Looking for a way to have my phone on greyscale butsomeapps in colour, I found a way that required minimal setup, but since then let me stick to the setup. Finally, a greyscale-mode iPhone that works in everyday life!
...
Then, you can setup automations in the »Shortcuts« app, and trigger these shortcuts when youstart or closean app.
...
Note that I have 11 apps that disable greyscale mode, but12apps that enable it. Why one more to (re-)enable greyscale?
