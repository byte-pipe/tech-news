...
site_name: hnrss
content_file: hnrss-github-glojurelangglojure-clojure-interpreter-host
fetched_at: '2026-06-19T01:17:46.579151'
original_url: https://github.com/glojurelang/glojure
date: '2026-06-17'
description: Clojure interpreter hosted on Go, with extensible interop support. - glojurelang/glojure
tags:
- hackernews
- hnrss
---
...
Gopher image derived from@egonelbre, licensed underCreative Commons 1.0 Attributions license.

Glojure is an interpreter forClojure, hosted on Go. Glojure provides
...
Install it with thego installcommand:
...
Thegljcommand provides a traditional Clojure development experience:
...
full indent level
* Persistent history-- saved to~/.glj_historyacross sessions
* Bracketed paste-- paste blocks of code instantly
* Job control-- Ctrl+Z suspends,fgresumes cleanly
...
When embedding Glojure, you can also expose your own Go packages or additional standard library packages using the package map approach described in theAccessing additional Go packagessection below. This allows embedded Clojure code to access any Go packages you choose to expose:
...
"
A couple of HTTP methods: %v
"
 [net:http.MethodGet net:http.MethodPost]))
A couple of HTTP methods: [
"
GET
"
...
Thegen-import-interopcan be used to emit the contents of a .go file
...
The Glojure type is a tagged rune (
type Char rune
). JVM chars are 16-bit whereas Go runes are 32-bit.

BigInt

*lang.BigInt

The Glojure type wraps 
*big.Int
.
...
Native JVM BigInteger corresponds to 
*big.Int
.
