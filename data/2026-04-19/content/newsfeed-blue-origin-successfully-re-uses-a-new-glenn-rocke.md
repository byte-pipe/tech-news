---
title: Blue Origin successfully re-uses a New Glenn rocket for the first time ever | TechCrunch
url: https://techcrunch.com/2026/04/19/blue-origin-successfully-re-uses-a-new-glenn-rocket-for-the-first-time-ever/
site_name: newsfeed
content_file: newsfeed-blue-origin-successfully-re-uses-a-new-glenn-rocke
fetched_at: '2026-04-19T19:41:10.740183'
original_url: https://techcrunch.com/2026/04/19/blue-origin-successfully-re-uses-a-new-glenn-rocket-for-the-first-time-ever/
author: Sean O'Kane
date: '2026-04-19'
published_date: '2026-04-19T11:45:38+00:00'
...
“We have confirmed payload separation. AST SpaceMobile has confirmed the satellite has powered on,” the companywroteon X. “We are currently assessing and will update when we have more detailed information.”

AST later said Blue Origin’s rocketplaced its satellite into an orbit that was “lower than planned,”so the satellite will have to be de-orbited.
...
The company accomplished the re-use feat Sunday on just the third-ever launch of New Glenn, and a little more thanone year afterthe first flight of the new rocket system, which has been in development for more than a decade.
...
The booster that Blue Origin re-flew on Sunday was thesame one the company used in the second New Glenn missionin November. During that mission, the New Glenn booster helped put two robotic NASA spacecraft into space for a mission to Mars, before returning to a drone ship in the ocean. On Sunday, Blue Origin recovered the rocket booster a second time on a drone ship roughly 10 minutes after takeoff.
