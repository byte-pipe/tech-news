...
site_name: hnrss
content_file: hnrss-github-slvdevesp32-ai-github
fetched_at: '2026-07-26T11:30:43.968352'
original_url: https://github.com/slvDev/esp32-ai
date: '2026-07-25'
description: Contribute to slvDev/esp32-ai development by creating an account on GitHub.
tags:
- hackernews
- hnrss
---
...
The firmware, the wiring, and the flashing steps live infirmware/esp32_llm/README.md. The training,
ablation, and quantization code is insrc/andexperiments/. The full method,
the ablations, and the on-chip measurements are written up inRESULTS.md.
...
Andrej Karpathy'sllama2.cis why a lot of
...
result that followed once I fixed it. The commit history andRESULTS.mdshow where
