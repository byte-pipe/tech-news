---
title: The Deadly Rise of Giant Trucks and S.U.V.s - The New York Times
url: https://www.nytimes.com/interactive/2026/06/21/us/trucks-suv-pedestrian-crashes.html
site_name: hnrss
content_file: hnrss-the-deadly-rise-of-giant-trucks-and-suvs-the-new-y
fetched_at: '2026-06-23T19:38:46.973985'
original_url: https://www.nytimes.com/interactive/2026/06/21/us/trucks-suv-pedestrian-crashes.html
date: '2026-06-21'
published_date: '2026-06-21T22:10:30.000Z'
description: The vehicles on American roads have grown larger — and they are killing thousands more pedestrians, a Times investigation found.
tags:
- hackernews
- hnrss
---
...
Source: Insurance Institute for Highway SafetyThe New York Times

 

The surge in pedestrian deaths hasbaffledresearchers. Most other wealthy countrieshaven’t seensimilar increases, suggesting that possible culprits like smartphones don’t tell the whole story.
...
We simulated what happens when vehicles hit pedestrians at 20 miles per hour, working with reconstruction experts at Virtual Crash.
...
This represents a standard sedan, which generally has a hood under two and a half feet. An average American man is 5-foot-9.
...
The car hits him in the lower body, beneath his center of gravity. He is flung onto the hood.
...
That looks dramatic, but it’s usually safer for pedestrians than other outcomes, partly because hoods are designed to absorb impact.
...
A modern pickup’s hood is much taller, almost four feet on average.
...
That means the truck strikes the pedestrian around his chest.
...
He is knocked to the pavement, which is less forgiving than a car’s hood, and the pickup runs him over.
...
He is more likely to be killed in this scenario.
...
Simulated and rendered inVirtual Crash 6.
...
7-foot-5
7-foot-6
, is likely to be knocked down by about 
XX percent
 of vehicles today.
	In 2002, that number would have been 
XX percent
.
...
Here is a 2021 Chevrolet Silverado.
...
A tall hood, such as this one, creates a largeblind zonefor the driver.
...
But large hoods are just one of the contributors to bigblind zones.
...
These areA-pillars, which protect passengers in a rollover. They, too, have grown as vehicles have gotten larger.
...
The A-pillar on the driver’s side creates an especially largeblind zonethat limits visibility during left turns.
...
Largesideview mirrorsalso add to theblind zones.
...
Our analysis found thatblind zonesin popular pickup trucks have grown significantly since the late 1990s.
...
As Ms. McAlister was crossing the street, a Ram 1500 TRX — a pickupmarketedfor its off-road capabilities and fierce-looking design — was turning left.
...
Serena McAlister at the intersection where her 76-year-old mother was struck by a pickup truck.Rachel Woolf for The New York Times
...
Charlene McAlister was hit as the truck turned left.Rachel Woolf for The New York Times
...
Automakers say that new technology designed to detect and avoid pedestrians — including systems that automatically apply the brakes — would dramatically improve safety. For example, Bill Grotz, a spokesman for General Motors, pointed to a recentstudythat found that G.M. vehicles with so-called front pedestrian braking reduced the frequency of injuries by 35 percent.
...
It isno coincidencethat automakers have dramatically scaled back their production of sedans and other passenger cars in the United States. Ford, for example, went from selling more than a million in 2017 to fewer than 100,000 five years later.
...
One common pitch centers onmachismo. Automakers trumpet how some of their trucks have an“aggressive appearance”or a“piercing glare.”
...
Chevrolet Silverados from 1998 and 2021.
...
In 2009, after a spate of fatal incidents in which drivers were crushed in rollovers, the National Highway Traffic Safety Administrationrequired roofsto be strong enough to support three times the weight of a vehicle. Many automakers responded by installing thicker A-pillars.
...
Those potential dangers began attracting attention, with articles in theDetroit Free PressandConsumer Reports.

By 2022, the lack of visibility in large vehicles had become a concern for researchers at the Transportation Department’s Volpe Center, whosemissionis to identify and address problems in the transportation system.
...
Source: A New York Times analysis of registration data from S&P Global and vehicle dimension data from Expert AutoStats.
...
For example, it doesn’t include collisions that occur in places like parking lots, driveways or private roads, which are not part of the federal database. Hundreds of pedestrians a yearare estimatedto die in such crashes, a number that has been increasing.

Only in the past several years have researchers startedexploringwhether and how larger vehicles threaten pedestrians.

The Insurance Institute for Highway Safety, for example,found last yearthat vehicles with larger blind zones were substantially more likely to hit pedestrians when turning left.
...
We asked engineers at Forensic Rock for a real-world demonstration of left-turn crashes to show the danger to pedestrians.
...
A 2021 Silverado is behind a red sedan at a mock intersection. A pedestrian (represented by a dummy) waits to the left.
...
Theblind zonefrom the Silverado’s A-pillar completely blocks the pedestrian from view.
...
The pedestrian begins crossing and remains in the blind zone as the Silverado moves forward.
...
As the truck turns, the blind zone mostly hides the pedestrian.
...
Video from the driver’s perspective shows there is a moment when the pedestrian’s lower body is visible.
...
We ran the same test with a 1998 Silverado.
...
Just as with the new truck, the A-pillar on the old Silverado initially blocks the pedestrian from view.
...
But because the A-pillar is smaller, the pedestrian is more visible.
...
When the videos are viewed together, the difference is subtle but clear.
...
Margaret Lacey was hit by an S.U.V. in a crosswalk in 2016.Lucy Garrett for The New York Times
...
When Ms. Lacey’s sister, Betty, learned of her death, she flew to the United States from Ireland.Lucy Garrett for The New York Times
