---
title: 'GitHub - sngyai/Sequoia-X: A股自动选股系统 — 多种技术形态自动扫描，收盘后自动运行并推送飞书 · GitHub'
url: https://github.com/sngyai/Sequoia-X
site_name: github
content_file: github-github-sngyaisequoia-x-a股自动选股系统-多种技术形态自动扫描收盘后自动运行并
fetched_at: '2026-09-02T14:58:52.210404'
original_url: https://github.com/sngyai/Sequoia-X
author: sngyai
description: A股自动选股系统 — 多种技术形态自动扫描，收盘后自动运行并推送飞书. Contribute to sngyai/Sequoia-X development by creating an account on GitHub.
---
...
数据层使用baostock（免费、无需注册、无限流）拉取历史及增量日 K 数据（后复权），
...
python main.py 
#
 日常模式：8进程增量补数据 + 跑策略 + 飞书推送（2~3分钟）

python main.py --backfill 
#
 回填模式：全市场历史K线一次性灌入（约12分钟）
...
cd /root/Sequoia-X && .venv/bin/python main.py >> log.txt 2>&1
