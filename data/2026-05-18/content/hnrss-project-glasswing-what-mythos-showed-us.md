...
site_name: hnrss
content_file: hnrss-project-glasswing-what-mythos-showed-us
fetched_at: '2026-05-18T19:36:13.633490'
original_url: https://blog.cloudflare.com/cyber-frontier-models/
date: '2026-05-18'
published_date: 2026-05-18T14:00+08:00
description: In recent weeks, we pointed Mythos and other security-focused LLMs at live code across critical parts of our infrastructure. We share what we observed, the models’ strengths and weaknesses, and what the work around them needs to look like before any of it can scale.
tags:
- hackernews
- hnrss
---
...
None of these LLMs has captured more attention than Mythos Preview, from Anthropic. A few weeks ago, we were invited to use Mythos Preview as part ofProject Glasswing. We soon pointed it at more than fifty of our own repositories – to see what it would find, and to see how it works.
