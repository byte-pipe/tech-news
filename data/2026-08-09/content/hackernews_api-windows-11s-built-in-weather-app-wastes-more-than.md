---
title: Windows 11's built-in Weather app wastes more than 1 GB of RAM - Notebookcheck News
url: https://www.notebookcheck.net/Windows-11-s-built-in-Weather-app-wastes-more-than-1-GB-of-RAM.1364205.0.html
site_name: hackernews_api
content_file: hackernews_api-windows-11s-built-in-weather-app-wastes-more-than
fetched_at: '2026-08-09T19:31:51.809112'
original_url: https://www.notebookcheck.net/Windows-11-s-built-in-Weather-app-wastes-more-than-1-GB-of-RAM.1364205.0.html
author: akyuu
date: '2026-08-09'
description: A new report shows Windows 11's built-in Weather app can consume more than 1 GB of RAM. By comparison, Apple's native Weather app on macOS uses roughly five times less memory under similar conditions.
tags:
- hackernews
- trending
---
...
The findings also appear to contradict Microsoft's recent efforts toimprove Windows 11's efficiency. The company has been updating several built-in applications and has repeatedly said it wants the operating system to perform better onlower-end hardware. Microsoft executive Rudy Huyn has also stated that the company intends to develop more fully native Windows applications in the future, although it remains unclear whether MSN-branded applications such as Weather will eventually be rebuilt using WinUI.
...
⟨
Previous article
KTM debuts affordable Macina Joy trekking e-bike with Bosch motor
Next article
Apple iPhone 18 Pro appears on preview website, Caviar unveils five limited editions
⟩
...
Andrew Sozinow
 - Tech Writer 
 - 71 articles published on Notebookcheck
 since 2024
