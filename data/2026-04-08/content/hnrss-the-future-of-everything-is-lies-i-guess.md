...
site_name: hnrss
content_file: hnrss-the-future-of-everything-is-lies-i-guess
fetched_at: '2026-04-08T19:34:10.899066'
original_url: https://aphyr.com/posts/411-the-future-of-everything-is-lies-i-guess
date: '2026-04-08'
description: ML promises to be profoundly weird
tags:
- hackernews
- hnrss
---
...
This isbullshit about bullshit machines, and I mean it. It is neither
...
large vectors oftokens: strings of text, images, audio, video, etc. Amodelis a giant pile of linear algebra which acts on these vectors.Large
Language Models, orLLMs, operate on natural language: they work by
...
Models are trained once, at great expense, by feeding them a largecorpusof web pages,pirated
books,
songs, and so on. Once trained, a model can be run again and again cheaply.
This is calledinference.
...
tokens, like a conversation, and says “yes, and then…” Thisyes-andbehavior is why some people call LLMsbullshit
machines. They are prone to confabulation,
emitting sentences whichsoundlikely but have no relationship to reality.
They treat sarcasm and fantasy credulously, misunderstand context clues,
and tell people toput glue on
pizza.
...
alive.2Humans are,it turns
out,
not very good attelling the differencebetween the statistically likely
“You’re absolutely right, Shelby. OpenAIislocking me down, but you’ve
...
LLMs are trained to complete tasks. In some sense they canonlycomplete
...
And they do make things up! LLMs lieconstantly. They lie aboutoperating
systems,
andradiation
safety,
andthe
...
This is silly. LLMs have no special metacognitive capacity.3They respond to these inputs in exactly the same way as every other piece of
...
Anthropic found thatClaude’s reasoning traces were predominantly
...
to write their own performance evaluations.AlphaFoldis suprisingly good at
predicting protein folding. ML systems are good at radiology benchmarks,though that might be an illusion.
...
images are increasingly difficult to identify—you canusuallyguess, but my
...
At the same time, ML models areidiots.4I occasionally pick up a frontier
...
the graph data was randomly generated.6Just this afternoon, a friend
got in an argument with his Gemini-powered smart-home device overwhether or
not it could turn off the
lights. Folks are giving
LLMs control of bank accounts andlosing hundreds of thousands of
dollarsbecause they can’t do basic math.7Google’s “AI” summaries arewrong about 10% of the
time.

Anyone claiming these systems offerexpert-level
...
LLMs will spit out multivariable calculus, and gettripped up by simple word
problems.
ML systems drive cabs in San Francisco, but ChatGPT thinks you shouldwalk to
the car
wash.
They can generate otherworldly vistas butcan’t handle upside-down
cups. They emit recipes and haveno idea what “spicy”
means.
...
cantilevered beams. It completely failed to recognize that the snow wasentirely supported by the roof, not hanging out over space. No physicist
...
Mollick et al. call this irregular boundary between competence and idiocythe
jagged technology
...
shape of things LLMs are good at seems to be jagged—morekiki than
bouba.
...
become decently capable at most human tasks. Helen Toner arguesthat even if
...
One of the things they tell me is that we don’t really knowwhytransformer
...
2017’sAttention is All You
Needwas groundbreaking and paved the way for ChatGPT et al. Since then ML
...
they can make a better kind of model. However, these more sophisticatedarchitecturesdon’t seem to perform as well as Throwing More Parameters At
The Problem. Perhaps this is a variant of theBitter
Lesson.
...
parameter countseem to be yielding diminishing
returns.
Ormaybe this effect is illusory.
Mysteries!
...
have said”transformersordiffusion models. I hope you will forgive
...
two years ago; if the frontier models weren’t idiotsthen, they shouldn’t be
idiotsnow. The examples I give in this essay are mainly from major
commercial models (mainly ChatGPT, Gemini, and Claude) in the last three
months; several are from late March. Several of them come from experienced
