...
content_file: hackernews_api-github-graafhenknumberwang-a-small-neural-network
fetched_at: '2026-09-17T03:38:28.610930'
original_url: https://github.com/GraafHenk/numberwang
author: Liogra123
date: '2026-09-16'
description: A small neural network that decides whether a number is Numberwang. - GraafHenk/numberwang
tags:
- hackernews
- trending
---
...
A number's wangness is a property of thenumber, not the language it
is said in:four,vier,quatreandcuatroall get the same verdict.
...
weights, andmodel.jsoncontains the lot.
...
gradiois needed only for the demo. The model itself never needs it.
...
network memorises rather than computes, so small common expressions like5*2are reliable while904 * 3is an educated guess. If arithmetic
