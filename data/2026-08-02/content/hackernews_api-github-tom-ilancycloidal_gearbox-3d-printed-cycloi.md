---
title: 'GitHub - tom-ilan/cycloidal_gearbox: 3D Printed Cycloidal Gearbox · GitHub'
url: https://github.com/tom-ilan/cycloidal_gearbox
site_name: hackernews_api
content_file: hackernews_api-github-tom-ilancycloidal_gearbox-3d-printed-cycloi
fetched_at: '2026-08-02T19:28:53.235769'
original_url: https://github.com/tom-ilan/cycloidal_gearbox
author: tomilan
date: '2026-08-02'
description: 3D Printed Cycloidal Gearbox . Contribute to tom-ilan/cycloidal_gearbox development by creating an account on GitHub.
tags:
- hackernews
- trending
---
...
This python script was based on the SolidWorks articleBuilding a Cycloidal Drive with SOLIDWORKS. The two main parametric equations I used were:
...
1. Clone the repo
2. Open Fusion 360 and launchScripts and Add-Ins(Shift + S).
3. Under theScriptstab, click+(Plus)to add a script.
4. Select thecycloidal_generatorfolder and clickRun.
...
This section is dedicated toVersion 3, whose CAD files can be found undercad_models/version_3.
