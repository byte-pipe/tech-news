---
title: 'Card Sorting and Tree Testing: Getting Your Information Architecture Right | Raw.Studio'
url: https://raw.studio/blog/card-sorting-and-tree-testing/
site_name: tldr
content_file: tldr-card-sorting-and-tree-testing-getting-your-informa
fetched_at: '2026-08-26T21:39:39.068225'
original_url: https://raw.studio/blog/card-sorting-and-tree-testing/
author: Philippe H.
date: '2026-08-26'
published_date: '2026-08-20T01:26:34+00:00'
description: Card sorting and tree testing are two UX research methods that help teams build and validate site navigation using user behaviour.
tags:
- tldr
---
...
Raw Studio’s guide toservice designexplores a similar idea: customer experience depends on how people, processes, and touchpoints work together.
...
Raw Studio’s article onuser interviewsis useful here too. Both methods work best when teams listen to the language customers actually use instead of relying on internal terminology.
...
Raw Studio’s article onusing data to inform UX designexplains why observed behaviour should guide design decisions.
...
Raw Studio’s article onwhy menus are disappearing in modern UXis a useful reminder that navigation patterns continue to evolve. The best structure is one users understand quickly.
...
Get a free audit and proposal from Raw Studioand find out where your information architecture, navigation labelling, or wider UX may be making customers work harder than they should.

Book a free 30-minute UX Teardown (Limited availability)
