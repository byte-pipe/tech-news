---
title: 'GitHub - alchaincyf/zhangxuefeng-skill: 张雪峰.skill — 张雪峰的认知操作系统。高考志愿/考研/职业规划的实战思维框架。由女娲.skill生成。 · GitHub'
url: https://github.com/alchaincyf/zhangxuefeng-skill
site_name: github
content_file: github-github-alchaincyfzhangxuefeng-skill-张雪峰skill-张雪峰的认
fetched_at: '2026-06-11T12:23:33.510216'
original_url: https://github.com/alchaincyf/zhangxuefeng-skill
author: alchaincyf
description: 张雪峰.skill — 张雪峰的认知操作系统。高考志愿/考研/职业规划的实战思维框架。由女娲.skill生成。 - alchaincyf/zhangxuefeng-skill
---
...
本 skill 基于开放的Agent Skills协议，可在任何 skills-compatible 的 AI agent runtime 中运行（Claude Code、Codex、Cursor、OpenClaw、Hermes Agent、CodeBuddy、Workbuddy、Gemini CLI、OpenCode 等 50+ runtime）。

### 方式一：一行命令（推荐，跨 runtime 自动检测）

npx skills add alchaincyf/zhangxuefeng-skill

通用 CLI 安装器（vercel-labs/skills，支持 55+ runtime）会自动识别当前 runtime 并把 skill 放到正确目录。需要指定 runtime 时加-a claude-code/-a codex/-a cursor/-a openclaw等参数。
...
~/.codex/skills/zhangxuefeng-skill/
...
~/.openclaw/workspace/skills/zhangxuefeng-skill/

Hermes Agent

跑该 runtime 的 install 脚本或 clone 到其 skills 目录
...
即使 runtime 不支持 Agent Skills 自动加载，你也可以把SKILL.md的内容粘贴进对话——它本质就是一份 markdown + YAML frontmatter。
...
从毕业后的就业数据倒推今天的专业选择，看中间50%的人去了哪
...
6个调研文件，全部在references/research/目录：
