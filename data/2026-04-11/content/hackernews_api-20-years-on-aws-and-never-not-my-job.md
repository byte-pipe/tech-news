...
content_file: hackernews_api-20-years-on-aws-and-never-not-my-job
fetched_at: '2026-04-11T19:18:29.120701'
original_url: https://www.daemonology.net/blog/2026-04-11-20-years-on-AWS-and-never-not-my-job.html
author: cperciva
date: '2026-04-11'
description: 20 years on AWS and never not my job
tags:
- hackernews
- trending
---
...
— which was therealfirst AWS service, but which most
people have never heard of and which has been quietly scrubbed from AWS
history.It didn't take long before I started complaining about things. By this
...
no corresponding signature on AWSresponses— and at this
...
to be better than transport-layer security.Of course, as soon as Amazon EC2 launched I had a new target: I wanted
...
internal "publish Amazon Kernel Images" API.But I didn't wait for this functionality to be offered before providing
...
do not know.I also mentioned — in fact in one of Jeff Barr's AWS user meetups
...
when EC2 Instance Attestation launched 18 years later.I ended 2007 with a blog post which I was told was quite widely read
...
users to reason about.In early 2008, Kip Macy got FreeBSD working on Xen with PAE — while
...
bash scripts, you might want to reconsider your choice of languages.Unfortunately even once I got FreeBSD packaged up into an AKI (Amazon
...
sticking with Xen 3.0 in order to support existing customers.In March 2008, I received one of those emails which only really seems
notable in hindsight:Hi Colin,

This is Matt Garman from the EC2 team at Amazon. [...]Matt was inviting me to join the private Alpha of "Elastic Block Storage"
...
talk to me about a new service isbefore building it.
I come from a background of mathematics and theory; I can provide far
more useful feedback on a design document than from alpha-test access.By April 2008 I had Tarsnap in private beta and I was working on its
...
the SimpleDB team?"While the issue wasn't fixed until December, Amazon did a good job of
...
about this in my blog postAWS
signature version 1 is insecure.)In June 2008 I noticed that NextToken values — returned by
...
after this I still never received any response, mind you.)Later in 2008, after Tarsnap was in public beta (but before
...
also know thatit isn't necessary to correct everyone
who is wrong.Finally in November 2008, I drove down to Seattle for an AWS Start-up
...
derived keys.For most of 2009 I was busy with growing Tarsnap. The EC2 team set up
...
2012, soon afterI
raised the issue publicly.By the start of 2010, with EC2 still stuck on an ancient version of
...
paravirtualized Xen rather than HVM.The lack of HVM continued to be a sore point — especially as I
...
for any longer than necessary.The first real breakthrough however came with the launch of the newt1.microinstance type in September. While it wasn't
...
instance, and on December 13, 2010,I announced that FreeBSD was
now available for EC2 t1.micro instances.Once I'd gotten that far, things suddenly got easier. Amazon now had
...
out to me that EC2 didn'treallyknow which OS we were
running, and I proceeded to make FreeBSD available on all 64-bit
instance types viadefenestration.
...
types which supported running "Linux" on HVM.)2012 was an exciting year. In April, I had the classic greybeard
...
and replace the faulty hardware a few days later.The highlight of 2012 however was the first re:Invent — which was
...
to a Principal engineer. I talked aboutmy work
...
straight to two vCPUs ("large") and skipped the "medium" size.Time passed. With FreeBSD fundamentally working, I turned to the "nice
...
running all of the builds.In October 2016, I took a closer look at IAM Roles for Amazon EC2,
...
via an interface which was entirely unsuitable for that purpose.In May 2019, I was invited to join theAWS Heroesprogram, which recognizes non-Amazonians who make significant
...
Principal Engineer, they felt they couldn't say no.In March 2021, EC2 added support for booting x86 instances using UEFI;
...
of users to provide a significant speedup to most users. In June,I requested a
BootMode=polyglotsetting which would indicate that the image was
...
which I had to admit was a friendlier, albeit less geeky, name for it.One of the most important things about the AWS Heroes program is the
...
trust them to handle such matters — and put it out of my mind.In December 2023, however, I was talking to some Amazonians at re:Invent
...
fixed it.The issue had not, in fact, been fixed: The 2023 commit prevented
...
had been disabled for most customers pending a "major revision".The largest change in my 20 years of working with Amazon started
...
like most hot spares I never expected to be promoted.Unfortunately, in late 2022 Glen was hospitalized with pneumonia, and
...
to keep up with EC2 support as well as I would have liked.In April 2024 I confided in an Amazonian that I was "not really doing
...
term of sponsorship.While I like to think that I've made important contributions to AWS
...
fraction of what I've accomplished without their help.Posted at 2026-04-11 05:31 |Permanent link|CommentsView the forum thread.blog comments powered byDisqus
