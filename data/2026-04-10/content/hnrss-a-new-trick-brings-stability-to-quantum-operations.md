---
title: A new trick brings stability to quantum operations | ETH Zurich
url: https://ethz.ch/en/news-and-events/eth-news/news/2026/04/a-new-trick-brings-stability-to-quantum-operations.html
site_name: hnrss
content_file: hnrss-a-new-trick-brings-stability-to-quantum-operations
fetched_at: '2026-04-10T19:22:28.659086'
original_url: https://ethz.ch/en/news-and-events/eth-news/news/2026/04/a-new-trick-brings-stability-to-quantum-operations.html
date: '2026-04-10'
description: Researchers at ETH Zurich have realised particularly stable quantum logical operations with qubits made of neutral atoms. Since these operations, called quantum gates, are based on geometric phases they are extremely robust against experimental noise and can be used in quantum computers in the future.
tags:
- hackernews
- hnrss
---
...
* Quantum exchange or swap gates are an important part of quantum computers with a large number of qubits.
* Researchers at ETH Zurich have developed a swap gate for qubits made of neutral atoms that is based on a particular physical effect: the state of the particles switches depending on the path they take and is independent of external disturbances.
* These so-called geometric phases make the system much less susceptible to experimental noise or imperfections.
* This novel swap gate works with a precision of more than 99,9 percent and can be applied to 17,000 qubits simultaneously.
...
Moreover, the researchers were able to demonstrate that the gate can be applied to several thousands of qubits simultaneously. The results, which were recently published in the scientific journalexternal pageNature, pave the way for future progress in quantum computers with neutral atoms.
...
Kiefer Y, Zhu Z, Fischer L, Jele S, Gächter M, Bisson G, Viebahn K, Esslinger T: Protected quantum gates using qubit doublons in dynamical optical lattices. Nature, 8 April 2026, DOI:external page10.1038/s41586-026-10285-1
