...
content_file: hackernews_api-littlelearner-language-models-under-pedagogically
fetched_at: '2026-08-16T19:19:58.883485'
original_url: https://littlelearner-ll.github.io/
author: porridgeraisin
date: '2026-08-16'
description: What happens when an LLM never sees material beyond fifth grade?
tags:
- hackernews
- trending
---
...
Modern LMs are trained on everything at once, so it is hard to tell whether a new skill
 waslearnedor merelyelicited. We constrain the training distribution itself: an 88B-token
...
Three scales (0.6B / 1.3B / 5B) trained from scratch on LittleCurriculum: chattable models
 with an interpretable knowledge boundary. Each ships with a matchedUnfilteredcontrol
