...
site_name: hnrss
content_file: hnrss-were-making-bunny-dns-free
fetched_at: '2026-06-24T11:57:16.109597'
original_url: https://bunny.net/blog/were-making-bunny-dns-free/
author: bunny.net
date: '2026-06-24'
published_date: '2026-06-24T05:58:00.000Z'
description: Your DNS bill shouldn't scale with your traffic. So we removed query fees from Bunny DNS entirely. No per-request billing and no query limits.
tags:
- hackernews
- hnrss
---
...
Originally,Bunny DNSwas built with one simple goal: to build the most advanced routing engine possible, capable of analyzing every DNS query and directing it to the optimal destination for serving your content. Even to this day, it’s what makes Bunny CDN achieve it’s exceptional performance.
...
It’s one of those details most people won’t notice directly, but it does change how comfortable you can be withturning DNSSEC on.
...
We take our mission seriously, and the “help” part of it is perhaps the most important. By dropping usage charges for DNS and integrating it deeply with the rest of our stack, starting with CDN andShield, we want to help you build faster, safer, and more resilient applications without worrying about arbitrary limits.
...
It’s free now, so you canlog inorsign upand start using it straight away.