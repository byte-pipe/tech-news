---
title: 'GitHub - andreknieriem/headunit-revived: Headunit App for displaying Android Auto · GitHub'
url: https://github.com/andreknieriem/headunit-revived
site_name: github
content_file: github-github-andreknieriemheadunit-revived-headunit-app
fetched_at: '2026-06-24T19:35:46.004603'
original_url: https://github.com/andreknieriem/headunit-revived
author: andreknieriem
description: Headunit App for displaying Android Auto. Contribute to andreknieriem/headunit-revived development by creating an account on GitHub.
---
...
 
 
COPYRIGHT_MICHAEL_REID_GPLv3AFFERO.txt
COPYRIGHT_MICHAEL_REID_GPLv3AFFERO.txt
 
 
LICENSE
...
 
 
README_OPENSOURCE_BUILDING.txt
README_OPENSOURCE_BUILDING.txt
 
 
build.gradle.kts
...
Check out theWikifor detailed documentation, setup guides and troubleshooting!
...
* Download:Wireless Helper on Google Play Store
* Features:Minimal configuration, supports NSD, Wi-Fi Direct Auto-Connect, and Bluetooth Auto-Start.

Setup:

* In Headunit Revived Settings: SetWireless ModetoHelper Mode.
...
* Wireless Launcher:You can still use the originalWireless Launcherby Emil Borconi.
...
You can trigger a wireless connection attempt using an Android Intent. This is useful for automation tools likeTasker,MacroDroid, or viaADB.
...
"
headunit://connect?ip=192.168.1.25
"

## Known Issues

* Google Maps in Portrait Mode:Touch interactions (searching, scrolling) within Google Maps may not work as expected when using Portrait Mode on some devices.Fix:Try reducing thePixel density (DPI)setting tobelow 200(e.g., 190) in the app settings. This often restores full functionality.
...
* Refactored Connection Core: Complete rewrite of the internal connection handling using the newCommManager. Improved stability, faster handshakes, and better coroutine integration.
...
* IMPORTANTFixing Android Auto 16.4 intents for selfmode. In Wireless Helper too. Please update to 1.2.0
...
* Major Improvement: Audio focus and routing overhaul. AddedMediaSessionsupport and immediate focus response to phone. Fixes issues where background apps on the tablet would block Android Auto audio.
...
sudo nano ~/.zshrc or sudo nano ~/.bashrcexport HEADUNIT_KEYSTORE_PASSWORD="YOUR_KEYSTORE_PASSWORD" export HEADUNIT_KEY_PASSWORD="YOUR_KEY_PASSWORD"
