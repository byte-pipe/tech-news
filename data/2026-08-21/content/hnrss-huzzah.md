...
site_name: hnrss
content_file: hnrss-huzzah
fetched_at: '2026-08-21T11:23:11.133015'
original_url: https://www.danielvaughn.dev/posts/huzzah/
date: '2026-08-20'
description: A new experimental way to code with AI
tags:
- hackernews
- hnrss
---
...
It’s August, and I feel utterlyfatigued.
...
And yet, I sense that Ineedto have better insight and control over what my code is doing.
...
2. AI chats are imperative, step-by-step instructions that describechangesto the application, not the application itself. This means instructions are often repeated, and thus consume tokens, many times over the course of development. This is inefficient.
...
Let’s take a very simple example - say you want to use AI to createfizz buzz. We’ll do this twice - once with coding agents and another with Huzzah.
...
You create a new file calledfizz_buzz.hz.
...
You should be able to see some benefits already. Notice how much more terse andreadablethe pseudocode is than the longform prompts? Here are some more:
...
* You could write a language agnostic pseudocode and use it as the basis for multiple language or environmental targets. Think complex algorithms, like aCRDT.
...
You can find thesource code and setup instructions here.
