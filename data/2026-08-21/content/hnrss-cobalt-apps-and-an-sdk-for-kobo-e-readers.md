---
title: 'Cobalt: apps and an SDK for Kobo e-readers'
url: https://bandarlabs.github.io/Cobalt/
site_name: hnrss
content_file: hnrss-cobalt-apps-and-an-sdk-for-kobo-e-readers
fetched_at: '2026-08-21T19:25:22.561621'
original_url: https://bandarlabs.github.io/Cobalt/
date: '2026-08-21'
description: 'Cobalt is an open-source app platform for Kobo e-readers: a launcher, a signed App Store, a Rust SDK, and a capability-isolated runtime. One USB install; every app after that arrives over Wi-Fi.'
tags:
- hackernews
- hnrss
---
...
ImplementKoboApp, describe screens declaratively, and the runtime handles layout, e-ink refresh planning, Back navigation and lifecycle.
...
1. Restart the readerand openCobaltfrom Kobo's menu.
2. Open Store.Everything from here on arrives over Wi-Fi.

The complete walkthrough, including recovery steps, is indocs/INSTALL.md.
...
1. Build it.Add the app as a workspace package underapps/<app-id>/and register it inapps/catalog.json.
...
Own a different Kobo model?Portingis welcome too; open an issue first so the device profile can be agreed. Full details indocs/CONTRIBUTING_APPS.md.
...
Only the Clara BW profile has been hardware-tested. Don't install on another model until it has areviewed, hardware-tested profile. Cobalt is an independent project, not affiliated with Rakuten Kobo.