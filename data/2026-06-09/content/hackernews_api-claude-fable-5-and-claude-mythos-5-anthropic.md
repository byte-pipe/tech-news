...
content_file: hackernews_api-claude-fable-5-and-claude-mythos-5-anthropic
fetched_at: '2026-06-09T19:43:46.330703'
...
Today we’re launchingClaude Fable 5: a Mythos-class1model that we’ve made safe for general use.
...
Overall level of misaligned behaviors from our automated alignment assessment. See section 6.2.3.1 of the 
system card
 for more.
...
Results of running cyber evaluations,
3
 with Fable 5 in a mode that blocks responses rather than falling back to Opus 4.8. Evaluations did not involve attempts to evade safeguards.
...
1. Mythos-class models are a tier of Claude models that sit above our Opus class in capability. The first, Claude Mythos Preview, was released in April throughProject Glasswing. That is followed today by Claude Fable 5 and Claude Mythos 5.
2. Fable is from the Latinfabula, “that which is told,” akin to the Greekmythos. The safeguards are what distinguish the two models (Fable and Mythos) and are why we’ve given them different names.
