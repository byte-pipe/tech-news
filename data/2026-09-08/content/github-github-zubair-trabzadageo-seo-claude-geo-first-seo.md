---
title: 'GitHub - zubair-trabzada/geo-seo-claude: GEO-first SEO skill for Claude Code. Comprehensive AI search optimization for any website — citability scoring, AI crawler analysis, brand authority, schema markup, platform-specific optimization, and PDF reports. If you want learn how to sell this to real businesses, check out the skool community · GitHub'
url: https://github.com/zubair-trabzada/geo-seo-claude
site_name: github
content_file: github-github-zubair-trabzadageo-seo-claude-geo-first-seo
fetched_at: '2026-09-08T00:30:37.250894'
original_url: https://github.com/zubair-trabzada/geo-seo-claude
author: zubair-trabzada
description: GEO-first SEO skill for Claude Code. Comprehensive AI search optimization for any website — citability scoring, AI crawler analysis, brand authority, schema markup, platform-specific optimization, and PDF reports. If you want learn how to sell this to real businesses, check out the skool community - zubair-trabzada/geo-seo-claude
---
...
 
 
pr-draft-agent-http-checks.md
pr-draft-agent-http-checks.md
 
 
pr-draft-content-signals.md
pr-draft-content-signals.md
 
 
requirements.txt
...
Gartner: search traffic drop by 2028

-50%

Brand mentions vs backlinks for AI

3x stronger correlation

Marketers investing in GEO
...
curl -fsSL https://raw.githubusercontent.com/zubair-trabzada/geo-seo-claude/main/install.sh 
|
 bash
...
RequiresGit for Windowswhich includes Git Bash.

#
 Option 1: One-command install (run from Git Bash, not PowerShell/CMD)

curl -fsSL https://raw.githubusercontent.com/zubair-trabzada/geo-seo-claude/main/install-win.sh 
|
 bash
...
* Python 3.8+ (on Debian/Ubuntu alsopython3-venv)
* Claude Code CLI
* Git
* Optional:uv— if present, the installer uses it for a faster dependency install
* Optional: Playwright (for screenshots)

### Isolated install

Python dependencies are installed into a dedicated virtual environment at~/.claude/skills/geo/.venv/. Your system Python isnottouched, and
...
regardless of whatpython3resolves to on yourPATH.
...
Structured data analysis & generation
...
Generate client-ready GEO report

/geo report-pdf

Generate professional PDF report with charts & visualizations
...
This directory isnot removedby the uninstaller — delete it manually if you no longer need your prospect data.
...
2. Parallel Analysis— Launches 5 subagents simultaneously:* AI Visibility (citability, crawlers, llms.txt, brand mentions)
...
Join the AI Workshop Community →
