...
site_name: tldr
content_file: tldr-ai-is-making-the-nice-version-worth-building-jamie
fetched_at: '2026-09-15T07:38:17.859360'
original_url: https://lord.technology/2026/09/14/ai-is-making-the-nice-version-worth-building.html
author: Jamie Lord
date: '2026-09-15'
published_date: '2026-09-14T08:02:00+01:00'
...
ai-is-making-the-nice-version-worth-building.html
...
Shopify’sannouncementis explicit about this. React Native served it well after its 2020 decision to adopt it. Coding agents changed the cost of building and maintaining separate implementations. Shop has already migrated; the larger Shopify merchant app is still underway. The earlier decision did its job. That does not oblige the company to keep it forever.

TheShop migration took twelve weeksfrom proof of concept to release. Six engineers built the foundations and main journeys, with feature teams joining to validate their areas. Shopify reports startup time falling by 23% on iOS and 50% on Android. The Android app shrank by 109 MB; the iOS app grew by 1 MB. The team also simplified parts of the product, so the framework cannot take all the credit. Still, these are improvements in an app people can use.

Apple also named Notion as an app migrating its interface to SwiftUI during theWWDC26 Platforms State of the Union, although Notion’sinvestment in native mobile code dates to 2020. Its longer migration should not be mistaken for another instance of Shopify’s AI-driven rewrite. The attraction of native development is well established. Its affordability is changing.
...
I saw a personal version of this withthe aircraft tracker I built for an audience of one. AI made its scope manageable in evenings and weekends. I did not need to find a larger audience to justify building it. The work became affordable for the audience it already had: me.
...
TheShop team says native expertise remained essential. Engineers reviewed plans and behaviour, and generated code still introduced architectural and performance problems. Faster implementation gives experienced developers more to work with, and plenty to catch.
...
As I havewritten before, owning code remains expensive. Another platform means another release process, more devices to test and more ways for things to fail. Those costs belong in the estimate, even as implementation gets cheaper.
