...
site_name: tldr
content_file: tldr-where-does-a-robot-think-on-device-vs-datacenter-i
fetched_at: '2026-09-15T07:38:15.389133'
original_url: https://newsletter.semianalysis.com/p/a-brain-too-big-to-carry-on-device
author: Ivan Chiam
date: '2026-09-15'
description: Robot Models, Silicon Efficiency, Jetson Thor vs. B300 TCO, Deployments, The Network Wall
tags:
- tldr
---
...
We useNVIDIA’s RoboTTT. It has no public code or weights, so we benchmark a timing-representative reconstruction: real GR00T N1.7 checkpoints with test-time-training (TTT) blocks inserted into the action head, built to match the paper’s compute and memory profile rather than its accuracy.
