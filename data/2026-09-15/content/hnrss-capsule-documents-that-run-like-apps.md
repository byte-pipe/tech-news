---
title: Capsule — Documents that run like apps
url: https://withcapsule.app/
site_name: hnrss
content_file: hnrss-capsule-documents-that-run-like-apps
fetched_at: '2026-09-15T21:56:28.467333'
original_url: https://withcapsule.app/
date: '2026-09-15'
description: Capsule packages your entire app — UI, data, and assets — into a single portable file. No cloud. No accounts. Just share it.
tags:
- hackernews
- hnrss
---

# Documents thatrun like apps

 

Capsule packs your entire app — UI, data, and everything — into a single portable.capsulefile. No cloud. No accounts. Just share it.
...
Capsule turns simple prompts into complete, self-contained desktop applications. No cloud
 servers, no databases to configure, no complex build setups.
...
Generates a complete single-file.capsulecontainer with HTML UI, schema, and local
 SQLite data.
...
Capsule brings the simplicity of documents together with the power of native desktop and
 mobile applications.
...
Forget cloud accounts, servers, and subscriptions. Capsule bundles your user interface, media
 assets, and local database into a single, portable.capsulefile.
...
Hey! Here's my latest design portfolio, with all projects, case studies, and
 assets packed in. Let me know what you think 👀
...
Open and run the exact same.capsulefiles on iOS and Android devices.
...
Capsule is completely free. Download the host player for your platform and open any.capsulefile in seconds.
