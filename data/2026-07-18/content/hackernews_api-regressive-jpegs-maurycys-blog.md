...
content_file: hackernews_api-regressive-jpegs-maurycys-blog
fetched_at: '2026-07-18T11:24:47.114975'
original_url: https://maurycyz.com/projects/bad_jpeg/
author: vitaut
date: '2026-07-18'
description: Regressive JPEGs
tags:
- hackernews
- trending
---
...
The luminance (Y) seperated because it must be high quality, but the color can be fudged quite a bit while looking fine.Very roughly: Y = G, Cb = B - G, Cr = R - G

After it, the file contains eight more scans to fill in the rest of the data:

Scan numberChannelsDCT bin rangePrecision0Y Cb Cr0 - 0Half (-1 bit)1Y1 - 5Quarter (-2 bits)2Cb1 - 63Half3Cr1 - 63Half4Y6 - 63Quarter5Y1 - 63Half6Y Cr Cb0 - 0Full7Cr1 - 63Full8Cb1 - 63Full9Y1 - 63Full
...
Scan numberChannelsDCT binsPrecision0Y Cb Cr0 - 0Full
...
cat>frame.scans<<EOF# DC only scan:
0,1,2:0-0,0,0;
# and nothing elseEOFjpegtran-scansframe.scans-outfileout.jpg in.jpg
...
here's ainteractive single-page applicationwith no CSS or JavaScript.
