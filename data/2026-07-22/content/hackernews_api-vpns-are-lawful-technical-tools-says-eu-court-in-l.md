---
title: '''VPNs are lawful technical tools,'' says EU Court in landmark Anne Frank copyright ruling | TechRadar'
...
content_file: hackernews_api-vpns-are-lawful-technical-tools-says-eu-court-in-l
fetched_at: '2026-07-22T11:37:29.850684'
original_url: https://www.techradar.com/vpn/vpn-privacy-security/vpns-are-lawful-technical-tools-says-eu-court-in-landmark-anne-frank-copyright-ruling
author: healsdata
date: '2026-07-21'
published_date: '2026-07-21T15:36:55Z'
description: The Court of Justice of the European Union has ruled that publishers and VPN providers aren't liable for copyright infringement
tags:
- hackernews
- trending
---
...
* The case centered on the copyright battle involvingAnne Frank's diary
...
Thelandmark judgment— handed down in July 2026 — stems from a complex legal battle over the online publication of Anne Frank's historical manuscripts. At its core, the case forced Europe's top judges to answer a highly technical question: if a publisher actively tries to block visitors from a specific country, are they still breaking the law if a user sneaks past the digital border using circumvention software?

According to the CJEU, the answer is no. As long as a website employs "state-of-the-art" geo-blocking technology, the publisher cannot be held liable for copyright infringement simply because a determined reader decides to fire up thebest VPNto bypass the restrictions.
...
The Anne Frank Fonds, which holds the Dutch copyright, sued. They argued that because standard VPNs easily allow users to mask their trueIP addressand spoof a Belgian location, the scholarly website was effectively communicating the protected work to the Dutch public.

The CJEU ultimately rejected this argument. In itsjudgment, the court noted that while geo-blocking measures can inevitably be circumvented, "the possibility of such circumvention cannot, in itself and in all circumstances, be a decisive factor in finding those measures to be inadequate and, therefore, ineffective."
...
The judges explicitly shielded VPN companies from collateral damage in piracy lawsuits, a topic that has sparked intensedebate among European ISPs and rightsholders. The court specifically argued that the provider of a VPN or similar services is not liable for users bypassing restrictions.
...
Follow TechRadar on Google Newsandadd us as a preferred sourceto get our expert news, reviews, and opinion in your feeds. Make sure to click the Follow button!
...
1. 1'VPNs are lawful technical tools,' says EU Court in landmark Anne Frank copyright ruling
2. 2Arozzi Arena Nordico Electric Standing Desk review: minimalist design with maximum appeal, but key accessories cost extra
3. 3Fake FBI social media scams are on the rise — here's what to look out for
4. 410 tech deals for professionals I actually recommend from Best Buy's Black Friday in July sale
5. 5Exclusive: 'I will always say' — Marvel star Tom Hiddleston reveals whether you 'need to watch' Loki on Disney+ before Avengers: Doomsday is released