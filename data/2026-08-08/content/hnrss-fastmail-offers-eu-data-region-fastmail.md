---
title: Fastmail offers EU data region | Fastmail
url: https://www.fastmail.com/blog/fastmail-offers-eu-data-region/
site_name: hnrss
content_file: hnrss-fastmail-offers-eu-data-region-fastmail
fetched_at: '2026-08-08T19:28:03.224665'
original_url: https://www.fastmail.com/blog/fastmail-offers-eu-data-region/
author: Bron Gondwana
date: '2026-08-08'
published_date: '2026-08-03T00:00:00Z'
description: Choose if you want to make the European Union the primary home for your Fastmail data, on our own secure servers in Amsterdam.
tags:
- hackernews
- hnrss
---
...
* Incoming mail will go to EU servers by preferenceif you are using your own domain and Fastmail’s nameservers, or an address at one of Fastmail’sEU-region domains.
...
* Incoming mail goes to US servers by preferenceif you are using your own domain and Fastmail’s nameservers, or an address at one of Fastmail’sUS-region domains.
...
* If you are using one of Fastmail’s genericnon-regional domainsthen your mail may go in or out via either location.
...
* Third party services are shared.Thethird partieswe use for debugging, billing, and support are linked to your account in the same way regardless of your region.
...
* We’re an Australian company, subject to Australian law including legal-cooperation treaties between Australia and other countries. Wherever your data is stored, we will respond the same way to lawful requests from relevant authorities (see ourtransparency report).
