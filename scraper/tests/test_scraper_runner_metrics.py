...
from scraper.core.scraper_runner import fetch_content_for_results, run_scraper, run_scrapers_parallel  # noqa: E402
from scraper.scrapers.base import BaseScraper  # noqa: E402
from scraper.utils.structured_logger import get_metrics_collector, reset_metrics  # noqa: E402
...
class TestScraperRunnerMetrics(unittest.TestCase):
    ...
    @patch("scraper.core.scraper_runner.logger")
    @patch("scraper.core.scraper_runner.structured_logger")
    ...
    def test_parallel_execution_metrics(self, mock_structured_logger, mock_logger):
        ...
        # Check structured logger recorded sequential execution (parallel is an alias now)
        mock_structured_logger.log_metric.assert_called()
        metric_calls = [call for call in mock_structured_logger.log_metric.call_args_list if call[0][0] == "sequential_execution_complete"]
