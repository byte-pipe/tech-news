...
class TestHealthChecker(unittest.TestCase):
    ...
    def setUp(self):
        ...
        (self.project_root / "scraper" / "config").mkdir(parents=True)
...
sites:
  ...
  techcrunch:
    ...
    selector: ".post-block"
"""
        (self.project_root / "scraper" / "config" / "sites.yaml").write_text(sites_config)
...
class TestHealthCheckIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        (self.project_root / "scraper" / "config").mkdir(parents=True)
        (self.project_root / "pyproject.toml").touch()
        (self.project_root / "scraper" / "config" / "sites.yaml").write_text("sites:\n  test: {}")
