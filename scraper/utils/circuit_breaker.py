...
from scraper.constants import CIRCUIT_BREAKER_EXPECTED_EXCEPTION, CIRCUIT_BREAKER_FAILURE_THRESHOLD, CIRCUIT_BREAKER_RECOVERY_TIMEOUT
...
class CircuitBreaker:
    ...
    def __init__(
        ...
        expected_exception: Type[BaseException] = CIRCUIT_BREAKER_EXPECTED_EXCEPTION,
